...
title:  "Stencil 3D r3 star variable homogeneous $STEMPEL_ARGS BroadwellEP_E5-2697_CoD"
...
vmovupd xmm1, xmmword ptr [rax+rbx*1+0x30]
vaddpd xmm2, xmm1, xmmword ptr [rax+rbx*1+0x20]
vaddpd xmm3, xmm2, xmmword ptr [rax+rbx*1+0x40]
vaddpd xmm4, xmm3, xmmword ptr [rax+rcx*1+0x30]
vaddpd xmm5, xmm4, xmmword ptr [rax+rdx*1+0x30]
vaddpd xmm6, xmm5, xmmword ptr [rax+r11*1+0x30]
vaddpd xmm7, xmm6, xmmword ptr [rax+r14*1+0x30]
vaddpd xmm8, xmm7, xmmword ptr [rax+rbx*1+0x10]
vaddpd xmm9, xmm8, xmmword ptr [rax+rbx*1+0x50]
vaddpd xmm10, xmm9, xmmword ptr [rax+rsi*1+0x30]
vaddpd xmm11, xmm10, xmmword ptr [rax+rdi*1+0x30]
vaddpd xmm12, xmm11, xmmword ptr [rax+r8*1+0x30]
mov r15, qword ptr [rsp+0x180]
inc r12
mov r13, qword ptr [rsp+0x190]
vaddpd xmm13, xmm12, xmmword ptr [rax+r15*1+0x30]
vmovupd xmm0, xmmword ptr [rax+r13*1+0x30]
vaddpd xmm14, xmm13, xmmword ptr [rax+rbx*1]
vaddpd xmm15, xmm14, xmmword ptr [rax+rbx*1+0x60]
mov r15, qword ptr [rsp+0x178]
vunpckhpd xmm0, xmm0, xmm0
vmovddup xmm7, qword ptr [rax+r13*1+0x30]
vaddpd xmm1, xmm15, xmmword ptr [rax+r15*1+0x30]
vaddpd xmm2, xmm1, xmmword ptr [rax+r9*1+0x30]
vaddpd xmm3, xmm2, xmmword ptr [rax+r10*1+0x30]
mov r15, qword ptr [rsp+0x1a0]
mov r13, qword ptr [rsp+0x188]
vaddpd xmm5, xmm3, xmmword ptr [rax+r15*1+0x30]
vshufpd xmm4, xmm5, xmm5, 0x1
vmulpd xmm6, xmm0, xmm4
vfmaddsub213pd xmm7, xmm5, xmm6
vmovupd xmmword ptr [rax+r13*1+0x30], xmm7
add rax, 0x10
cmp r12, qword ptr [rsp+0x198]
jb 0xffffffffffffff29
{%- endcapture -%}
...
|:---:|---:|---:|
|```48*M*N*P < 32768```|0|21|
|144*N*P - 144*P <= 32768```|3|18|
|144*N*P + 96*P <= 32768```|5|16|
|240*P - 432 <= 32768```|9|12|
|240*P + 96 <= 32768```|11|10|
|Else|15|6|
...
|condition|misses|hits|
|:---:|---:|---:|
|```48*M*N*P < 262144```|0|21|
|144*N*P - 144*P <= 262144```|3|18|
|144*N*P + 96*P <= 262144```|5|16|
|240*P - 432 <= 262144```|9|12|
|240*P + 96 <= 262144```|11|10|
|Else|15|6|
...
|condition|misses|hits|
|:---:|---:|---:|
|```48*M*N*P < 23592960```|0|21|
|144*N*P - 144*P <= 23592960```|3|18|
|144*N*P + 96*P <= 23592960```|5|16|
|240*P - 432 <= 23592960```|9|12|
|240*P + 96 <= 23592960```|11|10|
|Else|15|6|
...
--------------------------
Block Throughput: 18.42 Cycles       Throughput Bottleneck: Backend
Loop Count:  22
Port Binding In Cycles Per Iteration:
--------------------------------------------------------------------------------------------------
|  Port  |   0   -  DV   |   1   |   2   -  D    |   3   -  D    |   4   |   5   |   6   |   7   |
--------------------------------------------------------------------------------------------------
| Cycles |  2.3     0.0  | 18.0  | 14.0    13.0  | 14.0    14.0  |  1.0  |  2.3  |  2.4  |  0.0  |
--------------------------------------------------------------------------------------------------
...
-----------------------------------------------------------------------------------------
|   1      |             |      | 1.0     1.0 |             |      |      |      |      | vmovupd xmm1, xmmword ptr [rax+rbx*1+0x30]
|   2      |             | 1.0  |             | 1.0     1.0 |      |      |      |      | vaddpd xmm2, xmm1, xmmword ptr [rax+rbx*1+0x20]
|   2      |             | 1.0  | 1.0     1.0 |             |      |      |      |      | vaddpd xmm3, xmm2, xmmword ptr [rax+rbx*1+0x40]
|   2      |             | 1.0  |             | 1.0     1.0 |      |      |      |      | vaddpd xmm4, xmm3, xmmword ptr [rax+rcx*1+0x30]
|   2      |             | 1.0  | 1.0     1.0 |             |      |      |      |      | vaddpd xmm5, xmm4, xmmword ptr [rax+rdx*1+0x30]
|   2      |             | 1.0  |             | 1.0     1.0 |      |      |      |      | vaddpd xmm6, xmm5, xmmword ptr [rax+r11*1+0x30]
|   2      |             | 1.0  | 1.0     1.0 |             |      |      |      |      | vaddpd xmm7, xmm6, xmmword ptr [rax+r14*1+0x30]
|   2      |             | 1.0  |             | 1.0     1.0 |      |      |      |      | vaddpd xmm8, xmm7, xmmword ptr [rax+rbx*1+0x10]
|   2      |             | 1.0  | 1.0     1.0 |             |      |      |      |      | vaddpd xmm9, xmm8, xmmword ptr [rax+rbx*1+0x50]
|   2      |             | 1.0  |             | 1.0     1.0 |      |      |      |      | vaddpd xmm10, xmm9, xmmword ptr [rax+rsi*1+0x30]
|   2      |             | 1.0  | 1.0     1.0 |             |      |      |      |      | vaddpd xmm11, xmm10, xmmword ptr [rax+rdi*1+0x30]
|   2      |             | 1.0  |             | 1.0     1.0 |      |      |      |      | vaddpd xmm12, xmm11, xmmword ptr [rax+r8*1+0x30]
|   1      |             |      | 1.0     1.0 |             |      |      |      |      | mov r15, qword ptr [rsp+0x180]
|   1      | 0.3         |      |             |             |      | 0.3  | 0.4  |      | inc r12
|   1      |             |      |             | 1.0     1.0 |      |      |      |      | mov r13, qword ptr [rsp+0x190]
|   2      |             | 1.0  | 1.0     1.0 |             |      |      |      |      | vaddpd xmm13, xmm12, xmmword ptr [rax+r15*1+0x30]
|   1      |             |      |             | 1.0     1.0 |      |      |      |      | vmovupd xmm0, xmmword ptr [rax+r13*1+0x30]
|   2      |             | 1.0  | 1.0     1.0 |             |      |      |      |      | vaddpd xmm14, xmm13, xmmword ptr [rax+rbx*1]
|   2      |             | 1.0  |             | 1.0     1.0 |      |      |      |      | vaddpd xmm15, xmm14, xmmword ptr [rax+rbx*1+0x60]
|   1      |             |      | 1.0     1.0 |             |      |      |      |      | mov r15, qword ptr [rsp+0x178]
|   1      |             |      |             |             |      | 1.0  |      |      | vunpckhpd xmm0, xmm0, xmm0
|   1      |             |      |             | 1.0     1.0 |      |      |      |      | vmovddup xmm7, qword ptr [rax+r13*1+0x30]
|   2      |             | 1.0  | 1.0     1.0 |             |      |      |      |      | vaddpd xmm1, xmm15, xmmword ptr [rax+r15*1+0x30]
|   2      |             | 1.0  |             | 1.0     1.0 |      |      |      |      | vaddpd xmm2, xmm1, xmmword ptr [rax+r9*1+0x30]
|   2      |             | 1.0  | 1.0     1.0 |             |      |      |      |      | vaddpd xmm3, xmm2, xmmword ptr [rax+r10*1+0x30]
|   1      |             |      |             | 1.0     1.0 |      |      |      |      | mov r15, qword ptr [rsp+0x1a0]
|   1      |             |      | 1.0     1.0 |             |      |      |      |      | mov r13, qword ptr [rsp+0x188]
|   2      |             | 1.0  |             | 1.0     1.0 |      |      |      |      | vaddpd xmm5, xmm3, xmmword ptr [rax+r15*1+0x30]
|   1      |             |      |             |             |      | 1.0  |      |      | vshufpd xmm4, xmm5, xmm5, 0x1
|   1      | 1.0         |      |             |             |      |      |      |      | vmulpd xmm6, xmm0, xmm4
|   1      | 1.0         |      |             |             |      |      |      |      | vfmaddsub213pd xmm7, xmm5, xmm6
|   2      |             |      | 1.0         |             | 1.0  |      |      |      | vmovupd xmmword ptr [rax+r13*1+0x30], xmm7
|   1      |             |      |             |             |      |      | 1.0  |      | add rax, 0x10
|   2^     |             |      |             | 1.0     1.0 |      |      | 1.0  |      | cmp r12, qword ptr [rsp+0x198]
|   0*F    |             |      |             |             |      |      |      |      | jb 0xffffffffffffff29
Total Num Of Uops: 54
Analysis Notes:
...
# Logged in users
################################################################################
 19:24:07 up 70 days,  9:37,  0 users,  load average: 2.54, 1.72, 1.38
...
CPU 0: governor  performance min/cur/max 2.3/1.635/2.3 GHz Turbo 0
CPU 1: governor  performance min/cur/max 2.3/2.242/2.3 GHz Turbo 0
CPU 2: governor  performance min/cur/max 2.3/2.224/2.3 GHz Turbo 0
CPU 3: governor  performance min/cur/max 2.3/2.262/2.3 GHz Turbo 0
CPU 4: governor  performance min/cur/max 2.3/1.353/2.3 GHz Turbo 0
CPU 5: governor  performance min/cur/max 2.3/1.223/2.3 GHz Turbo 0
CPU 6: governor  performance min/cur/max 2.3/1.785/2.3 GHz Turbo 0
CPU 7: governor  performance min/cur/max 2.3/2.243/2.3 GHz Turbo 0
CPU 8: governor  performance min/cur/max 2.3/2.263/2.3 GHz Turbo 0
CPU 9: governor  performance min/cur/max 2.3/1.383/2.3 GHz Turbo 0
CPU 10: governor  performance min/cur/max 2.3/1.768/2.3 GHz Turbo 0
CPU 11: governor  performance min/cur/max 2.3/2.246/2.3 GHz Turbo 0
CPU 12: governor  performance min/cur/max 2.3/2.180/2.3 GHz Turbo 0
CPU 13: governor  performance min/cur/max 2.3/1.857/2.3 GHz Turbo 0
CPU 14: governor  performance min/cur/max 2.3/2.278/2.3 GHz Turbo 0
CPU 15: governor  performance min/cur/max 2.3/2.177/2.3 GHz Turbo 0
CPU 16: governor  performance min/cur/max 2.3/1.349/2.3 GHz Turbo 0
CPU 17: governor  performance min/cur/max 2.3/1.788/2.3 GHz Turbo 0
...
CPU 20: governor  performance min/cur/max 2.3/2.298/2.3 GHz Turbo 0
CPU 21: governor  performance min/cur/max 2.3/2.283/2.3 GHz Turbo 0
CPU 22: governor  performance min/cur/max 2.3/2.282/2.3 GHz Turbo 0
...
CPU 25: governor  performance min/cur/max 2.3/2.271/2.3 GHz Turbo 0
CPU 26: governor  performance min/cur/max 2.3/2.296/2.3 GHz Turbo 0
CPU 27: governor  performance min/cur/max 2.3/2.297/2.3 GHz Turbo 0
CPU 28: governor  performance min/cur/max 2.3/2.245/2.3 GHz Turbo 0
CPU 29: governor  performance min/cur/max 2.3/2.297/2.3 GHz Turbo 0
CPU 30: governor  performance min/cur/max 2.3/2.151/2.3 GHz Turbo 0
CPU 31: governor  performance min/cur/max 2.3/2.295/2.3 GHz Turbo 0
CPU 32: governor  performance min/cur/max 2.3/2.265/2.3 GHz Turbo 0
CPU 33: governor  performance min/cur/max 2.3/2.253/2.3 GHz Turbo 0
CPU 34: governor  performance min/cur/max 2.3/2.283/2.3 GHz Turbo 0
CPU 35: governor  performance min/cur/max 2.3/2.298/2.3 GHz Turbo 0
CPU 36: governor  performance min/cur/max 2.3/1.935/2.3 GHz Turbo 0
CPU 37: governor  performance min/cur/max 2.3/1.412/2.3 GHz Turbo 0
CPU 38: governor  performance min/cur/max 2.3/1.490/2.3 GHz Turbo 0
CPU 39: governor  performance min/cur/max 2.3/1.307/2.3 GHz Turbo 0
CPU 40: governor  performance min/cur/max 2.3/1.242/2.3 GHz Turbo 0
CPU 41: governor  performance min/cur/max 2.3/1.961/2.3 GHz Turbo 0
CPU 42: governor  performance min/cur/max 2.3/2.130/2.3 GHz Turbo 0
CPU 43: governor  performance min/cur/max 2.3/2.297/2.3 GHz Turbo 0
CPU 44: governor  performance min/cur/max 2.3/1.198/2.3 GHz Turbo 0
CPU 45: governor  performance min/cur/max 2.3/1.402/2.3 GHz Turbo 0
CPU 46: governor  performance min/cur/max 2.3/1.293/2.3 GHz Turbo 0
CPU 47: governor  performance min/cur/max 2.3/2.251/2.3 GHz Turbo 0
CPU 48: governor  performance min/cur/max 2.3/2.208/2.3 GHz Turbo 0
CPU 49: governor  performance min/cur/max 2.3/1.279/2.3 GHz Turbo 0
CPU 50: governor  performance min/cur/max 2.3/2.254/2.3 GHz Turbo 0
CPU 51: governor  performance min/cur/max 2.3/2.251/2.3 GHz Turbo 0
CPU 52: governor  performance min/cur/max 2.3/1.640/2.3 GHz Turbo 0
CPU 53: governor  performance min/cur/max 2.3/1.219/2.3 GHz Turbo 0
CPU 54: governor  performance min/cur/max 2.3/2.296/2.3 GHz Turbo 0
CPU 55: governor  performance min/cur/max 2.3/2.296/2.3 GHz Turbo 0
CPU 56: governor  performance min/cur/max 2.3/2.297/2.3 GHz Turbo 0
CPU 57: governor  performance min/cur/max 2.3/2.284/2.3 GHz Turbo 0
CPU 58: governor  performance min/cur/max 2.3/2.293/2.3 GHz Turbo 0
CPU 59: governor  performance min/cur/max 2.3/2.293/2.3 GHz Turbo 0
CPU 60: governor  performance min/cur/max 2.3/2.295/2.3 GHz Turbo 0
CPU 61: governor  performance min/cur/max 2.3/2.283/2.3 GHz Turbo 0
CPU 62: governor  performance min/cur/max 2.3/2.292/2.3 GHz Turbo 0
CPU 63: governor  performance min/cur/max 2.3/2.295/2.3 GHz Turbo 0
CPU 64: governor  performance min/cur/max 2.3/2.274/2.3 GHz Turbo 0
CPU 65: governor  performance min/cur/max 2.3/2.297/2.3 GHz Turbo 0
CPU 66: governor  performance min/cur/max 2.3/2.195/2.3 GHz Turbo 0
CPU 67: governor  performance min/cur/max 2.3/2.286/2.3 GHz Turbo 0
CPU 68: governor  performance min/cur/max 2.3/2.295/2.3 GHz Turbo 0
CPU 69: governor  performance min/cur/max 2.3/2.294/2.3 GHz Turbo 0
CPU 70: governor  performance min/cur/max 2.3/2.291/2.3 GHz Turbo 0
...
MemFree:        130157436 kB
MemAvailable:   129870960 kB
Buffers:           20820 kB
Cached:           232636 kB
SwapCached:            0 kB
Active:           231752 kB
Inactive:          68532 kB
Active(anon):      46856 kB
Inactive(anon):     1896 kB
Active(file):     184896 kB
Inactive(file):    66636 kB
Unevictable:           0 kB
Mlocked:               0 kB
...
Shmem:              1920 kB
Slab:             622916 kB
SReclaimable:     246436 kB
SUnreclaim:       376480 kB
...
OLDPWD=/home/hpc/iwia/iwia84/INSPECT-repo/stencils/3D_r3_heterogeneous_star_variable/BroadwellEP_E5-2697_CoD_20190705_191135
...
PWD=/home/hpc/iwia/iwia84/INSPECT-repo/stencils/3D_r3_homogeneous_star_variable/BroadwellEP_E5-2697_CoD_20190705_192407
