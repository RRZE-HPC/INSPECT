...
title:  "Stencil 3D r3 star constant homogeneous double _Complex BroadwellEP_E5-2697_CoD"
...
vmovupd xmm4, xmmword ptr [rax+rbx*1+0x30]
vaddpd xmm5, xmm4, xmmword ptr [rax+rbx*1+0x20]
vaddpd xmm6, xmm5, xmmword ptr [rax+rbx*1+0x40]
vaddpd xmm7, xmm6, xmmword ptr [rax+rdx*1+0x30]
vaddpd xmm8, xmm7, xmmword ptr [rax+rcx*1+0x30]
vaddpd xmm9, xmm8, xmmword ptr [rax+r9*1+0x30]
vaddpd xmm10, xmm9, xmmword ptr [rax+r13*1+0x30]
vaddpd xmm11, xmm10, xmmword ptr [rax+rbx*1+0x10]
vaddpd xmm12, xmm11, xmmword ptr [rax+rbx*1+0x50]
vaddpd xmm13, xmm12, xmmword ptr [rax+r14*1+0x30]
vaddpd xmm14, xmm13, xmmword ptr [rax+r12*1+0x30]
mov r15, qword ptr [rsp+0x170]
inc r10
vaddpd xmm15, xmm14, xmmword ptr [rax+r15*1+0x30]
mov r15, qword ptr [rsp+0x180]
vaddpd xmm4, xmm15, xmmword ptr [rax+r15*1+0x30]
vaddpd xmm5, xmm4, xmmword ptr [rax+rbx*1]
vaddpd xmm6, xmm5, xmmword ptr [rax+rbx*1+0x60]
vaddpd xmm7, xmm6, xmmword ptr [rax+r11*1+0x30]
vaddpd xmm8, xmm7, xmmword ptr [rax+rsi*1+0x30]
vaddpd xmm9, xmm8, xmmword ptr [rax+rdi*1+0x30]
mov r15, qword ptr [rsp+0x178]
vaddpd xmm10, xmm9, xmmword ptr [rax+r15*1+0x30]
vunpckhpd xmm11, xmm10, xmm10
vmulpd xmm12, xmm11, xmm3
vmovddup xmm13, xmm10
vfmaddsub213pd xmm13, xmm2, xmm12
vmovupd xmmword ptr [rax+r8*1+0x30], xmm13
add rax, 0x10
cmp r10, qword ptr [rsp+0x188]
jb 0xffffffffffffff46
{%- endcapture -%}
...
--------------------------
Block Throughput: 18.84 Cycles       Throughput Bottleneck: Backend
Loop Count:  22
Port Binding In Cycles Per Iteration:
--------------------------------------------------------------------------------------------------
|  Port  |   0   -  DV   |   1   |   2   -  D    |   3   -  D    |   4   |   5   |   6   |   7   |
--------------------------------------------------------------------------------------------------
| Cycles |  2.3     0.0  | 18.0  | 12.0    11.0  | 12.0    12.0  |  1.0  |  2.3  |  2.4  |  0.0  |
--------------------------------------------------------------------------------------------------
...
-----------------------------------------------------------------------------------------
|   1      |             |      | 1.0     1.0 |             |      |      |      |      | vmovupd xmm4, xmmword ptr [rax+rbx*1+0x30]
|   2      |             | 1.0  |             | 1.0     1.0 |      |      |      |      | vaddpd xmm5, xmm4, xmmword ptr [rax+rbx*1+0x20]
|   2      |             | 1.0  | 1.0     1.0 |             |      |      |      |      | vaddpd xmm6, xmm5, xmmword ptr [rax+rbx*1+0x40]
|   2      |             | 1.0  |             | 1.0     1.0 |      |      |      |      | vaddpd xmm7, xmm6, xmmword ptr [rax+rdx*1+0x30]
|   2      |             | 1.0  | 1.0     1.0 |             |      |      |      |      | vaddpd xmm8, xmm7, xmmword ptr [rax+rcx*1+0x30]
|   2      |             | 1.0  |             | 1.0     1.0 |      |      |      |      | vaddpd xmm9, xmm8, xmmword ptr [rax+r9*1+0x30]
|   2      |             | 1.0  | 1.0     1.0 |             |      |      |      |      | vaddpd xmm10, xmm9, xmmword ptr [rax+r13*1+0x30]
|   2      |             | 1.0  |             | 1.0     1.0 |      |      |      |      | vaddpd xmm11, xmm10, xmmword ptr [rax+rbx*1+0x10]
|   2      |             | 1.0  | 1.0     1.0 |             |      |      |      |      | vaddpd xmm12, xmm11, xmmword ptr [rax+rbx*1+0x50]
|   2      |             | 1.0  |             | 1.0     1.0 |      |      |      |      | vaddpd xmm13, xmm12, xmmword ptr [rax+r14*1+0x30]
|   2      |             | 1.0  | 1.0     1.0 |             |      |      |      |      | vaddpd xmm14, xmm13, xmmword ptr [rax+r12*1+0x30]
|   1      |             |      |             | 1.0     1.0 |      |      |      |      | mov r15, qword ptr [rsp+0x170]
|   1      | 0.3         |      |             |             |      | 0.3  | 0.4  |      | inc r10
|   2      |             | 1.0  | 1.0     1.0 |             |      |      |      |      | vaddpd xmm15, xmm14, xmmword ptr [rax+r15*1+0x30]
|   1      |             |      |             | 1.0     1.0 |      |      |      |      | mov r15, qword ptr [rsp+0x180]
|   2      |             | 1.0  | 1.0     1.0 |             |      |      |      |      | vaddpd xmm4, xmm15, xmmword ptr [rax+r15*1+0x30]
|   2      |             | 1.0  |             | 1.0     1.0 |      |      |      |      | vaddpd xmm5, xmm4, xmmword ptr [rax+rbx*1]
|   2      |             | 1.0  | 1.0     1.0 |             |      |      |      |      | vaddpd xmm6, xmm5, xmmword ptr [rax+rbx*1+0x60]
|   2      |             | 1.0  |             | 1.0     1.0 |      |      |      |      | vaddpd xmm7, xmm6, xmmword ptr [rax+r11*1+0x30]
|   2      |             | 1.0  | 1.0     1.0 |             |      |      |      |      | vaddpd xmm8, xmm7, xmmword ptr [rax+rsi*1+0x30]
|   2      |             | 1.0  |             | 1.0     1.0 |      |      |      |      | vaddpd xmm9, xmm8, xmmword ptr [rax+rdi*1+0x30]
|   1      |             |      | 1.0     1.0 |             |      |      |      |      | mov r15, qword ptr [rsp+0x178]
|   2      |             | 1.0  |             | 1.0     1.0 |      |      |      |      | vaddpd xmm10, xmm9, xmmword ptr [rax+r15*1+0x30]
|   1      |             |      |             |             |      | 1.0  |      |      | vunpckhpd xmm11, xmm10, xmm10
|   1      | 1.0         |      |             |             |      |      |      |      | vmulpd xmm12, xmm11, xmm3
|   1      |             |      |             |             |      | 1.0  |      |      | vmovddup xmm13, xmm10
|   1      | 1.0         |      |             |             |      |      |      |      | vfmaddsub213pd xmm13, xmm2, xmm12
|   2      |             |      | 1.0         |             | 1.0  |      |      |      | vmovupd xmmword ptr [rax+r8*1+0x30], xmm13
|   1      |             |      |             |             |      |      | 1.0  |      | add rax, 0x10
|   2^     |             |      |             | 1.0     1.0 |      |      | 1.0  |      | cmp r10, qword ptr [rsp+0x188]
|   0*F    |             |      |             |             |      |      |      |      | jb 0xffffffffffffff46
...
# Logged in users
################################################################################
 17:21:33 up 74 days,  7:35,  0 users,  load average: 3.21, 2.10, 1.42
...
CPU 0: governor  performance min/cur/max 2.3/1.516952/2.3 GHz Turbo 0
CPU 1: governor  performance min/cur/max 2.3/2.250018/2.3 GHz Turbo 0
CPU 2: governor  performance min/cur/max 2.3/2.114687/2.3 GHz Turbo 0
CPU 3: governor  performance min/cur/max 2.3/2.241488/2.3 GHz Turbo 0
CPU 4: governor  performance min/cur/max 2.3/2.267696/2.3 GHz Turbo 0
CPU 5: governor  performance min/cur/max 2.3/2.206805/2.3 GHz Turbo 0
CPU 6: governor  performance min/cur/max 2.3/2.115235/2.3 GHz Turbo 0
CPU 7: governor  performance min/cur/max 2.3/2.267897/2.3 GHz Turbo 0
CPU 8: governor  performance min/cur/max 2.3/2.273082/2.3 GHz Turbo 0
CPU 9: governor  performance min/cur/max 2.3/2.054522/2.3 GHz Turbo 0
CPU 10: governor  performance min/cur/max 2.3/2.134063/2.3 GHz Turbo 0
CPU 11: governor  performance min/cur/max 2.3/2.27391/2.3 GHz Turbo 0
CPU 12: governor  performance min/cur/max 2.3/2.014235/2.3 GHz Turbo 0
CPU 13: governor  performance min/cur/max 2.3/2.272774/2.3 GHz Turbo 0
CPU 14: governor  performance min/cur/max 2.3/2.263325/2.3 GHz Turbo 0
CPU 15: governor  performance min/cur/max 2.3/2.099176/2.3 GHz Turbo 0
CPU 16: governor  performance min/cur/max 2.3/1.881426/2.3 GHz Turbo 0
CPU 17: governor  performance min/cur/max 2.3/2.177444/2.3 GHz Turbo 0
CPU 18: governor  performance min/cur/max 2.3/2.289718/2.3 GHz Turbo 0
CPU 19: governor  performance min/cur/max 2.3/2.287095/2.3 GHz Turbo 0
CPU 20: governor  performance min/cur/max 2.3/2.278691/2.3 GHz Turbo 0
CPU 21: governor  performance min/cur/max 2.3/2.283121/2.3 GHz Turbo 0
CPU 22: governor  performance min/cur/max 2.3/2.291226/2.3 GHz Turbo 0
CPU 23: governor  performance min/cur/max 2.3/2.288557/2.3 GHz Turbo 0
CPU 24: governor  performance min/cur/max 2.3/2.288569/2.3 GHz Turbo 0
CPU 25: governor  performance min/cur/max 2.3/2.289538/2.3 GHz Turbo 0
CPU 26: governor  performance min/cur/max 2.3/2.294596/2.3 GHz Turbo 0
CPU 27: governor  performance min/cur/max 2.3/2.268478/2.3 GHz Turbo 0
CPU 28: governor  performance min/cur/max 2.3/2.262531/2.3 GHz Turbo 0
CPU 29: governor  performance min/cur/max 2.3/2.297642/2.3 GHz Turbo 0
CPU 30: governor  performance min/cur/max 2.3/2.260625/2.3 GHz Turbo 0
CPU 31: governor  performance min/cur/max 2.3/2.293958/2.3 GHz Turbo 0
CPU 32: governor  performance min/cur/max 2.3/2.278503/2.3 GHz Turbo 0
CPU 33: governor  performance min/cur/max 2.3/2.251584/2.3 GHz Turbo 0
CPU 34: governor  performance min/cur/max 2.3/2.251407/2.3 GHz Turbo 0
CPU 35: governor  performance min/cur/max 2.3/2.29777/2.3 GHz Turbo 0
CPU 36: governor  performance min/cur/max 2.3/1.988477/2.3 GHz Turbo 0
CPU 37: governor  performance min/cur/max 2.3/2.295892/2.3 GHz Turbo 0
CPU 38: governor  performance min/cur/max 2.3/2.282917/2.3 GHz Turbo 0
CPU 39: governor  performance min/cur/max 2.3/2.136412/2.3 GHz Turbo 0
CPU 40: governor  performance min/cur/max 2.3/2.297378/2.3 GHz Turbo 0
CPU 41: governor  performance min/cur/max 2.3/2.097959/2.3 GHz Turbo 0
CPU 42: governor  performance min/cur/max 2.3/2.270164/2.3 GHz Turbo 0
CPU 43: governor  performance min/cur/max 2.3/2.297425/2.3 GHz Turbo 0
CPU 44: governor  performance min/cur/max 2.3/2.297385/2.3 GHz Turbo 0
CPU 45: governor  performance min/cur/max 2.3/2.244661/2.3 GHz Turbo 0
CPU 46: governor  performance min/cur/max 2.3/1.903258/2.3 GHz Turbo 0
CPU 47: governor  performance min/cur/max 2.3/2.297361/2.3 GHz Turbo 0
CPU 48: governor  performance min/cur/max 2.3/2.255063/2.3 GHz Turbo 0
CPU 49: governor  performance min/cur/max 2.3/2.297385/2.3 GHz Turbo 0
CPU 50: governor  performance min/cur/max 2.3/2.250103/2.3 GHz Turbo 0
CPU 51: governor  performance min/cur/max 2.3/2.253053/2.3 GHz Turbo 0
CPU 52: governor  performance min/cur/max 2.3/2.164868/2.3 GHz Turbo 0
CPU 53: governor  performance min/cur/max 2.3/2.277556/2.3 GHz Turbo 0
CPU 54: governor  performance min/cur/max 2.3/2.293433/2.3 GHz Turbo 0
CPU 55: governor  performance min/cur/max 2.3/2.286222/2.3 GHz Turbo 0
CPU 56: governor  performance min/cur/max 2.3/2.284012/2.3 GHz Turbo 0
CPU 57: governor  performance min/cur/max 2.3/2.294029/2.3 GHz Turbo 0
CPU 58: governor  performance min/cur/max 2.3/2.291185/2.3 GHz Turbo 0
CPU 59: governor  performance min/cur/max 2.3/2.286362/2.3 GHz Turbo 0
CPU 60: governor  performance min/cur/max 2.3/2.291548/2.3 GHz Turbo 0
CPU 61: governor  performance min/cur/max 2.3/2.294843/2.3 GHz Turbo 0
CPU 62: governor  performance min/cur/max 2.3/2.283085/2.3 GHz Turbo 0
CPU 63: governor  performance min/cur/max 2.3/2.290307/2.3 GHz Turbo 0
CPU 64: governor  performance min/cur/max 2.3/2.109783/2.3 GHz Turbo 0
CPU 65: governor  performance min/cur/max 2.3/2.297447/2.3 GHz Turbo 0
CPU 66: governor  performance min/cur/max 2.3/2.220868/2.3 GHz Turbo 0
CPU 67: governor  performance min/cur/max 2.3/2.291665/2.3 GHz Turbo 0
CPU 68: governor  performance min/cur/max 2.3/2.278373/2.3 GHz Turbo 0
CPU 69: governor  performance min/cur/max 2.3/2.282026/2.3 GHz Turbo 0
CPU 70: governor  performance min/cur/max 2.3/2.284178/2.3 GHz Turbo 0
CPU 71: governor  performance min/cur/max 2.3/2.297433/2.3 GHz Turbo 0
...
MemFree:        129832948 kB
MemAvailable:   129710724 kB
Buffers:           22116 kB
Cached:           531848 kB
SwapCached:            0 kB
Active:           449312 kB
Inactive:         152368 kB
Active(anon):      48008 kB
Inactive(anon):     1628 kB
Active(file):     401304 kB
Inactive(file):   150740 kB
Unevictable:           0 kB
Mlocked:               0 kB
...
Shmem:              1920 kB
Slab:             645480 kB
SReclaimable:     256376 kB
SUnreclaim:       389104 kB
...
OLDPWD=/home/hpc/iwia/iwia84/INSPECT-repo/stencils/3D_r3_heterogeneous_star_constant/BroadwellEP_E5-2697_CoD_20190709_170206
...
PWD=/home/hpc/iwia/iwia84/INSPECT-repo/stencils/3D_r3_homogeneous_star_constant/BroadwellEP_E5-2697_CoD_20190709_172133
