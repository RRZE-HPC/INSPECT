...
title:  "Stencil 3D r3 star constant homogeneous double _Complex SkylakeSP_Gold-6148_SNC"
...
vaddpd xmm5, xmm4, xmmword ptr [rax+rdx*1+0x20]
vaddpd xmm6, xmm5, xmmword ptr [rax+rdx*1+0x40]
vaddpd xmm7, xmm6, xmmword ptr [rax+rdi*1+0x30]
vaddpd xmm8, xmm7, xmmword ptr [rax+r8*1+0x30]
vaddpd xmm9, xmm8, xmmword ptr [rax+rcx*1+0x30]
vaddpd xmm10, xmm9, xmmword ptr [rax+r9*1+0x30]
vaddpd xmm11, xmm10, xmmword ptr [rax+rdx*1+0x10]
vaddpd xmm12, xmm11, xmmword ptr [rax+rdx*1+0x50]
mov r15, qword ptr [rsp+0x1a0]
inc r11
vaddpd xmm13, xmm12, xmmword ptr [rax+r15*1+0x30]
vaddpd xmm14, xmm13, xmmword ptr [rax+r12*1+0x30]
vaddpd xmm15, xmm14, xmmword ptr [rax+rbx*1+0x30]
mov r15, qword ptr [rsp+0x190]
vaddpd xmm16, xmm15, xmmword ptr [rax+r15*1+0x30]
vaddpd xmm17, xmm16, xmmword ptr [rax+rdx*1]
vaddpd xmm18, xmm17, xmmword ptr [rax+rdx*1+0x60]
vaddpd xmm19, xmm18, xmmword ptr [rax+r13*1+0x30]
vaddpd xmm20, xmm19, xmmword ptr [rax+r14*1+0x30]
vaddpd xmm21, xmm20, xmmword ptr [rax+r10*1+0x30]
vaddpd xmm22, xmm21, xmmword ptr [rax+rsi*1+0x30]
vunpckhpd xmm23, xmm22, xmm22
vmulpd xmm24, xmm23, xmm3
vmovddup xmm25, xmm22
vfmaddsub213pd xmm25, xmm2, xmm24
mov r15, qword ptr [rsp+0x198]
vmovupd xmmword ptr [rax+r15*1+0x30], xmm25
add rax, 0x10
cmp r11, qword ptr [rsp+0x1a8]
jb 0xffffffffffffff36
{%- endcapture -%}
...
--------------------------
Block Throughput: 25.90 Cycles       Throughput Bottleneck: Backend
Loop Count:  24
Port Binding In Cycles Per Iteration:
--------------------------------------------------------------------------------------------------
|  Port  |   0   -  DV   |   1   |   2   -  D    |   3   -  D    |   4   |   5   |   6   |   7   |
--------------------------------------------------------------------------------------------------
| Cycles | 10.0     0.0  | 10.0  | 12.0    11.0  | 12.0    12.0  |  1.0  |  2.5  |  2.5  |  0.0  |
--------------------------------------------------------------------------------------------------
...
|   2      | 1.0         |      |             | 1.0     1.0 |      |      |      |      | vaddpd xmm5, xmm4, xmmword ptr [rax+rdx*1+0x20]
|   2      |             | 1.0  | 1.0     1.0 |             |      |      |      |      | vaddpd xmm6, xmm5, xmmword ptr [rax+rdx*1+0x40]
|   2      | 1.0         |      |             | 1.0     1.0 |      |      |      |      | vaddpd xmm7, xmm6, xmmword ptr [rax+rdi*1+0x30]
|   2      |             | 1.0  | 1.0     1.0 |             |      |      |      |      | vaddpd xmm8, xmm7, xmmword ptr [rax+r8*1+0x30]
|   2      | 1.0         |      |             | 1.0     1.0 |      |      |      |      | vaddpd xmm9, xmm8, xmmword ptr [rax+rcx*1+0x30]
|   2      |             | 1.0  | 1.0     1.0 |             |      |      |      |      | vaddpd xmm10, xmm9, xmmword ptr [rax+r9*1+0x30]
|   2      | 1.0         |      |             | 1.0     1.0 |      |      |      |      | vaddpd xmm11, xmm10, xmmword ptr [rax+rdx*1+0x10]
|   2      |             | 1.0  | 1.0     1.0 |             |      |      |      |      | vaddpd xmm12, xmm11, xmmword ptr [rax+rdx*1+0x50]
|   1      |             |      |             | 1.0     1.0 |      |      |      |      | mov r15, qword ptr [rsp+0x1a0]
|   1      |             |      |             |             |      | 0.5  | 0.5  |      | inc r11
|   2      | 1.0         |      | 1.0     1.0 |             |      |      |      |      | vaddpd xmm13, xmm12, xmmword ptr [rax+r15*1+0x30]
|   2      |             | 1.0  |             | 1.0     1.0 |      |      |      |      | vaddpd xmm14, xmm13, xmmword ptr [rax+r12*1+0x30]
|   2      | 1.0         |      | 1.0     1.0 |             |      |      |      |      | vaddpd xmm15, xmm14, xmmword ptr [rax+rbx*1+0x30]
|   1      |             |      |             | 1.0     1.0 |      |      |      |      | mov r15, qword ptr [rsp+0x190]
|   2      |             | 1.0  | 1.0     1.0 |             |      |      |      |      | vaddpd xmm16, xmm15, xmmword ptr [rax+r15*1+0x30]
|   2      | 1.0         |      |             | 1.0     1.0 |      |      |      |      | vaddpd xmm17, xmm16, xmmword ptr [rax+rdx*1]
|   2      |             | 1.0  | 1.0     1.0 |             |      |      |      |      | vaddpd xmm18, xmm17, xmmword ptr [rax+rdx*1+0x60]
|   2      | 1.0         |      |             | 1.0     1.0 |      |      |      |      | vaddpd xmm19, xmm18, xmmword ptr [rax+r13*1+0x30]
|   2      |             | 1.0  | 1.0     1.0 |             |      |      |      |      | vaddpd xmm20, xmm19, xmmword ptr [rax+r14*1+0x30]
|   2      | 1.0         |      |             | 1.0     1.0 |      |      |      |      | vaddpd xmm21, xmm20, xmmword ptr [rax+r10*1+0x30]
|   2      |             | 1.0  | 1.0     1.0 |             |      |      |      |      | vaddpd xmm22, xmm21, xmmword ptr [rax+rsi*1+0x30]
|   1      |             |      |             |             |      | 1.0  |      |      | vunpckhpd xmm23, xmm22, xmm22
|   1      | 1.0         |      |             |             |      |      |      |      | vmulpd xmm24, xmm23, xmm3
|   1      |             |      |             |             |      | 1.0  |      |      | vmovddup xmm25, xmm22
|   1      |             | 1.0  |             |             |      |      |      |      | vfmaddsub213pd xmm25, xmm2, xmm24
|   1      |             |      |             | 1.0     1.0 |      |      |      |      | mov r15, qword ptr [rsp+0x198]
|   2      |             |      | 1.0         |             | 1.0  |      |      |      | vmovupd xmmword ptr [rax+r15*1+0x30], xmm25
|   1      |             |      |             |             |      |      | 1.0  |      | add rax, 0x10
|   2^     |             |      |             | 1.0     1.0 |      |      | 1.0  |      | cmp r11, qword ptr [rsp+0x1a8]
...
# Logged in users
################################################################################
 20:31:41 up 51 days,  3:18,  0 users,  load average: 6.67, 6.55, 3.99
...
CPU 0: governor  performance min/cur/max 2.4/1.517836/2.4 GHz Turbo 0
CPU 1: governor  performance min/cur/max 2.4/2.30927/2.4 GHz Turbo 0
CPU 2: governor  performance min/cur/max 2.4/1.976831/2.4 GHz Turbo 0
CPU 5: governor  performance min/cur/max 2.4/2.326795/2.4 GHz Turbo 0
CPU 6: governor  performance min/cur/max 2.4/2.041704/2.4 GHz Turbo 0
CPU 10: governor  performance min/cur/max 2.4/2.251083/2.4 GHz Turbo 0
CPU 11: governor  performance min/cur/max 2.4/2.042796/2.4 GHz Turbo 0
CPU 12: governor  performance min/cur/max 2.4/2.203/2.4 GHz Turbo 0
CPU 15: governor  performance min/cur/max 2.4/2.042861/2.4 GHz Turbo 0
CPU 16: governor  performance min/cur/max 2.4/1.388078/2.4 GHz Turbo 0
CPU 3: governor  performance min/cur/max 2.4/1.980979/2.4 GHz Turbo 0
CPU 4: governor  performance min/cur/max 2.4/2.114546/2.4 GHz Turbo 0
CPU 7: governor  performance min/cur/max 2.4/1.91977/2.4 GHz Turbo 0
CPU 8: governor  performance min/cur/max 2.4/2.022044/2.4 GHz Turbo 0
CPU 9: governor  performance min/cur/max 2.4/2.33679/2.4 GHz Turbo 0
CPU 13: governor  performance min/cur/max 2.4/2.181231/2.4 GHz Turbo 0
CPU 14: governor  performance min/cur/max 2.4/2.154019/2.4 GHz Turbo 0
CPU 17: governor  performance min/cur/max 2.4/1.971837/2.4 GHz Turbo 0
CPU 18: governor  performance min/cur/max 2.4/2.104907/2.4 GHz Turbo 0
CPU 19: governor  performance min/cur/max 2.4/2.284833/2.4 GHz Turbo 0
CPU 20: governor  performance min/cur/max 2.4/2.130563/2.4 GHz Turbo 0
CPU 21: governor  performance min/cur/max 2.4/2.207955/2.4 GHz Turbo 0
CPU 22: governor  performance min/cur/max 2.4/2.094016/2.4 GHz Turbo 0
CPU 25: governor  performance min/cur/max 2.4/2.175042/2.4 GHz Turbo 0
CPU 26: governor  performance min/cur/max 2.4/2.306086/2.4 GHz Turbo 0
CPU 30: governor  performance min/cur/max 2.4/2.114992/2.4 GHz Turbo 0
CPU 31: governor  performance min/cur/max 2.4/1.457089/2.4 GHz Turbo 0
CPU 32: governor  performance min/cur/max 2.4/1.682411/2.4 GHz Turbo 0
CPU 35: governor  performance min/cur/max 2.4/2.030886/2.4 GHz Turbo 0
CPU 36: governor  performance min/cur/max 2.4/1.377032/2.4 GHz Turbo 0
CPU 23: governor  performance min/cur/max 2.4/1.746686/2.4 GHz Turbo 0
CPU 24: governor  performance min/cur/max 2.4/2.120491/2.4 GHz Turbo 0
CPU 27: governor  performance min/cur/max 2.4/1.700911/2.4 GHz Turbo 0
CPU 28: governor  performance min/cur/max 2.4/1.638624/2.4 GHz Turbo 0
CPU 29: governor  performance min/cur/max 2.4/1.466602/2.4 GHz Turbo 0
CPU 33: governor  performance min/cur/max 2.4/1.768519/2.4 GHz Turbo 0
CPU 34: governor  performance min/cur/max 2.4/1.545823/2.4 GHz Turbo 0
CPU 37: governor  performance min/cur/max 2.4/2.035756/2.4 GHz Turbo 0
CPU 38: governor  performance min/cur/max 2.4/1.797526/2.4 GHz Turbo 0
CPU 39: governor  performance min/cur/max 2.4/1.601175/2.4 GHz Turbo 0
CPU 40: governor  performance min/cur/max 2.4/2.049938/2.4 GHz Turbo 0
CPU 41: governor  performance min/cur/max 2.4/2.249881/2.4 GHz Turbo 0
CPU 42: governor  performance min/cur/max 2.4/2.057766/2.4 GHz Turbo 0
CPU 45: governor  performance min/cur/max 2.4/1.897813/2.4 GHz Turbo 0
CPU 46: governor  performance min/cur/max 2.4/2.290359/2.4 GHz Turbo 0
CPU 50: governor  performance min/cur/max 2.4/2.359795/2.4 GHz Turbo 0
CPU 51: governor  performance min/cur/max 2.4/1.721899/2.4 GHz Turbo 0
CPU 52: governor  performance min/cur/max 2.4/1.919036/2.4 GHz Turbo 0
CPU 55: governor  performance min/cur/max 2.4/1.933204/2.4 GHz Turbo 0
CPU 56: governor  performance min/cur/max 2.4/2.23929/2.4 GHz Turbo 0
CPU 43: governor  performance min/cur/max 2.4/2.058732/2.4 GHz Turbo 0
CPU 44: governor  performance min/cur/max 2.4/2.035413/2.4 GHz Turbo 0
CPU 47: governor  performance min/cur/max 2.4/2.199959/2.4 GHz Turbo 0
CPU 48: governor  performance min/cur/max 2.4/2.234757/2.4 GHz Turbo 0
CPU 49: governor  performance min/cur/max 2.4/2.037581/2.4 GHz Turbo 0
CPU 53: governor  performance min/cur/max 2.4/2.179204/2.4 GHz Turbo 0
CPU 54: governor  performance min/cur/max 2.4/2.261549/2.4 GHz Turbo 0
CPU 57: governor  performance min/cur/max 2.4/2.022898/2.4 GHz Turbo 0
CPU 58: governor  performance min/cur/max 2.4/1.355009/2.4 GHz Turbo 0
CPU 59: governor  performance min/cur/max 2.4/1.790411/2.4 GHz Turbo 0
CPU 60: governor  performance min/cur/max 2.4/1.687594/2.4 GHz Turbo 0
CPU 61: governor  performance min/cur/max 2.4/1.94252/2.4 GHz Turbo 0
CPU 62: governor  performance min/cur/max 2.4/2.167048/2.4 GHz Turbo 0
CPU 65: governor  performance min/cur/max 2.4/2.329492/2.4 GHz Turbo 0
CPU 66: governor  performance min/cur/max 2.4/1.942224/2.4 GHz Turbo 0
CPU 70: governor  performance min/cur/max 2.4/1.182708/2.4 GHz Turbo 0
CPU 71: governor  performance min/cur/max 2.4/1.252507/2.4 GHz Turbo 0
CPU 72: governor  performance min/cur/max 2.4/1.889326/2.4 GHz Turbo 0
CPU 75: governor  performance min/cur/max 2.4/1.791632/2.4 GHz Turbo 0
CPU 76: governor  performance min/cur/max 2.4/2.141596/2.4 GHz Turbo 0
CPU 63: governor  performance min/cur/max 2.4/1.453449/2.4 GHz Turbo 0
CPU 64: governor  performance min/cur/max 2.4/2.231706/2.4 GHz Turbo 0
CPU 67: governor  performance min/cur/max 2.4/1.515859/2.4 GHz Turbo 0
CPU 68: governor  performance min/cur/max 2.4/1.591537/2.4 GHz Turbo 0
CPU 69: governor  performance min/cur/max 2.4/1.684561/2.4 GHz Turbo 0
CPU 73: governor  performance min/cur/max 2.4/1.791599/2.4 GHz Turbo 0
CPU 74: governor  performance min/cur/max 2.4/1.345019/2.4 GHz Turbo 0
CPU 77: governor  performance min/cur/max 2.4/1.629886/2.4 GHz Turbo 0
CPU 78: governor  performance min/cur/max 2.4/1.943524/2.4 GHz Turbo 0
CPU 79: governor  performance min/cur/max 2.4/1.218182/2.4 GHz Turbo 0
...
Inactive(anon):     4040 kB
Active(file):     389296 kB
...
Shmem:               308 kB
Slab:             841828 kB
SReclaimable:     330732 kB
SUnreclaim:       511096 kB
...
OLDPWD=/home/hpc/iwia/iwia84/INSPECT-repo/stencils/3D_r3_heterogeneous_star_constant/SkylakeSP_Gold-6148_SNC_20190719_154855
...
PWD=/home/hpc/iwia/iwia84/INSPECT-repo/stencils/3D_r3_homogeneous_star_constant/SkylakeSP_Gold-6148_SNC_20190719_203141
