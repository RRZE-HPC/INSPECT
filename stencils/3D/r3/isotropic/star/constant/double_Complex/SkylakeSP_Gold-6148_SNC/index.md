...
title:  "Stencil 3D r3 star constant isotropic double _Complex SkylakeSP_Gold-6148_SNC"
...
vmovupd xmm18, xmmword ptr [rax+rdx*1+0x20]
vmovupd xmm28, xmmword ptr [rax+rdx*1+0x10]
vaddpd xmm19, xmm18, xmmword ptr [rax+rdx*1+0x40]
vaddpd xmm29, xmm28, xmmword ptr [rax+rdx*1+0x50]
vmovupd xmm18, xmmword ptr [rax+rdx*1]
vaddpd xmm20, xmm19, xmmword ptr [rax+r13*1+0x30]
vaddpd xmm19, xmm18, xmmword ptr [rax+rdx*1+0x60]
vmovupd xmm16, xmmword ptr [rax+rdx*1+0x30]
vaddpd xmm21, xmm20, xmmword ptr [rax+r12*1+0x30]
vaddpd xmm20, xmm19, xmmword ptr [rax+rbx*1+0x30]
vaddpd xmm22, xmm21, xmmword ptr [rax+r8*1+0x30]
vaddpd xmm21, xmm20, xmmword ptr [rax+rdi*1+0x30]
vaddpd xmm23, xmm22, xmmword ptr [rax+r9*1+0x30]
vaddpd xmm22, xmm21, xmmword ptr [rax+rsi*1+0x30]
mov r15, qword ptr [rsp+0x198]
inc r11
vunpckhpd xmm17, xmm16, xmm16
vunpckhpd xmm24, xmm23, xmm23
vaddpd xmm30, xmm29, xmmword ptr [rax+r15*1+0x30]
vmulpd xmm26, xmm17, xmm15
vaddpd xmm31, xmm30, xmmword ptr [rax+r14*1+0x30]
vmulpd xmm25, xmm24, xmm13
vaddpd xmm28, xmm31, xmmword ptr [rax+r10*1+0x30]
vfmaddsub231pd xmm26, xmm14, qword ptr [rax+rdx*1+0x30]{1to2}
vmovddup xmm27, xmm23
mov r15, qword ptr [rsp+0x190]
vaddpd xmm23, xmm22, xmmword ptr [rax+rcx*1+0x30]
vfmaddsub213pd xmm27, xmm12, xmm25
vaddpd xmm29, xmm28, xmmword ptr [rax+r15*1+0x30]
vaddpd xmm16, xmm26, xmm27
vunpckhpd xmm30, xmm29, xmm29
vmulpd xmm31, xmm30, xmm11
vunpckhpd xmm24, xmm23, xmm23
vmulpd xmm25, xmm24, xmm9
vmovddup xmm17, xmm29
vfmaddsub213pd xmm17, xmm10, xmm31
vmovddup xmm27, xmm23
vfmaddsub213pd xmm27, xmm8, xmm25
vaddpd xmm26, xmm16, xmm17
vaddpd xmm16, xmm26, xmm27
nop 
mov r15, qword ptr [rsp+0x1a0]
vmovupd xmmword ptr [rax+r15*1+0x30], xmm16
add rax, 0x10
cmp r11, qword ptr [rsp+0x1a8]
jb 0xfffffffffffffecb
{%- endcapture -%}
...
--------------------------------------------------------------------------------------------------
| Cycles | 13.0     0.0  | 13.0  | 12.5    12.1  | 12.5    11.9  |  1.0  |  7.0  |  4.0  |  0.0  |
--------------------------------------------------------------------------------------------------
...
-----------------------------------------------------------------------------------------
|   1      |             |      | 0.5     0.5 | 0.5     0.5 |      |      |      |      | vmovupd xmm18, xmmword ptr [rax+rdx*1+0x20]
|   1      |             |      | 0.5     0.5 | 0.5     0.5 |      |      |      |      | vmovupd xmm28, xmmword ptr [rax+rdx*1+0x10]
|   2      | 1.0         |      | 0.5     0.5 | 0.5     0.5 |      |      |      |      | vaddpd xmm19, xmm18, xmmword ptr [rax+rdx*1+0x40]
|   2      |             | 1.0  | 0.5     0.5 | 0.5     0.5 |      |      |      |      | vaddpd xmm29, xmm28, xmmword ptr [rax+rdx*1+0x50]
|   1      |             |      | 0.5     0.5 | 0.5     0.5 |      |      |      |      | vmovupd xmm18, xmmword ptr [rax+rdx*1]
|   2      | 1.0         |      | 0.5     0.5 | 0.5     0.5 |      |      |      |      | vaddpd xmm20, xmm19, xmmword ptr [rax+r13*1+0x30]
|   2      |             | 1.0  | 0.5     0.5 | 0.5     0.5 |      |      |      |      | vaddpd xmm19, xmm18, xmmword ptr [rax+rdx*1+0x60]
|   1      |             |      | 0.5     0.5 | 0.5     0.5 |      |      |      |      | vmovupd xmm16, xmmword ptr [rax+rdx*1+0x30]
|   2      | 1.0         |      | 0.5     0.5 | 0.5     0.5 |      |      |      |      | vaddpd xmm21, xmm20, xmmword ptr [rax+r12*1+0x30]
|   2      |             | 1.0  | 0.5     0.5 | 0.5     0.5 |      |      |      |      | vaddpd xmm20, xmm19, xmmword ptr [rax+rbx*1+0x30]
|   2      | 1.0         |      | 0.5     0.5 | 0.5     0.5 |      |      |      |      | vaddpd xmm22, xmm21, xmmword ptr [rax+r8*1+0x30]
|   2      |             | 1.0  | 0.5     0.5 | 0.5     0.5 |      |      |      |      | vaddpd xmm21, xmm20, xmmword ptr [rax+rdi*1+0x30]
|   2      | 1.0         |      | 0.5     0.5 | 0.5     0.5 |      |      |      |      | vaddpd xmm23, xmm22, xmmword ptr [rax+r9*1+0x30]
|   2      |             | 1.0  | 0.5     0.5 | 0.5     0.5 |      |      |      |      | vaddpd xmm22, xmm21, xmmword ptr [rax+rsi*1+0x30]
|   1      |             |      | 0.5     0.5 | 0.5     0.5 |      |      |      |      | mov r15, qword ptr [rsp+0x198]
|   1      |             |      |             |             |      |      | 1.0  |      | inc r11
|   1      |             |      |             |             |      | 1.0  |      |      | vunpckhpd xmm17, xmm16, xmm16
|   1      |             |      |             |             |      | 1.0  |      |      | vunpckhpd xmm24, xmm23, xmm23
|   2      | 1.0         |      | 0.5     0.5 | 0.5     0.5 |      |      |      |      | vaddpd xmm30, xmm29, xmmword ptr [rax+r15*1+0x30]
|   1      |             | 1.0  |             |             |      |      |      |      | vmulpd xmm26, xmm17, xmm15
|   2      | 1.0         |      | 0.5     0.5 | 0.5     0.5 |      |      |      |      | vaddpd xmm31, xmm30, xmmword ptr [rax+r14*1+0x30]
|   1      |             | 1.0  |             |             |      |      |      |      | vmulpd xmm25, xmm24, xmm13
|   2      | 1.0         |      | 0.5     0.5 | 0.5     0.5 |      |      |      |      | vaddpd xmm28, xmm31, xmmword ptr [rax+r10*1+0x30]
|   2      |             | 1.0  | 0.5     0.5 | 0.5     0.5 |      |      |      |      | vfmaddsub231pd xmm26, xmm14, qword ptr [rax+rdx*1+0x30]{1to2}
|   1      |             |      |             |             |      | 1.0  |      |      | vmovddup xmm27, xmm23
|   1      |             |      | 0.5     0.5 | 0.5     0.5 |      |      |      |      | mov r15, qword ptr [rsp+0x190]
|   2      | 1.0         |      | 0.5     0.5 | 0.5     0.5 |      |      |      |      | vaddpd xmm23, xmm22, xmmword ptr [rax+rcx*1+0x30]
|   1      |             | 1.0  |             |             |      |      |      |      | vfmaddsub213pd xmm27, xmm12, xmm25
|   2      | 1.0         |      | 0.5     0.5 | 0.5     0.5 |      |      |      |      | vaddpd xmm29, xmm28, xmmword ptr [rax+r15*1+0x30]
|   1      |             | 1.0  |             |             |      |      |      |      | vaddpd xmm16, xmm26, xmm27
|   1      |             |      |             |             |      | 1.0  |      |      | vunpckhpd xmm30, xmm29, xmm29
|   1      | 1.0         |      |             |             |      |      |      |      | vmulpd xmm31, xmm30, xmm11
|   1      |             |      |             |             |      | 1.0  |      |      | vunpckhpd xmm24, xmm23, xmm23
|   1      |             | 1.0  |             |             |      |      |      |      | vmulpd xmm25, xmm24, xmm9
|   1      |             |      |             |             |      | 1.0  |      |      | vmovddup xmm17, xmm29
|   1      | 1.0         |      |             |             |      |      |      |      | vfmaddsub213pd xmm17, xmm10, xmm31
|   1      |             |      |             |             |      | 1.0  |      |      | vmovddup xmm27, xmm23
|   1      |             | 1.0  |             |             |      |      |      |      | vfmaddsub213pd xmm27, xmm8, xmm25
|   1      | 1.0         |      |             |             |      |      |      |      | vaddpd xmm26, xmm16, xmm17
|   1      |             | 1.0  |             |             |      |      |      |      | vaddpd xmm16, xmm26, xmm27
|   1      |             |      |             |             |      |      | 1.0  |      | nop 
|   1      |             |      | 0.5     0.5 | 0.5     0.5 |      |      |      |      | mov r15, qword ptr [rsp+0x1a0]
|   2      |             |      | 0.5         | 0.5         | 1.0  |      |      |      | vmovupd xmmword ptr [rax+r15*1+0x30], xmm16
|   1      |             |      |             |             |      |      | 1.0  |      | add rax, 0x10
|   2^     |             |      | 0.5     0.5 | 0.5     0.5 |      |      | 1.0  |      | cmp r11, qword ptr [rsp+0x1a8]
|   0*F    |             |      |             |             |      |      |      |      | jb 0xfffffffffffffecb
...
# Logged in users
################################################################################
 11:51:33 up 50 days, 18:38,  0 users,  load average: 0.12, 0.03, 0.01
...
CPU 0: governor  performance min/cur/max 2.4/1.984595/2.4 GHz Turbo 0
CPU 1: governor  performance min/cur/max 2.4/2.004998/2.4 GHz Turbo 0
CPU 2: governor  performance min/cur/max 2.4/1.910112/2.4 GHz Turbo 0
CPU 5: governor  performance min/cur/max 2.4/1.958612/2.4 GHz Turbo 0
CPU 6: governor  performance min/cur/max 2.4/2.04626/2.4 GHz Turbo 0
CPU 10: governor  performance min/cur/max 2.4/1.841781/2.4 GHz Turbo 0
CPU 11: governor  performance min/cur/max 2.4/1.93186/2.4 GHz Turbo 0
CPU 12: governor  performance min/cur/max 2.4/2.344538/2.4 GHz Turbo 0
CPU 15: governor  performance min/cur/max 2.4/1.711093/2.4 GHz Turbo 0
CPU 16: governor  performance min/cur/max 2.4/2.263171/2.4 GHz Turbo 0
CPU 3: governor  performance min/cur/max 2.4/1.947016/2.4 GHz Turbo 0
CPU 4: governor  performance min/cur/max 2.4/2.186532/2.4 GHz Turbo 0
CPU 7: governor  performance min/cur/max 2.4/2.150266/2.4 GHz Turbo 0
CPU 8: governor  performance min/cur/max 2.4/2.031596/2.4 GHz Turbo 0
CPU 9: governor  performance min/cur/max 2.4/2.141704/2.4 GHz Turbo 0
CPU 13: governor  performance min/cur/max 2.4/1.409452/2.4 GHz Turbo 0
CPU 14: governor  performance min/cur/max 2.4/2.018178/2.4 GHz Turbo 0
CPU 17: governor  performance min/cur/max 2.4/1.691208/2.4 GHz Turbo 0
CPU 18: governor  performance min/cur/max 2.4/2.215619/2.4 GHz Turbo 0
CPU 19: governor  performance min/cur/max 2.4/2.236682/2.4 GHz Turbo 0
CPU 20: governor  performance min/cur/max 2.4/2.148442/2.4 GHz Turbo 0
CPU 21: governor  performance min/cur/max 2.4/1.955377/2.4 GHz Turbo 0
CPU 22: governor  performance min/cur/max 2.4/1.975441/2.4 GHz Turbo 0
CPU 25: governor  performance min/cur/max 2.4/1.256547/2.4 GHz Turbo 0
CPU 26: governor  performance min/cur/max 2.4/1.355986/2.4 GHz Turbo 0
CPU 30: governor  performance min/cur/max 2.4/1.968659/2.4 GHz Turbo 0
CPU 31: governor  performance min/cur/max 2.4/2.187486/2.4 GHz Turbo 0
CPU 32: governor  performance min/cur/max 2.4/1.732309/2.4 GHz Turbo 0
CPU 35: governor  performance min/cur/max 2.4/1.80168/2.4 GHz Turbo 0
CPU 36: governor  performance min/cur/max 2.4/2.189576/2.4 GHz Turbo 0
CPU 23: governor  performance min/cur/max 2.4/1.720199/2.4 GHz Turbo 0
CPU 24: governor  performance min/cur/max 2.4/1.310269/2.4 GHz Turbo 0
CPU 27: governor  performance min/cur/max 2.4/1.894785/2.4 GHz Turbo 0
CPU 28: governor  performance min/cur/max 2.4/1.278993/2.4 GHz Turbo 0
CPU 29: governor  performance min/cur/max 2.4/1.295734/2.4 GHz Turbo 0
CPU 33: governor  performance min/cur/max 2.4/1.226194/2.4 GHz Turbo 0
CPU 34: governor  performance min/cur/max 2.4/1.12294/2.4 GHz Turbo 0
CPU 37: governor  performance min/cur/max 2.4/2.136623/2.4 GHz Turbo 0
CPU 38: governor  performance min/cur/max 2.4/1.930117/2.4 GHz Turbo 0
CPU 39: governor  performance min/cur/max 2.4/2.349834/2.4 GHz Turbo 0
CPU 40: governor  performance min/cur/max 2.4/2.187279/2.4 GHz Turbo 0
CPU 41: governor  performance min/cur/max 2.4/1.986481/2.4 GHz Turbo 0
CPU 42: governor  performance min/cur/max 2.4/2.019536/2.4 GHz Turbo 0
CPU 45: governor  performance min/cur/max 2.4/1.718481/2.4 GHz Turbo 0
CPU 46: governor  performance min/cur/max 2.4/1.556362/2.4 GHz Turbo 0
CPU 50: governor  performance min/cur/max 2.4/1.372447/2.4 GHz Turbo 0
CPU 51: governor  performance min/cur/max 2.4/2.31704/2.4 GHz Turbo 0
CPU 52: governor  performance min/cur/max 2.4/2.162748/2.4 GHz Turbo 0
CPU 55: governor  performance min/cur/max 2.4/2.007/2.4 GHz Turbo 0
CPU 56: governor  performance min/cur/max 2.4/1.990661/2.4 GHz Turbo 0
CPU 43: governor  performance min/cur/max 2.4/2.225915/2.4 GHz Turbo 0
CPU 44: governor  performance min/cur/max 2.4/2.146793/2.4 GHz Turbo 0
CPU 47: governor  performance min/cur/max 2.4/2.146632/2.4 GHz Turbo 0
CPU 48: governor  performance min/cur/max 2.4/2.093411/2.4 GHz Turbo 0
CPU 49: governor  performance min/cur/max 2.4/2.341988/2.4 GHz Turbo 0
CPU 53: governor  performance min/cur/max 2.4/1.964325/2.4 GHz Turbo 0
CPU 54: governor  performance min/cur/max 2.4/2.274327/2.4 GHz Turbo 0
CPU 57: governor  performance min/cur/max 2.4/2.263287/2.4 GHz Turbo 0
CPU 58: governor  performance min/cur/max 2.4/2.177625/2.4 GHz Turbo 0
CPU 59: governor  performance min/cur/max 2.4/1.908643/2.4 GHz Turbo 0
CPU 60: governor  performance min/cur/max 2.4/2.200091/2.4 GHz Turbo 0
CPU 61: governor  performance min/cur/max 2.4/2.222253/2.4 GHz Turbo 0
CPU 62: governor  performance min/cur/max 2.4/2.3332/2.4 GHz Turbo 0
CPU 65: governor  performance min/cur/max 2.4/1.610823/2.4 GHz Turbo 0
CPU 66: governor  performance min/cur/max 2.4/1.780951/2.4 GHz Turbo 0
CPU 70: governor  performance min/cur/max 2.4/2.192415/2.4 GHz Turbo 0
CPU 71: governor  performance min/cur/max 2.4/1.973277/2.4 GHz Turbo 0
CPU 72: governor  performance min/cur/max 2.4/2.199067/2.4 GHz Turbo 0
CPU 75: governor  performance min/cur/max 2.4/1.738001/2.4 GHz Turbo 0
CPU 76: governor  performance min/cur/max 2.4/1.99447/2.4 GHz Turbo 0
CPU 63: governor  performance min/cur/max 2.4/1.857803/2.4 GHz Turbo 0
CPU 64: governor  performance min/cur/max 2.4/1.707786/2.4 GHz Turbo 0
CPU 67: governor  performance min/cur/max 2.4/1.752955/2.4 GHz Turbo 0
CPU 68: governor  performance min/cur/max 2.4/1.855444/2.4 GHz Turbo 0
CPU 69: governor  performance min/cur/max 2.4/1.530888/2.4 GHz Turbo 0
CPU 73: governor  performance min/cur/max 2.4/1.892867/2.4 GHz Turbo 0
CPU 74: governor  performance min/cur/max 2.4/1.710724/2.4 GHz Turbo 0
CPU 77: governor  performance min/cur/max 2.4/1.481816/2.4 GHz Turbo 0
CPU 78: governor  performance min/cur/max 2.4/1.819288/2.4 GHz Turbo 0
CPU 79: governor  performance min/cur/max 2.4/1.18311/2.4 GHz Turbo 0
...
Inactive(anon):     4224 kB
Active(file):     245600 kB
Inactive(file):   140028 kB
Unevictable:           0 kB
Mlocked:               0 kB
SwapTotal:      49632252 kB
SwapFree:       49585404 kB
Dirty:               828 kB
Writeback:             0 kB
AnonPages:         14248 kB
Mapped:            35384 kB
Shmem:               308 kB
Slab:             828760 kB
SReclaimable:     314864 kB
SUnreclaim:       513896 kB
...
PWD=/home/hpc/iwia/iwia84/INSPECT-repo/stencils/3D_r3_isotropic_star_constant/SkylakeSP_Gold-6148_SNC_20190719_115133
