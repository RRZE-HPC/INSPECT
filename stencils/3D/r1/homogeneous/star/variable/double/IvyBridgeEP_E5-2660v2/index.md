...
title:  "Stencil 3D r1 star variable homogeneous double IvyBridgeEP_E5-2660v2"
...
vmovupd xmm0, xmmword ptr [r9+rsi*8+0x8]
vmovupd xmm9, xmmword ptr [r9+rsi*8+0x10]
vaddpd xmm1, xmm0, xmmword ptr [r9+rsi*8]
vmovupd xmm8, xmmword ptr [r9+rsi*8+0x18]
vaddpd xmm2, xmm1, xmm9
vaddpd xmm10, xmm8, xmm9
vaddpd xmm3, xmm2, xmmword ptr [r13+rsi*8+0x8]
vaddpd xmm4, xmm3, xmmword ptr [r14+rsi*8+0x8]
vaddpd xmm5, xmm4, xmmword ptr [rcx+rsi*8+0x8]
vaddpd xmm6, xmm5, xmmword ptr [rdi+rsi*8+0x8]
vmulpd xmm7, xmm6, xmmword ptr [rax+rsi*8+0x8]
vmovupd xmmword ptr [r15+rsi*8+0x8], xmm7
vmovupd xmm1, xmmword ptr [r9+rsi*8+0x20]
vmovupd xmm0, xmmword ptr [r9+rsi*8+0x28]
vaddpd xmm11, xmm10, xmm1
vaddpd xmm2, xmm0, xmm1
vaddpd xmm12, xmm11, xmmword ptr [r13+rsi*8+0x18]
vaddpd xmm13, xmm12, xmmword ptr [r14+rsi*8+0x18]
vaddpd xmm14, xmm13, xmmword ptr [rcx+rsi*8+0x18]
vaddpd xmm15, xmm14, xmmword ptr [rdi+rsi*8+0x18]
vmulpd xmm10, xmm15, xmmword ptr [rax+rsi*8+0x18]
vmovupd xmmword ptr [r15+rsi*8+0x18], xmm10
vmovupd xmm9, xmmword ptr [r9+rsi*8+0x38]
vmovupd xmm11, xmmword ptr [r9+rsi*8+0x30]
vaddpd xmm12, xmm9, xmm11
vaddpd xmm3, xmm2, xmm11
vaddpd xmm13, xmm12, xmmword ptr [r9+rsi*8+0x40]
vaddpd xmm4, xmm3, xmmword ptr [r13+rsi*8+0x28]
vaddpd xmm14, xmm13, xmmword ptr [r13+rsi*8+0x38]
vaddpd xmm5, xmm4, xmmword ptr [r14+rsi*8+0x28]
vaddpd xmm15, xmm14, xmmword ptr [r14+rsi*8+0x38]
vaddpd xmm6, xmm5, xmmword ptr [rcx+rsi*8+0x28]
vaddpd xmm0, xmm15, xmmword ptr [rcx+rsi*8+0x38]
vaddpd xmm7, xmm6, xmmword ptr [rdi+rsi*8+0x28]
vaddpd xmm1, xmm0, xmmword ptr [rdi+rsi*8+0x38]
vmulpd xmm8, xmm7, xmmword ptr [rax+rsi*8+0x28]
vmulpd xmm2, xmm1, xmmword ptr [rax+rsi*8+0x38]
vmovupd xmmword ptr [r15+rsi*8+0x28], xmm8
vmovupd xmmword ptr [r15+rsi*8+0x38], xmm2
add rsi, 0x8
cmp rsi, rbx
...
-------------------------------------------------------------------------
| Cycles | 4.0    0.0  | 24.0 | 16.5   14.5 | 16.5   14.5 | 4.0  | 2.0  |
-------------------------------------------------------------------------
...
---------------------------------------------------------------------
|   1    |           |     | 0.5   0.5 | 0.5   0.5 |     |     |    | vmovupd xmm0, xmmword ptr [r9+rsi*8+0x8]
|   1    |           |     | 0.5   0.5 | 0.5   0.5 |     |     |    | vmovupd xmm9, xmmword ptr [r9+rsi*8+0x10]
|   2    |           | 1.0 | 0.5   0.5 | 0.5   0.5 |     |     | CP | vaddpd xmm1, xmm0, xmmword ptr [r9+rsi*8]
|   1    |           |     | 0.5   0.5 | 0.5   0.5 |     |     |    | vmovupd xmm8, xmmword ptr [r9+rsi*8+0x18]
|   1    |           | 1.0 |           |           |     |     | CP | vaddpd xmm2, xmm1, xmm9
|   1    |           | 1.0 |           |           |     |     | CP | vaddpd xmm10, xmm8, xmm9
|   2    |           | 1.0 | 0.5   0.5 | 0.5   0.5 |     |     | CP | vaddpd xmm3, xmm2, xmmword ptr [r13+rsi*8+0x8]
|   2    |           | 1.0 | 0.5   0.5 | 0.5   0.5 |     |     | CP | vaddpd xmm4, xmm3, xmmword ptr [r14+rsi*8+0x8]
|   2    |           | 1.0 | 0.5   0.5 | 0.5   0.5 |     |     | CP | vaddpd xmm5, xmm4, xmmword ptr [rcx+rsi*8+0x8]
|   2    |           | 1.0 | 0.5   0.5 | 0.5   0.5 |     |     | CP | vaddpd xmm6, xmm5, xmmword ptr [rdi+rsi*8+0x8]
|   2    | 1.0       |     | 0.5   0.5 | 0.5   0.5 |     |     |    | vmulpd xmm7, xmm6, xmmword ptr [rax+rsi*8+0x8]
|   2    |           |     | 0.5       | 0.5       | 1.0 |     |    | vmovupd xmmword ptr [r15+rsi*8+0x8], xmm7
|   1    |           |     | 0.5   0.5 | 0.5   0.5 |     |     |    | vmovupd xmm1, xmmword ptr [r9+rsi*8+0x20]
|   1    |           |     | 0.5   0.5 | 0.5   0.5 |     |     |    | vmovupd xmm0, xmmword ptr [r9+rsi*8+0x28]
|   1    |           | 1.0 |           |           |     |     | CP | vaddpd xmm11, xmm10, xmm1
|   1    |           | 1.0 |           |           |     |     | CP | vaddpd xmm2, xmm0, xmm1
|   2    |           | 1.0 | 0.5   0.5 | 0.5   0.5 |     |     | CP | vaddpd xmm12, xmm11, xmmword ptr [r13+rsi*8+0x18]
|   2    |           | 1.0 | 0.5   0.5 | 0.5   0.5 |     |     | CP | vaddpd xmm13, xmm12, xmmword ptr [r14+rsi*8+0x18]
|   2    |           | 1.0 | 0.5   0.5 | 0.5   0.5 |     |     | CP | vaddpd xmm14, xmm13, xmmword ptr [rcx+rsi*8+0x18]
|   2    |           | 1.0 | 0.5   0.5 | 0.5   0.5 |     |     | CP | vaddpd xmm15, xmm14, xmmword ptr [rdi+rsi*8+0x18]
|   2    | 1.0       |     | 0.5   0.5 | 0.5   0.5 |     |     |    | vmulpd xmm10, xmm15, xmmword ptr [rax+rsi*8+0x18]
|   2    |           |     | 0.5       | 0.5       | 1.0 |     |    | vmovupd xmmword ptr [r15+rsi*8+0x18], xmm10
|   1    |           |     | 0.5   0.5 | 0.5   0.5 |     |     |    | vmovupd xmm9, xmmword ptr [r9+rsi*8+0x38]
|   1    |           |     | 0.5   0.5 | 0.5   0.5 |     |     |    | vmovupd xmm11, xmmword ptr [r9+rsi*8+0x30]
|   1    |           | 1.0 |           |           |     |     | CP | vaddpd xmm12, xmm9, xmm11
|   1    |           | 1.0 |           |           |     |     | CP | vaddpd xmm3, xmm2, xmm11
|   2    |           | 1.0 | 0.5   0.5 | 0.5   0.5 |     |     | CP | vaddpd xmm13, xmm12, xmmword ptr [r9+rsi*8+0x40]
|   2    |           | 1.0 | 0.5   0.5 | 0.5   0.5 |     |     | CP | vaddpd xmm4, xmm3, xmmword ptr [r13+rsi*8+0x28]
|   2    |           | 1.0 | 0.5   0.5 | 0.5   0.5 |     |     | CP | vaddpd xmm14, xmm13, xmmword ptr [r13+rsi*8+0x38]
|   2    |           | 1.0 | 0.5   0.5 | 0.5   0.5 |     |     | CP | vaddpd xmm5, xmm4, xmmword ptr [r14+rsi*8+0x28]
|   2    |           | 1.0 | 0.5   0.5 | 0.5   0.5 |     |     | CP | vaddpd xmm15, xmm14, xmmword ptr [r14+rsi*8+0x38]
|   2    |           | 1.0 | 0.5   0.5 | 0.5   0.5 |     |     | CP | vaddpd xmm6, xmm5, xmmword ptr [rcx+rsi*8+0x28]
|   2    |           | 1.0 | 0.5   0.5 | 0.5   0.5 |     |     | CP | vaddpd xmm0, xmm15, xmmword ptr [rcx+rsi*8+0x38]
|   2    |           | 1.0 | 0.5   0.5 | 0.5   0.5 |     |     | CP | vaddpd xmm7, xmm6, xmmword ptr [rdi+rsi*8+0x28]
|   2    |           | 1.0 | 0.5   0.5 | 0.5   0.5 |     |     | CP | vaddpd xmm1, xmm0, xmmword ptr [rdi+rsi*8+0x38]
|   2    | 1.0       |     | 0.5   0.5 | 0.5   0.5 |     |     |    | vmulpd xmm8, xmm7, xmmword ptr [rax+rsi*8+0x28]
|   2    | 1.0       |     | 0.5   0.5 | 0.5   0.5 |     |     |    | vmulpd xmm2, xmm1, xmmword ptr [rax+rsi*8+0x38]
|   2    |           |     | 0.5       | 0.5       | 1.0 |     |    | vmovupd xmmword ptr [r15+rsi*8+0x28], xmm8
|   2    |           |     | 0.5       | 0.5       | 1.0 |     |    | vmovupd xmmword ptr [r15+rsi*8+0x38], xmm2
|   1    |           |     |           |           |     | 1.0 |    | add rsi, 0x8
|   1    |           |     |           |           |     | 1.0 |    | cmp rsi, rbx
|   0F   |           |     |           |           |     |     |    | jb 0xffffffffffffff03
...
# Logged in users
################################################################################
 13:56:42 up 1 day, 23:17,  0 users,  load average: 0.92, 1.50, 1.89
...
MemFree:        62305668 kB
MemAvailable:   62269756 kB
Buffers:               0 kB
Cached:          2222356 kB
SwapCached:            0 kB
Active:           111204 kB
Inactive:        2124000 kB
Active(anon):      38188 kB
Inactive(anon):  1881268 kB
Active(file):      73016 kB
Inactive(file):   242732 kB
...
PWD=/home/hpc/iwia/iwia84/INSPECT-repo/stencils/3D_r1_homogeneous_star_variable/IvyBridgeEP_E5-2660v2_20190523_135642
