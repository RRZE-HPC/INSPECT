...
vmovupd ymm14, ymmword ptr [r14+r9*8]
vmovupd ymm12, ymmword ptr [r10+r9*8]
vmovupd ymm0, ymmword ptr [r14+r9*8+0x8]
vaddpd ymm15, ymm14, ymmword ptr [r13+r9*8+0x10]
vaddpd ymm13, ymm12, ymmword ptr [r10+r9*8+0x10]
vaddpd ymm12, ymm0, ymmword ptr [r13+r9*8+0x8]
vmulpd ymm11, ymm7, ymm15
vmovupd ymm0, ymmword ptr [rsp+0x300]
vmovupd ymm14, ymmword ptr [r13+r9*8]
vmovupd ymm15, ymmword ptr [r12+r9*8+0x8]
vfmadd231pd ymm11, ymm12, ymm9
vmovupd ymm12, ymmword ptr [r12+r9*8]
vaddpd ymm15, ymm15, ymmword ptr [r11+r9*8+0x8]
vfmadd231pd ymm11, ymm0, ymmword ptr [r10+r9*8+0x8]
vaddpd ymm0, ymm14, ymmword ptr [r14+r9*8+0x10]
vaddpd ymm14, ymm12, ymmword ptr [r11+r9*8+0x10]
vmulpd ymm12, ymm14, ymmword ptr [rsp+0x2e0]
vfmadd231pd ymm12, ymm15, ymm8
vfmadd231pd ymm12, ymm13, ymm10
vmovupd ymm13, ymmword ptr [r15+r9*8+0x8]
vaddpd ymm15, ymm11, ymm12
vmovupd ymm11, ymmword ptr [r11+r9*8]
vaddpd ymm12, ymm11, ymmword ptr [r12+r9*8+0x10]
vaddpd ymm11, ymm13, ymmword ptr [rsi+r9*8+0x8]
vmovupd ymm13, ymmword ptr [r15+r9*8]
vmulpd ymm14, ymm5, ymm11
vmovupd ymm11, ymmword ptr [rsi+r9*8]
vaddpd ymm13, ymm13, ymmword ptr [rsi+r9*8+0x10]
vfmadd231pd ymm14, ymm12, ymm6
vaddpd ymm12, ymm11, ymmword ptr [r15+r9*8+0x10]
vmovupd ymm11, ymmword ptr [rdi+r9*8+0x8]
vmulpd ymm12, ymm12, ymmword ptr [rsp+0x2a0]
vaddpd ymm11, ymm11, ymmword ptr [r8+r9*8+0x8]
vmulpd ymm11, ymm4, ymm11
vfmadd231pd ymm11, ymm0, ymmword ptr [rsp+0x2c0]
vmovupd ymm0, ymmword ptr [rdi+r9*8]
vaddpd ymm11, ymm14, ymm11
vaddpd ymm0, ymm0, ymmword ptr [r8+r9*8+0x10]
vmovupd ymm14, ymmword ptr [r8+r9*8]
vfmadd231pd ymm12, ymm0, ymm2
vaddpd ymm0, ymm14, ymmword ptr [rdi+r9*8+0x10]
...
--------------------------
Block Throughput: 18.05 Cycles       Throughput Bottleneck: Backend
Loop Count:  22
Port Binding In Cycles Per Iteration:
--------------------------------------------------------------------------------------------------
|  Port  |   0   -  DV   |   1   |   2   -  D    |   3   -  D    |   4   |   5   |   6   |   7   |
--------------------------------------------------------------------------------------------------
| Cycles | 14.0     0.0  | 18.0  | 16.0    16.0  | 16.0    15.0  |  1.0  |  0.5  |  0.5  |  0.0  |
--------------------------------------------------------------------------------------------------
...
-----------------------------------------------------------------------------------------
|   1      |             |      | 1.0     1.0 |             |      |      |      |      | vmovupd ymm14, ymmword ptr [r14+r9*8]
|   1      |             |      |             | 1.0     1.0 |      |      |      |      | vmovupd ymm12, ymmword ptr [r10+r9*8]
|   1      |             |      | 1.0     1.0 |             |      |      |      |      | vmovupd ymm0, ymmword ptr [r14+r9*8+0x8]
|   2      |             | 1.0  |             | 1.0     1.0 |      |      |      |      | vaddpd ymm15, ymm14, ymmword ptr [r13+r9*8+0x10]
|   2      |             | 1.0  | 1.0     1.0 |             |      |      |      |      | vaddpd ymm13, ymm12, ymmword ptr [r10+r9*8+0x10]
|   2      |             | 1.0  |             | 1.0     1.0 |      |      |      |      | vaddpd ymm12, ymm0, ymmword ptr [r13+r9*8+0x8]
|   1      | 1.0         |      |             |             |      |      |      |      | vmulpd ymm11, ymm7, ymm15
|   1      |             |      | 1.0     1.0 |             |      |      |      |      | vmovupd ymm0, ymmword ptr [rsp+0x300]
|   1      |             |      |             | 1.0     1.0 |      |      |      |      | vmovupd ymm14, ymmword ptr [r13+r9*8]
|   1      |             |      | 1.0     1.0 |             |      |      |      |      | vmovupd ymm15, ymmword ptr [r12+r9*8+0x8]
|   1      | 1.0         |      |             |             |      |      |      |      | vfmadd231pd ymm11, ymm12, ymm9
|   1      |             |      |             | 1.0     1.0 |      |      |      |      | vmovupd ymm12, ymmword ptr [r12+r9*8]
|   2      |             | 1.0  | 1.0     1.0 |             |      |      |      |      | vaddpd ymm15, ymm15, ymmword ptr [r11+r9*8+0x8]
|   2      | 1.0         |      |             | 1.0     1.0 |      |      |      |      | vfmadd231pd ymm11, ymm0, ymmword ptr [r10+r9*8+0x8]
|   2      |             | 1.0  | 1.0     1.0 |             |      |      |      |      | vaddpd ymm0, ymm14, ymmword ptr [r14+r9*8+0x10]
|   2      |             | 1.0  |             | 1.0     1.0 |      |      |      |      | vaddpd ymm14, ymm12, ymmword ptr [r11+r9*8+0x10]
|   2^     | 1.0         |      | 1.0     1.0 |             |      |      |      |      | vmulpd ymm12, ymm14, ymmword ptr [rsp+0x2e0]
|   1      | 1.0         |      |             |             |      |      |      |      | vfmadd231pd ymm12, ymm15, ymm8
|   1      | 1.0         |      |             |             |      |      |      |      | vfmadd231pd ymm12, ymm13, ymm10
|   1      |             |      |             | 1.0     1.0 |      |      |      |      | vmovupd ymm13, ymmword ptr [r15+r9*8+0x8]
|   1      |             | 1.0  |             |             |      |      |      |      | vaddpd ymm15, ymm11, ymm12
|   1      |             |      | 1.0     1.0 |             |      |      |      |      | vmovupd ymm11, ymmword ptr [r11+r9*8]
|   2      |             | 1.0  |             | 1.0     1.0 |      |      |      |      | vaddpd ymm12, ymm11, ymmword ptr [r12+r9*8+0x10]
|   2      |             | 1.0  | 1.0     1.0 |             |      |      |      |      | vaddpd ymm11, ymm13, ymmword ptr [rsi+r9*8+0x8]
|   1      |             |      |             | 1.0     1.0 |      |      |      |      | vmovupd ymm13, ymmword ptr [r15+r9*8]
|   1      | 1.0         |      |             |             |      |      |      |      | vmulpd ymm14, ymm5, ymm11
|   1      |             |      | 1.0     1.0 |             |      |      |      |      | vmovupd ymm11, ymmword ptr [rsi+r9*8]
|   2      |             | 1.0  |             | 1.0     1.0 |      |      |      |      | vaddpd ymm13, ymm13, ymmword ptr [rsi+r9*8+0x10]
|   1      | 1.0         |      |             |             |      |      |      |      | vfmadd231pd ymm14, ymm12, ymm6
|   2      |             | 1.0  | 1.0     1.0 |             |      |      |      |      | vaddpd ymm12, ymm11, ymmword ptr [r15+r9*8+0x10]
|   1      |             |      |             | 1.0     1.0 |      |      |      |      | vmovupd ymm11, ymmword ptr [rdi+r9*8+0x8]
|   2^     | 1.0         |      | 1.0     1.0 |             |      |      |      |      | vmulpd ymm12, ymm12, ymmword ptr [rsp+0x2a0]
|   2      |             | 1.0  |             | 1.0     1.0 |      |      |      |      | vaddpd ymm11, ymm11, ymmword ptr [r8+r9*8+0x8]
|   1      | 1.0         |      |             |             |      |      |      |      | vmulpd ymm11, ymm4, ymm11
|   2^     | 1.0         |      | 1.0     1.0 |             |      |      |      |      | vfmadd231pd ymm11, ymm0, ymmword ptr [rsp+0x2c0]
|   1      |             |      |             | 1.0     1.0 |      |      |      |      | vmovupd ymm0, ymmword ptr [rdi+r9*8]
|   1      |             | 1.0  |             |             |      |      |      |      | vaddpd ymm11, ymm14, ymm11
|   2      |             | 1.0  | 1.0     1.0 |             |      |      |      |      | vaddpd ymm0, ymm0, ymmword ptr [r8+r9*8+0x10]
|   1      |             |      |             | 1.0     1.0 |      |      |      |      | vmovupd ymm14, ymmword ptr [r8+r9*8]
|   1      | 1.0         |      |             |             |      |      |      |      | vfmadd231pd ymm12, ymm0, ymm2
|   2      |             | 1.0  | 1.0     1.0 |             |      |      |      |      | vaddpd ymm0, ymm14, ymmword ptr [rdi+r9*8+0x10]
|   1      | 1.0         |      |             |             |      |      |      |      | vmulpd ymm14, ymm1, ymm0
|   1      | 1.0         |      |             |             |      |      |      |      | vfmadd231pd ymm14, ymm13, ymm3
|   1      |             | 1.0  |             |             |      |      |      |      | vaddpd ymm12, ymm14, ymm12
|   1      |             | 1.0  |             |             |      |      |      |      | vaddpd ymm11, ymm12, ymm11
...
# Logged in users
################################################################################
 01:15:34 up 37 days, 12:19,  0 users,  load average: 0.74, 0.90, 0.98
...
CPU 0: governor  performance min/cur/max 2.3/1.275/2.3 GHz Turbo 0
CPU 1: governor  performance min/cur/max 2.3/1.297/2.3 GHz Turbo 0
CPU 2: governor  performance min/cur/max 2.3/1.414/2.3 GHz Turbo 0
CPU 3: governor  performance min/cur/max 2.3/1.432/2.3 GHz Turbo 0
CPU 4: governor  performance min/cur/max 2.3/1.336/2.3 GHz Turbo 0
CPU 5: governor  performance min/cur/max 2.3/1.702/2.3 GHz Turbo 0
CPU 6: governor  performance min/cur/max 2.3/1.493/2.3 GHz Turbo 0
CPU 7: governor  performance min/cur/max 2.3/1.463/2.3 GHz Turbo 0
CPU 8: governor  performance min/cur/max 2.3/1.838/2.3 GHz Turbo 0
CPU 9: governor  performance min/cur/max 2.3/1.519/2.3 GHz Turbo 0
CPU 10: governor  performance min/cur/max 2.3/1.821/2.3 GHz Turbo 0
CPU 11: governor  performance min/cur/max 2.3/1.453/2.3 GHz Turbo 0
CPU 12: governor  performance min/cur/max 2.3/1.693/2.3 GHz Turbo 0
CPU 13: governor  performance min/cur/max 2.3/1.831/2.3 GHz Turbo 0
CPU 14: governor  performance min/cur/max 2.3/2.300/2.3 GHz Turbo 0
CPU 15: governor  performance min/cur/max 2.3/2.256/2.3 GHz Turbo 0
CPU 16: governor  performance min/cur/max 2.3/2.255/2.3 GHz Turbo 0
CPU 17: governor  performance min/cur/max 2.3/2.300/2.3 GHz Turbo 0
CPU 18: governor  performance min/cur/max 2.3/2.239/2.3 GHz Turbo 0
CPU 19: governor  performance min/cur/max 2.3/2.195/2.3 GHz Turbo 0
CPU 20: governor  performance min/cur/max 2.3/2.168/2.3 GHz Turbo 0
CPU 21: governor  performance min/cur/max 2.3/2.168/2.3 GHz Turbo 0
...
CPU 25: governor  performance min/cur/max 2.3/2.302/2.3 GHz Turbo 0
...
CPU 28: governor  performance min/cur/max 2.3/1.284/2.3 GHz Turbo 0
CPU 29: governor  performance min/cur/max 2.3/2.302/2.3 GHz Turbo 0
CPU 30: governor  performance min/cur/max 2.3/1.756/2.3 GHz Turbo 0
CPU 31: governor  performance min/cur/max 2.3/1.760/2.3 GHz Turbo 0
CPU 32: governor  performance min/cur/max 2.3/1.754/2.3 GHz Turbo 0
CPU 33: governor  performance min/cur/max 2.3/1.760/2.3 GHz Turbo 0
CPU 34: governor  performance min/cur/max 2.3/1.478/2.3 GHz Turbo 0
CPU 35: governor  performance min/cur/max 2.3/1.438/2.3 GHz Turbo 0
CPU 36: governor  performance min/cur/max 2.3/1.751/2.3 GHz Turbo 0
CPU 37: governor  performance min/cur/max 2.3/1.565/2.3 GHz Turbo 0
CPU 38: governor  performance min/cur/max 2.3/1.751/2.3 GHz Turbo 0
CPU 39: governor  performance min/cur/max 2.3/1.687/2.3 GHz Turbo 0
CPU 40: governor  performance min/cur/max 2.3/1.752/2.3 GHz Turbo 0
CPU 41: governor  performance min/cur/max 2.3/1.772/2.3 GHz Turbo 0
CPU 42: governor  performance min/cur/max 2.3/2.279/2.3 GHz Turbo 0
CPU 43: governor  performance min/cur/max 2.3/2.299/2.3 GHz Turbo 0
CPU 44: governor  performance min/cur/max 2.3/2.285/2.3 GHz Turbo 0
CPU 45: governor  performance min/cur/max 2.3/2.166/2.3 GHz Turbo 0
CPU 46: governor  performance min/cur/max 2.3/2.266/2.3 GHz Turbo 0
CPU 47: governor  performance min/cur/max 2.3/2.284/2.3 GHz Turbo 0
CPU 48: governor  performance min/cur/max 2.3/2.104/2.3 GHz Turbo 0
CPU 49: governor  performance min/cur/max 2.3/2.284/2.3 GHz Turbo 0
CPU 50: governor  performance min/cur/max 2.3/2.290/2.3 GHz Turbo 0
CPU 51: governor  performance min/cur/max 2.3/2.248/2.3 GHz Turbo 0
CPU 52: governor  performance min/cur/max 2.3/2.262/2.3 GHz Turbo 0
CPU 53: governor  performance min/cur/max 2.3/2.157/2.3 GHz Turbo 0
CPU 54: governor  performance min/cur/max 2.3/2.118/2.3 GHz Turbo 0
CPU 55: governor  performance min/cur/max 2.3/2.174/2.3 GHz Turbo 0
...
MemFree:        64173668 kB
MemAvailable:   64524900 kB
Buffers:           70472 kB
Cached:           716356 kB
SwapCached:           64 kB
Active:           553892 kB
Inactive:         275032 kB
Active(anon):      39284 kB
Inactive(anon):    10960 kB
Active(file):     514608 kB
Inactive(file):   264072 kB
Unevictable:           0 kB
Mlocked:               0 kB
...
Shmem:              8116 kB
Slab:             533336 kB
SReclaimable:     224832 kB
SUnreclaim:       308504 kB
...
OLDPWD=/home/hpc/iwia/iwia84/INSPECT-repo/stencils/3D_r1_homogeneous_box_constant/HaswellEP_E5-2695v3_CoD_20190503_202318
...
PWD=/home/hpc/iwia/iwia84/INSPECT-repo/stencils/3D_r1_point-symmetric_box_constant/HaswellEP_E5-2695v3_CoD_20190504_011534
