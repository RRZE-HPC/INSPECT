...
title:  "Stencil 3D r1 star variable point-symmetric double IvyBridgeEP_E5-2660v2"
...
vmovupd ymm3, ymmword ptr [rsi+r8*8]
vmovupd xmm0, xmmword ptr [r14+r8*8+0x8]
vmovupd xmm2, xmmword ptr [r10+r8*8+0x8]
vaddpd ymm5, ymm3, ymmword ptr [rsi+r8*8+0x10]
vmovupd xmm9, xmmword ptr [rdi+r8*8+0x8]
vmovupd xmm10, xmmword ptr [r12+r8*8+0x8]
vmovupd xmm8, xmmword ptr [r11+r8*8+0x8]
vmovupd xmm3, xmmword ptr [r13+r8*8+0x8]
vinsertf128 ymm1, ymm0, xmmword ptr [r14+r8*8+0x18], 0x1
vinsertf128 ymm4, ymm2, xmmword ptr [r10+r8*8+0x18], 0x1
vmulpd ymm6, ymm1, ymmword ptr [rsi+r8*8+0x8]
vmulpd ymm7, ymm4, ymm5
vmovupd xmm2, xmmword ptr [rdx+r8*8+0x8]
vmovupd xmm1, xmmword ptr [r9+r8*8+0x8]
vaddpd ymm15, ymm6, ymm7
vinsertf128 ymm11, ymm9, xmmword ptr [rdi+r8*8+0x18], 0x1
vinsertf128 ymm12, ymm10, xmmword ptr [r12+r8*8+0x18], 0x1
vaddpd ymm14, ymm11, ymm12
vinsertf128 ymm13, ymm8, xmmword ptr [r11+r8*8+0x18], 0x1
vinsertf128 ymm4, ymm2, xmmword ptr [rdx+r8*8+0x18], 0x1
vinsertf128 ymm5, ymm3, xmmword ptr [r13+r8*8+0x18], 0x1
vmulpd ymm0, ymm13, ymm14
vaddpd ymm7, ymm4, ymm5
vaddpd ymm8, ymm15, ymm0
vinsertf128 ymm6, ymm1, xmmword ptr [r9+r8*8+0x18], 0x1
vmulpd ymm9, ymm6, ymm7
vaddpd ymm10, ymm8, ymm9
vmovupd ymmword ptr [r15+r8*8+0x8], ymm10
add r8, 0x4
cmp r8, rax
jb 0xffffffffffffff43
{%- endcapture -%}

{%- capture layercondition -%}
L1: unconditionally fulfilled L2: unconditionally fulfilled L3: unconditionally fulfilled L1: P <= 2052/5 L2: P <= 16388/5 L3: P <= 1638404/5 L1: 48*N*P + 16*P*(N - 1) - 32*P <= 32768 L2: 48*N*P + 16*P*(N - 1) - 32*P <= 262144 L3: 48*N*P + 16*P*(N - 1) - 32*P <= 26214400
{%- endcapture -%}
{%- capture iaca -%}

Throughput Analysis Report
--------------------------
Block Throughput: 11.33 Cycles       Throughput Bottleneck: Backend. Port2_DATA, Port3_DATA

Port Binding In Cycles Per Iteration:
-------------------------------------------------------------------------
|  Port  |  0   -  DV  |  1   |  2   -  D   |  3   -  D   |  4   |  5   |
-------------------------------------------------------------------------
| Cycles | 6.3    0.0  | 6.0  | 10.0   11.0 | 10.0   11.0 | 2.0  | 7.7  |
-------------------------------------------------------------------------
...
---------------------------------------------------------------------
|   1    |           |     | 0.5   1.0 | 0.5   1.0 |     |     | CP | vmovupd ymm3, ymmword ptr [rsi+r8*8]
|   1    |           |     | 0.5   0.5 | 0.5   0.5 |     |     | CP | vmovupd xmm0, xmmword ptr [r14+r8*8+0x8]
|   1    |           |     | 0.5   0.5 | 0.5   0.5 |     |     | CP | vmovupd xmm2, xmmword ptr [r10+r8*8+0x8]
|   2    |           | 1.0 | 0.5   1.0 | 0.5   1.0 |     |     | CP | vaddpd ymm5, ymm3, ymmword ptr [rsi+r8*8+0x10]
|   1    |           |     | 0.5   0.5 | 0.5   0.5 |     |     | CP | vmovupd xmm9, xmmword ptr [rdi+r8*8+0x8]
|   1    |           |     | 0.5   0.5 | 0.5   0.5 |     |     | CP | vmovupd xmm10, xmmword ptr [r12+r8*8+0x8]
|   1    |           |     | 0.5   0.5 | 0.5   0.5 |     |     | CP | vmovupd xmm8, xmmword ptr [r11+r8*8+0x8]
|   1    |           |     | 0.5   0.5 | 0.5   0.5 |     |     | CP | vmovupd xmm3, xmmword ptr [r13+r8*8+0x8]
|   2    | 0.2       |     | 0.5   0.5 | 0.5   0.5 |     | 0.8 | CP | vinsertf128 ymm1, ymm0, xmmword ptr [r14+r8*8+0x18], 0x1
|   2    | 0.2       |     | 0.5   0.5 | 0.5   0.5 |     | 0.8 | CP | vinsertf128 ymm4, ymm2, xmmword ptr [r10+r8*8+0x18], 0x1
|   2    | 1.0       |     | 0.5   1.0 | 0.5   1.0 |     |     | CP | vmulpd ymm6, ymm1, ymmword ptr [rsi+r8*8+0x8]
|   1    | 1.0       |     |           |           |     |     |    | vmulpd ymm7, ymm4, ymm5
|   1    |           |     | 0.5   0.5 | 0.5   0.5 |     |     | CP | vmovupd xmm2, xmmword ptr [rdx+r8*8+0x8]
|   1    |           |     | 0.5   0.5 | 0.5   0.5 |     |     | CP | vmovupd xmm1, xmmword ptr [r9+r8*8+0x8]
|   1    |           | 1.0 |           |           |     |     |    | vaddpd ymm15, ymm6, ymm7
|   2    | 0.1       |     | 0.5   0.5 | 0.5   0.5 |     | 0.9 | CP | vinsertf128 ymm11, ymm9, xmmword ptr [rdi+r8*8+0x18], 0x1
|   2    | 0.1       |     | 0.5   0.5 | 0.5   0.5 |     | 0.9 | CP | vinsertf128 ymm12, ymm10, xmmword ptr [r12+r8*8+0x18], 0x1
|   1    |           | 1.0 |           |           |     |     |    | vaddpd ymm14, ymm11, ymm12
|   2    | 0.8       |     | 0.5   0.5 | 0.5   0.5 |     | 0.2 | CP | vinsertf128 ymm13, ymm8, xmmword ptr [r11+r8*8+0x18], 0x1
|   2    | 0.3       |     | 0.5   0.5 | 0.5   0.5 |     | 0.6 | CP | vinsertf128 ymm4, ymm2, xmmword ptr [rdx+r8*8+0x18], 0x1
|   2    | 0.3       |     | 0.5   0.5 | 0.5   0.5 |     | 0.6 | CP | vinsertf128 ymm5, ymm3, xmmword ptr [r13+r8*8+0x18], 0x1
|   1    | 1.0       |     |           |           |     |     |    | vmulpd ymm0, ymm13, ymm14
|   1    |           | 1.0 |           |           |     |     |    | vaddpd ymm7, ymm4, ymm5
|   1    |           | 1.0 |           |           |     |     |    | vaddpd ymm8, ymm15, ymm0
|   2    | 0.2       |     | 0.5   0.5 | 0.5   0.5 |     | 0.9 | CP | vinsertf128 ymm6, ymm1, xmmword ptr [r9+r8*8+0x18], 0x1
|   1    | 1.0       |     |           |           |     |     |    | vmulpd ymm9, ymm6, ymm7
|   1    |           | 1.0 |           |           |     |     |    | vaddpd ymm10, ymm8, ymm9
|   2    |           |     | 0.5       | 0.5       | 2.0 |     |    | vmovupd ymmword ptr [r15+r8*8+0x8], ymm10
|   1    |           |     |           |           |     | 1.0 |    | add r8, 0x4
|   1    |           |     |           |           |     | 1.0 |    | cmp r8, rax
|   0F   |           |     |           |           |     |     |    | jb 0xffffffffffffff43
...
# Logged in users
################################################################################
 02:01:36 up 2 days, 11:22,  0 users,  load average: 0.82, 1.12, 1.77
...
MemFree:        62286060 kB
MemAvailable:   62253668 kB
Buffers:               0 kB
Cached:          2242480 kB
SwapCached:            0 kB
Active:           123540 kB
Inactive:        2133112 kB
Active(anon):      48592 kB
Inactive(anon):  1888996 kB
Active(file):      74948 kB
Inactive(file):   244116 kB
...
PWD=/home/hpc/iwia/iwia84/INSPECT-repo/stencils/3D_r1_point-symmetric_star_variable/IvyBridgeEP_E5-2660v2_20190524_020136
