...
title:  "Stencil 3D r1 star constant point-symmetric double SkylakeSP_Gold-6148_SNC"
...
--------------------------
Block Throughput: 6.84 Cycles       Throughput Bottleneck: Backend
Loop Count:  22
Port Binding In Cycles Per Iteration:
--------------------------------------------------------------------------------------------------
|  Port  |   0   -  DV   |   1   |   2   -  D    |   3   -  D    |   4   |   5   |   6   |   7   |
--------------------------------------------------------------------------------------------------
| Cycles |  5.3     0.0  |  5.4  |  4.0     4.0  |  4.0     3.0  |  1.0  |  5.3  |  1.0  |  0.0  |
--------------------------------------------------------------------------------------------------
...
-----------------------------------------------------------------------------------------
|   1      |             |      |             |             |      | 1.0  |      |      | vpcmpgtq k1, ymm10, ymm11
|   1      |             |      |             |             |      | 1.0  |      |      | vpaddq ymm11, ymm11, ymm7
|   2      |             |      | 1.0     1.0 |             |      | 1.0  |      |      | vmovupd ymm12{k1}{z}, ymmword ptr [r8+r12*8]
|   2      |             | 0.4  |             | 1.0     1.0 |      | 0.6  |      |      | vmovupd ymm13{k1}{z}, ymmword ptr [r8+r12*8+0x10]
|   2      | 0.3         | 0.3  | 1.0     1.0 |             |      | 0.4  |      |      | vmovupd ymm15{k1}{z}, ymmword ptr [r8+r12*8+0x8]
|   2      | 0.4         | 0.3  |             | 1.0     1.0 |      | 0.3  |      |      | vmovupd ymm16{k1}{z}, ymmword ptr [rsi+r12*8+0x8]
|   2      | 0.3         | 0.4  | 1.0     1.0 |             |      | 0.3  |      |      | vmovupd ymm17{k1}{z}, ymmword ptr [r15+r12*8+0x8]
|   2      | 0.3         | 0.3  |             | 1.0     1.0 |      | 0.4  |      |      | vmovupd ymm19{k1}{z}, ymmword ptr [rbx+r12*8+0x8]
|   2      | 0.4         | 0.3  | 1.0     1.0 |             |      | 0.3  |      |      | vmovupd ymm20{k1}{z}, ymmword ptr [r14+r12*8+0x8]
|   1      | 0.6         | 0.4  |             |             |      |      |      |      | vaddpd ymm14, ymm12, ymm13
|   1      | 0.4         | 0.6  |             |             |      |      |      |      | vaddpd ymm18, ymm16, ymm17
|   1      | 0.6         | 0.4  |             |             |      |      |      |      | vaddpd ymm21, ymm19, ymm20
|   1      | 0.4         | 0.6  |             |             |      |      |      |      | vmulpd ymm22, ymm2, ymm14
|   1      | 0.6         | 0.4  |             |             |      |      |      |      | vfmadd231pd ymm22, ymm15, ymm3
|   1      | 0.4         | 0.6  |             |             |      |      |      |      | vfmadd231pd ymm22, ymm18, ymm1
|   1      | 0.6         | 0.4  |             |             |      |      |      |      | vfmadd231pd ymm22, ymm21, ymm0
|   2      |             |      |             | 1.0         | 1.0  |      |      |      | vmovupd ymmword ptr [r13+r12*8+0x8]{k1}, ymm22
|   1      |             |      |             |             |      |      | 1.0  |      | add r12, 0x4
|   1*     |             |      |             |             |      |      |      |      | cmp r12, rax
|   0*F    |             |      |             |             |      |      |      |      | jb 0xffffffffffffff72
...
# Logged in users
################################################################################
 03:12:47 up 10 days, 13:07,  0 users,  load average: 0.48, 0.79, 0.91
...
CPU 0: governor  performance min/cur/max 2.4/1.334/2.4 GHz Turbo 0
CPU 1: governor  performance min/cur/max 2.4/1.484/2.4 GHz Turbo 0
CPU 2: governor  performance min/cur/max 2.4/2.251/2.4 GHz Turbo 0
CPU 5: governor  performance min/cur/max 2.4/1.359/2.4 GHz Turbo 0
CPU 6: governor  performance min/cur/max 2.4/1.818/2.4 GHz Turbo 0
CPU 10: governor  performance min/cur/max 2.4/2.108/2.4 GHz Turbo 0
CPU 11: governor  performance min/cur/max 2.4/2.327/2.4 GHz Turbo 0
CPU 12: governor  performance min/cur/max 2.4/1.527/2.4 GHz Turbo 0
CPU 15: governor  performance min/cur/max 2.4/1.316/2.4 GHz Turbo 0
CPU 16: governor  performance min/cur/max 2.4/1.960/2.4 GHz Turbo 0
CPU 3: governor  performance min/cur/max 2.4/1.884/2.4 GHz Turbo 0
CPU 4: governor  performance min/cur/max 2.4/1.762/2.4 GHz Turbo 0
CPU 7: governor  performance min/cur/max 2.4/1.499/2.4 GHz Turbo 0
CPU 8: governor  performance min/cur/max 2.4/1.995/2.4 GHz Turbo 0
CPU 9: governor  performance min/cur/max 2.4/2.158/2.4 GHz Turbo 0
CPU 13: governor  performance min/cur/max 2.4/1.504/2.4 GHz Turbo 0
CPU 14: governor  performance min/cur/max 2.4/1.977/2.4 GHz Turbo 0
CPU 17: governor  performance min/cur/max 2.4/2.400/2.4 GHz Turbo 0
CPU 18: governor  performance min/cur/max 2.4/1.414/2.4 GHz Turbo 0
CPU 19: governor  performance min/cur/max 2.4/1.618/2.4 GHz Turbo 0
CPU 20: governor  performance min/cur/max 2.4/2.118/2.4 GHz Turbo 0
CPU 21: governor  performance min/cur/max 2.4/2.107/2.4 GHz Turbo 0
CPU 22: governor  performance min/cur/max 2.4/2.099/2.4 GHz Turbo 0
CPU 25: governor  performance min/cur/max 2.4/1.663/2.4 GHz Turbo 0
CPU 26: governor  performance min/cur/max 2.4/2.292/2.4 GHz Turbo 0
CPU 30: governor  performance min/cur/max 2.4/2.030/2.4 GHz Turbo 0
CPU 31: governor  performance min/cur/max 2.4/1.528/2.4 GHz Turbo 0
CPU 32: governor  performance min/cur/max 2.4/1.847/2.4 GHz Turbo 0
CPU 35: governor  performance min/cur/max 2.4/2.307/2.4 GHz Turbo 0
CPU 36: governor  performance min/cur/max 2.4/2.021/2.4 GHz Turbo 0
CPU 23: governor  performance min/cur/max 2.4/1.554/2.4 GHz Turbo 0
CPU 24: governor  performance min/cur/max 2.4/2.164/2.4 GHz Turbo 0
CPU 27: governor  performance min/cur/max 2.4/2.256/2.4 GHz Turbo 0
CPU 28: governor  performance min/cur/max 2.4/1.692/2.4 GHz Turbo 0
CPU 29: governor  performance min/cur/max 2.4/2.144/2.4 GHz Turbo 0
CPU 33: governor  performance min/cur/max 2.4/2.287/2.4 GHz Turbo 0
CPU 34: governor  performance min/cur/max 2.4/1.687/2.4 GHz Turbo 0
CPU 37: governor  performance min/cur/max 2.4/1.607/2.4 GHz Turbo 0
CPU 38: governor  performance min/cur/max 2.4/1.909/2.4 GHz Turbo 0
CPU 39: governor  performance min/cur/max 2.4/2.029/2.4 GHz Turbo 0
CPU 40: governor  performance min/cur/max 2.4/1.495/2.4 GHz Turbo 0
CPU 41: governor  performance min/cur/max 2.4/1.660/2.4 GHz Turbo 0
CPU 42: governor  performance min/cur/max 2.4/2.247/2.4 GHz Turbo 0
CPU 45: governor  performance min/cur/max 2.4/1.245/2.4 GHz Turbo 0
CPU 46: governor  performance min/cur/max 2.4/2.102/2.4 GHz Turbo 0
CPU 50: governor  performance min/cur/max 2.4/1.483/2.4 GHz Turbo 0
CPU 51: governor  performance min/cur/max 2.4/1.717/2.4 GHz Turbo 0
CPU 52: governor  performance min/cur/max 2.4/2.303/2.4 GHz Turbo 0
CPU 55: governor  performance min/cur/max 2.4/1.366/2.4 GHz Turbo 0
CPU 56: governor  performance min/cur/max 2.4/1.992/2.4 GHz Turbo 0
CPU 43: governor  performance min/cur/max 2.4/1.750/2.4 GHz Turbo 0
CPU 44: governor  performance min/cur/max 2.4/1.821/2.4 GHz Turbo 0
CPU 47: governor  performance min/cur/max 2.4/2.335/2.4 GHz Turbo 0
CPU 48: governor  performance min/cur/max 2.4/1.192/2.4 GHz Turbo 0
CPU 49: governor  performance min/cur/max 2.4/2.174/2.4 GHz Turbo 0
CPU 53: governor  performance min/cur/max 2.4/1.427/2.4 GHz Turbo 0
CPU 54: governor  performance min/cur/max 2.4/2.029/2.4 GHz Turbo 0
CPU 57: governor  performance min/cur/max 2.4/1.226/2.4 GHz Turbo 0
CPU 58: governor  performance min/cur/max 2.4/1.970/2.4 GHz Turbo 0
CPU 59: governor  performance min/cur/max 2.4/2.028/2.4 GHz Turbo 0
CPU 60: governor  performance min/cur/max 2.4/2.400/2.4 GHz Turbo 0
CPU 61: governor  performance min/cur/max 2.4/2.400/2.4 GHz Turbo 0
CPU 62: governor  performance min/cur/max 2.4/2.311/2.4 GHz Turbo 0
CPU 65: governor  performance min/cur/max 2.4/2.335/2.4 GHz Turbo 0
CPU 66: governor  performance min/cur/max 2.4/1.539/2.4 GHz Turbo 0
CPU 70: governor  performance min/cur/max 2.4/1.672/2.4 GHz Turbo 0
CPU 71: governor  performance min/cur/max 2.4/2.322/2.4 GHz Turbo 0
CPU 72: governor  performance min/cur/max 2.4/1.866/2.4 GHz Turbo 0
CPU 75: governor  performance min/cur/max 2.4/1.670/2.4 GHz Turbo 0
CPU 76: governor  performance min/cur/max 2.4/2.313/2.4 GHz Turbo 0
CPU 63: governor  performance min/cur/max 2.4/1.969/2.4 GHz Turbo 0
CPU 64: governor  performance min/cur/max 2.4/2.171/2.4 GHz Turbo 0
CPU 67: governor  performance min/cur/max 2.4/1.774/2.4 GHz Turbo 0
CPU 68: governor  performance min/cur/max 2.4/2.267/2.4 GHz Turbo 0
CPU 69: governor  performance min/cur/max 2.4/2.237/2.4 GHz Turbo 0
CPU 73: governor  performance min/cur/max 2.4/1.578/2.4 GHz Turbo 0
CPU 74: governor  performance min/cur/max 2.4/1.649/2.4 GHz Turbo 0
CPU 77: governor  performance min/cur/max 2.4/1.799/2.4 GHz Turbo 0
CPU 78: governor  performance min/cur/max 2.4/1.614/2.4 GHz Turbo 0
CPU 79: governor  performance min/cur/max 2.4/2.401/2.4 GHz Turbo 0
...
MemFree:        95601196 kB
MemAvailable:   95660068 kB
Buffers:           47456 kB
Cached:           545888 kB
SwapCached:          108 kB
Active:           375648 kB
Inactive:         255728 kB
Active(anon):      32880 kB
Inactive(anon):     6792 kB
Active(file):     342768 kB
Inactive(file):   248936 kB
Unevictable:           0 kB
Mlocked:               0 kB
SwapTotal:      49632252 kB
SwapFree:       49627388 kB
Dirty:               260 kB
Writeback:             8 kB
AnonPages:         37680 kB
Mapped:            55576 kB
Shmem:              1640 kB
Slab:             688620 kB
SReclaimable:     261276 kB
SUnreclaim:       427344 kB
...
OLDPWD=/home/hpc/iwia/iwia84/INSPECT-repo/stencils/3D_r1_homogeneous_star_constant/SkylakeSP_Gold-6148_SNC_20190416_231343
...
PWD=/home/hpc/iwia/iwia84/INSPECT-repo/stencils/3D_r1_point-symmetric_star_constant/SkylakeSP_Gold-6148_SNC_20190417_031247
