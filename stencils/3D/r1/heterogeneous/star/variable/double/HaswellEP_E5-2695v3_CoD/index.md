...
--------------------------
Block Throughput: 8.01 Cycles       Throughput Bottleneck: Backend
Loop Count:  108
Port Binding In Cycles Per Iteration:
--------------------------------------------------------------------------------------------------
|  Port  |   0   -  DV   |   1   |   2   -  D    |   3   -  D    |   4   |   5   |   6   |   7   |
--------------------------------------------------------------------------------------------------
| Cycles |  4.5     0.0  |  4.5  |  8.0     7.0  |  8.0     8.0  |  1.0  |  1.0  |  1.0  |  0.0  |
--------------------------------------------------------------------------------------------------
...
-----------------------------------------------------------------------------------------
|   1      |             |      | 1.0     1.0 |             |      |      |      |      | vmovupd ymm6, ymmword ptr [r12+rdx*8+0x8]
|   1      |             |      |             | 1.0     1.0 |      |      |      |      | vmovupd ymm0, ymmword ptr [rbx+rdx*8+0x8]
|   1      |             |      | 1.0     1.0 |             |      |      |      |      | vmovupd ymm2, ymmword ptr [rdi+rdx*8+0x8]
|   1      |             |      |             | 1.0     1.0 |      |      |      |      | vmovupd ymm7, ymmword ptr [r14+rdx*8]
|   1      |             |      | 1.0     1.0 |             |      |      |      |      | vmovupd ymm1, ymmword ptr [r11+rdx*8+0x8]
|   2      | 1.0         |      |             | 1.0     1.0 |      |      |      |      | vmulpd ymm10, ymm6, ymmword ptr [r14+rdx*8+0x10]
|   1      |             |      | 1.0     1.0 |             |      |      |      |      | vmovupd ymm3, ymmword ptr [r10+rdx*8+0x8]
|   2      | 1.0         |      |             | 1.0     1.0 |      |      |      |      | vmulpd ymm4, ymm0, ymmword ptr [rsi+rdx*8+0x8]
|   2      | 0.5         | 0.5  | 1.0     1.0 |             |      |      |      |      | vmulpd ymm5, ymm2, ymmword ptr [r8+rdx*8+0x8]
|   1      |             |      |             | 1.0     1.0 |      |      |      |      | vmovupd ymm8, ymmword ptr [r14+rdx*8+0x8]
|   2      | 0.5         | 0.5  | 1.0     1.0 |             |      |      |      |      | vfmadd231pd ymm10, ymm7, ymmword ptr [r13+rdx*8+0x8]
|   2      | 0.5         | 0.5  |             | 1.0     1.0 |      |      |      |      | vfmadd231pd ymm4, ymm1, ymmword ptr [r15+rdx*8+0x8]
|   2      | 0.5         | 0.5  | 1.0     1.0 |             |      |      |      |      | vfmadd231pd ymm5, ymm3, ymmword ptr [rax+rdx*8+0x8]
|   2      | 0.5         | 0.5  |             | 1.0     1.0 |      |      |      |      | vfmadd231pd ymm10, ymm8, ymmword ptr [rcx+rdx*8+0x8]
|   1      |             | 1.0  |             |             |      |      |      |      | vaddpd ymm9, ymm4, ymm5
|   1      |             | 1.0  |             |             |      |      |      |      | vaddpd ymm11, ymm9, ymm10
|   2      |             |      | 1.0         |             | 1.0  |      |      |      | vmovupd ymmword ptr [r9+rdx*8+0x8], ymm11
|   1      |             |      |             |             |      |      | 1.0  |      | add rdx, 0x4
...
# Logged in users
################################################################################
 09:04:13 up 20 days, 20:08,  0 users,  load average: 0.58, 0.83, 0.92
...
CPU 0: governor  performance min/cur/max 2.3/1.723/2.3 GHz Turbo 0
CPU 1: governor  performance min/cur/max 2.3/1.340/2.3 GHz Turbo 0
CPU 2: governor  performance min/cur/max 2.3/1.335/2.3 GHz Turbo 0
CPU 3: governor  performance min/cur/max 2.3/1.200/2.3 GHz Turbo 0
CPU 4: governor  performance min/cur/max 2.3/1.434/2.3 GHz Turbo 0
CPU 5: governor  performance min/cur/max 2.3/1.751/2.3 GHz Turbo 0
CPU 6: governor  performance min/cur/max 2.3/1.439/2.3 GHz Turbo 0
CPU 7: governor  performance min/cur/max 2.3/1.516/2.3 GHz Turbo 0
CPU 8: governor  performance min/cur/max 2.3/2.301/2.3 GHz Turbo 0
CPU 9: governor  performance min/cur/max 2.3/1.525/2.3 GHz Turbo 0
CPU 10: governor  performance min/cur/max 2.3/1.340/2.3 GHz Turbo 0
CPU 11: governor  performance min/cur/max 2.3/1.497/2.3 GHz Turbo 0
CPU 12: governor  performance min/cur/max 2.3/1.464/2.3 GHz Turbo 0
CPU 13: governor  performance min/cur/max 2.3/1.644/2.3 GHz Turbo 0
CPU 14: governor  performance min/cur/max 2.3/2.276/2.3 GHz Turbo 0
CPU 15: governor  performance min/cur/max 2.3/2.259/2.3 GHz Turbo 0
CPU 16: governor  performance min/cur/max 2.3/2.192/2.3 GHz Turbo 0
CPU 17: governor  performance min/cur/max 2.3/2.262/2.3 GHz Turbo 0
CPU 18: governor  performance min/cur/max 2.3/2.147/2.3 GHz Turbo 0
CPU 19: governor  performance min/cur/max 2.3/2.173/2.3 GHz Turbo 0
CPU 20: governor  performance min/cur/max 2.3/2.247/2.3 GHz Turbo 0
CPU 21: governor  performance min/cur/max 2.3/2.152/2.3 GHz Turbo 0
CPU 22: governor  performance min/cur/max 2.3/2.064/2.3 GHz Turbo 0
CPU 23: governor  performance min/cur/max 2.3/2.277/2.3 GHz Turbo 0
CPU 24: governor  performance min/cur/max 2.3/2.171/2.3 GHz Turbo 0
CPU 25: governor  performance min/cur/max 2.3/2.278/2.3 GHz Turbo 0
CPU 26: governor  performance min/cur/max 2.3/2.254/2.3 GHz Turbo 0
CPU 27: governor  performance min/cur/max 2.3/2.046/2.3 GHz Turbo 0
CPU 28: governor  performance min/cur/max 2.3/1.654/2.3 GHz Turbo 0
CPU 29: governor  performance min/cur/max 2.3/1.766/2.3 GHz Turbo 0
CPU 30: governor  performance min/cur/max 2.3/2.303/2.3 GHz Turbo 0
CPU 31: governor  performance min/cur/max 2.3/2.085/2.3 GHz Turbo 0
CPU 32: governor  performance min/cur/max 2.3/1.454/2.3 GHz Turbo 0
CPU 33: governor  performance min/cur/max 2.3/1.523/2.3 GHz Turbo 0
CPU 34: governor  performance min/cur/max 2.3/1.762/2.3 GHz Turbo 0
CPU 35: governor  performance min/cur/max 2.3/1.413/2.3 GHz Turbo 0
CPU 36: governor  performance min/cur/max 2.3/1.755/2.3 GHz Turbo 0
CPU 37: governor  performance min/cur/max 2.3/1.660/2.3 GHz Turbo 0
CPU 38: governor  performance min/cur/max 2.3/1.745/2.3 GHz Turbo 0
CPU 39: governor  performance min/cur/max 2.3/1.554/2.3 GHz Turbo 0
...
CPU 43: governor  performance min/cur/max 2.3/2.289/2.3 GHz Turbo 0
CPU 44: governor  performance min/cur/max 2.3/2.297/2.3 GHz Turbo 0
...
CPU 55: governor  performance min/cur/max 2.3/2.301/2.3 GHz Turbo 0
...
MemFree:        64103176 kB
MemAvailable:   64506944 kB
Buffers:          119976 kB
Cached:           698600 kB
SwapCached:           24 kB
Active:           653024 kB
Inactive:         207068 kB
Active(anon):      38908 kB
Inactive(anon):    10652 kB
Active(file):     614116 kB
Inactive(file):   196416 kB
Unevictable:           0 kB
Mlocked:               0 kB
...
Shmem:              8044 kB
Slab:             547516 kB
SReclaimable:     266200 kB
SUnreclaim:       281316 kB
...
DirectMap4k:      537728 kB
DirectMap2M:    21372928 kB
...
OLDPWD=/home/hpc/iwia/iwia84/INSPECT-repo/stencils/3D_r1_isotropic_star_variable/HaswellEP_E5-2695v3_CoD_20190417_052435
...
PWD=/home/hpc/iwia/iwia84/INSPECT-repo/stencils/3D_r1_heterogeneous_star_variable/HaswellEP_E5-2695v3_CoD_20190417_090413
