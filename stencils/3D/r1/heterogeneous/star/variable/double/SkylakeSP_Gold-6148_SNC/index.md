...
title:  "Stencil 3D r1 star variable heterogeneous double SkylakeSP_Gold-6148_SNC"
...
vmovupd ymm14{k1}{z}, ymmword ptr [rcx+r14*8+0x8]
vmovupd ymm15{k1}{z}, ymmword ptr [r13+r14*8+0x10]
vmovupd ymm4{k1}{z}, ymmword ptr [r11+r14*8+0x8]
vmovupd ymm5{k1}{z}, ymmword ptr [r12+r14*8+0x8]
vmovupd ymm8{k1}{z}, ymmword ptr [r10+r14*8+0x8]
vmovupd ymm9{k1}{z}, ymmword ptr [rdi+r14*8+0x8]
vmovupd ymm17{k1}{z}, ymmword ptr [rsi+r14*8+0x8]
vmovupd ymm16{k1}{z}, ymmword ptr [r13+r14*8]
vmulpd ymm21, ymm14, ymm15
vmovupd ymm7{k1}{z}, ymmword ptr [rdx+r14*8+0x8]
vmovupd ymm6{k1}{z}, ymmword ptr [r9+r14*8+0x8]
vmovupd ymm11{k1}{z}, ymmword ptr [rax+r14*8+0x8]
vmovupd ymm10{k1}{z}, ymmword ptr [rbx+r14*8+0x8]
vmulpd ymm12, ymm4, ymm5
vmulpd ymm13, ymm8, ymm9
vmovupd ymm19{k1}{z}, ymmword ptr [r8+r14*8+0x8]
vmovupd ymm18{k1}{z}, ymmword ptr [r13+r14*8+0x8]
...
vmovupd ymmword ptr [r15+r14*8+0x8]{k1}, ymm22
add r14, 0x4
cmp r14, qword ptr [rsp+0x1b8]
jb 0xffffffffffffff17
{%- endcapture -%}
...
--------------------------
Block Throughput: 10.74 Cycles       Throughput Bottleneck: Dependency chains
Loop Count:  22
Port Binding In Cycles Per Iteration:
--------------------------------------------------------------------------------------------------
|  Port  |   0   -  DV   |   1   |   2   -  D    |   3   -  D    |   4   |   5   |   6   |   7   |
--------------------------------------------------------------------------------------------------
| Cycles |  8.3     0.0  |  8.4  |  8.0     7.0  |  8.0     8.0  |  1.0  |  8.3  |  2.0  |  0.0  |
--------------------------------------------------------------------------------------------------
...
|   2      |             |      | 1.0     1.0 |             |      | 1.0  |      |      | vmovupd ymm14{k1}{z}, ymmword ptr [rcx+r14*8+0x8]
|   2      | 0.3         | 0.4  |             | 1.0     1.0 |      | 0.3  |      |      | vmovupd ymm15{k1}{z}, ymmword ptr [r13+r14*8+0x10]
|   2      | 0.3         | 0.3  | 1.0     1.0 |             |      | 0.4  |      |      | vmovupd ymm4{k1}{z}, ymmword ptr [r11+r14*8+0x8]
|   2      | 0.4         | 0.3  |             | 1.0     1.0 |      | 0.3  |      |      | vmovupd ymm5{k1}{z}, ymmword ptr [r12+r14*8+0x8]
|   2      | 0.3         | 0.4  | 1.0     1.0 |             |      | 0.3  |      |      | vmovupd ymm8{k1}{z}, ymmword ptr [r10+r14*8+0x8]
|   2      | 0.3         | 0.3  |             | 1.0     1.0 |      | 0.4  |      |      | vmovupd ymm9{k1}{z}, ymmword ptr [rdi+r14*8+0x8]
|   2      | 0.4         | 0.3  | 1.0     1.0 |             |      | 0.3  |      |      | vmovupd ymm17{k1}{z}, ymmword ptr [rsi+r14*8+0x8]
|   2      | 0.3         | 0.4  |             | 1.0     1.0 |      | 0.3  |      |      | vmovupd ymm16{k1}{z}, ymmword ptr [r13+r14*8]
|   1      | 0.7         | 0.3  |             |             |      |      |      |      | vmulpd ymm21, ymm14, ymm15
|   2      |             | 0.3  | 1.0     1.0 |             |      | 0.7  |      |      | vmovupd ymm7{k1}{z}, ymmword ptr [rdx+r14*8+0x8]
|   2      | 0.3         | 0.4  |             | 1.0     1.0 |      | 0.3  |      |      | vmovupd ymm6{k1}{z}, ymmword ptr [r9+r14*8+0x8]
|   2      | 0.3         | 0.3  | 1.0     1.0 |             |      | 0.4  |      |      | vmovupd ymm11{k1}{z}, ymmword ptr [rax+r14*8+0x8]
|   2      | 0.4         | 0.3  |             | 1.0     1.0 |      | 0.3  |      |      | vmovupd ymm10{k1}{z}, ymmword ptr [rbx+r14*8+0x8]
|   1      | 0.6         | 0.4  |             |             |      |      |      |      | vmulpd ymm12, ymm4, ymm5
|   1      | 0.4         | 0.6  |             |             |      |      |      |      | vmulpd ymm13, ymm8, ymm9
|   2      |             |      | 1.0     1.0 |             |      | 1.0  |      |      | vmovupd ymm19{k1}{z}, ymmword ptr [r8+r14*8+0x8]
|   2      | 0.3         | 0.4  |             | 1.0     1.0 |      | 0.3  |      |      | vmovupd ymm18{k1}{z}, ymmword ptr [r13+r14*8+0x8]
|   1      | 0.7         | 0.3  |             |             |      |      |      |      | vfmadd231pd ymm21, ymm16, ymm17
|   1      | 0.3         | 0.7  |             |             |      |      |      |      | vfmadd231pd ymm12, ymm6, ymm7
|   1      | 0.7         | 0.3  |             |             |      |      |      |      | vfmadd231pd ymm13, ymm10, ymm11
|   1      | 0.3         | 0.7  |             |             |      |      |      |      | vfmadd231pd ymm21, ymm18, ymm19
|   1      | 0.7         | 0.3  |             |             |      |      |      |      | vaddpd ymm20, ymm12, ymm13
|   1      | 0.3         | 0.7  |             |             |      |      |      |      | vaddpd ymm22, ymm20, ymm21
|   2      |             |      | 1.0         |             | 1.0  |      |      |      | vmovupd ymmword ptr [r15+r14*8+0x8]{k1}, ymm22
|   1      |             |      |             |             |      |      | 1.0  |      | add r14, 0x4
|   2^     |             |      |             | 1.0     1.0 |      |      | 1.0  |      | cmp r14, qword ptr [rsp+0x1b8]
...
# Logged in users
################################################################################
 12:19:24 up 10 days, 22:13,  0 users,  load average: 0.72, 0.91, 0.97
...
CPU 0: governor  performance min/cur/max 2.4/1.146/2.4 GHz Turbo 0
CPU 1: governor  performance min/cur/max 2.4/1.575/2.4 GHz Turbo 0
CPU 2: governor  performance min/cur/max 2.4/2.375/2.4 GHz Turbo 0
CPU 5: governor  performance min/cur/max 2.4/1.858/2.4 GHz Turbo 0
CPU 6: governor  performance min/cur/max 2.4/1.308/2.4 GHz Turbo 0
CPU 10: governor  performance min/cur/max 2.4/1.854/2.4 GHz Turbo 0
CPU 11: governor  performance min/cur/max 2.4/1.961/2.4 GHz Turbo 0
CPU 12: governor  performance min/cur/max 2.4/2.158/2.4 GHz Turbo 0
CPU 15: governor  performance min/cur/max 2.4/2.275/2.4 GHz Turbo 0
CPU 16: governor  performance min/cur/max 2.4/1.444/2.4 GHz Turbo 0
CPU 3: governor  performance min/cur/max 2.4/1.918/2.4 GHz Turbo 0
CPU 4: governor  performance min/cur/max 2.4/1.876/2.4 GHz Turbo 0
CPU 7: governor  performance min/cur/max 2.4/2.264/2.4 GHz Turbo 0
CPU 8: governor  performance min/cur/max 2.4/1.289/2.4 GHz Turbo 0
CPU 9: governor  performance min/cur/max 2.4/2.124/2.4 GHz Turbo 0
CPU 13: governor  performance min/cur/max 2.4/1.909/2.4 GHz Turbo 0
CPU 14: governor  performance min/cur/max 2.4/1.307/2.4 GHz Turbo 0
CPU 17: governor  performance min/cur/max 2.4/1.449/2.4 GHz Turbo 0
CPU 18: governor  performance min/cur/max 2.4/1.765/2.4 GHz Turbo 0
CPU 19: governor  performance min/cur/max 2.4/1.799/2.4 GHz Turbo 0
CPU 20: governor  performance min/cur/max 2.4/1.570/2.4 GHz Turbo 0
CPU 21: governor  performance min/cur/max 2.4/2.156/2.4 GHz Turbo 0
CPU 22: governor  performance min/cur/max 2.4/2.280/2.4 GHz Turbo 0
CPU 25: governor  performance min/cur/max 2.4/2.117/2.4 GHz Turbo 0
CPU 26: governor  performance min/cur/max 2.4/2.337/2.4 GHz Turbo 0
CPU 30: governor  performance min/cur/max 2.4/2.366/2.4 GHz Turbo 0
CPU 31: governor  performance min/cur/max 2.4/2.085/2.4 GHz Turbo 0
CPU 32: governor  performance min/cur/max 2.4/2.184/2.4 GHz Turbo 0
CPU 35: governor  performance min/cur/max 2.4/2.070/2.4 GHz Turbo 0
CPU 36: governor  performance min/cur/max 2.4/1.838/2.4 GHz Turbo 0
CPU 23: governor  performance min/cur/max 2.4/1.653/2.4 GHz Turbo 0
CPU 24: governor  performance min/cur/max 2.4/2.362/2.4 GHz Turbo 0
CPU 27: governor  performance min/cur/max 2.4/2.361/2.4 GHz Turbo 0
CPU 28: governor  performance min/cur/max 2.4/2.400/2.4 GHz Turbo 0
CPU 29: governor  performance min/cur/max 2.4/2.402/2.4 GHz Turbo 0
...
CPU 37: governor  performance min/cur/max 2.4/2.401/2.4 GHz Turbo 0
CPU 38: governor  performance min/cur/max 2.4/1.432/2.4 GHz Turbo 0
CPU 39: governor  performance min/cur/max 2.4/2.400/2.4 GHz Turbo 0
CPU 40: governor  performance min/cur/max 2.4/1.203/2.4 GHz Turbo 0
CPU 41: governor  performance min/cur/max 2.4/1.884/2.4 GHz Turbo 0
CPU 42: governor  performance min/cur/max 2.4/1.857/2.4 GHz Turbo 0
CPU 45: governor  performance min/cur/max 2.4/1.519/2.4 GHz Turbo 0
CPU 46: governor  performance min/cur/max 2.4/1.873/2.4 GHz Turbo 0
CPU 50: governor  performance min/cur/max 2.4/1.797/2.4 GHz Turbo 0
CPU 51: governor  performance min/cur/max 2.4/1.809/2.4 GHz Turbo 0
CPU 52: governor  performance min/cur/max 2.4/2.134/2.4 GHz Turbo 0
CPU 55: governor  performance min/cur/max 2.4/1.892/2.4 GHz Turbo 0
CPU 56: governor  performance min/cur/max 2.4/1.670/2.4 GHz Turbo 0
CPU 43: governor  performance min/cur/max 2.4/1.663/2.4 GHz Turbo 0
CPU 44: governor  performance min/cur/max 2.4/1.329/2.4 GHz Turbo 0
CPU 47: governor  performance min/cur/max 2.4/1.668/2.4 GHz Turbo 0
CPU 48: governor  performance min/cur/max 2.4/2.040/2.4 GHz Turbo 0
CPU 49: governor  performance min/cur/max 2.4/2.027/2.4 GHz Turbo 0
CPU 53: governor  performance min/cur/max 2.4/1.809/2.4 GHz Turbo 0
CPU 54: governor  performance min/cur/max 2.4/1.884/2.4 GHz Turbo 0
CPU 57: governor  performance min/cur/max 2.4/2.271/2.4 GHz Turbo 0
CPU 58: governor  performance min/cur/max 2.4/1.954/2.4 GHz Turbo 0
CPU 59: governor  performance min/cur/max 2.4/1.688/2.4 GHz Turbo 0
CPU 60: governor  performance min/cur/max 2.4/1.976/2.4 GHz Turbo 0
CPU 61: governor  performance min/cur/max 2.4/2.118/2.4 GHz Turbo 0
CPU 62: governor  performance min/cur/max 2.4/2.259/2.4 GHz Turbo 0
CPU 65: governor  performance min/cur/max 2.4/2.216/2.4 GHz Turbo 0
CPU 66: governor  performance min/cur/max 2.4/2.371/2.4 GHz Turbo 0
CPU 70: governor  performance min/cur/max 2.4/2.253/2.4 GHz Turbo 0
CPU 71: governor  performance min/cur/max 2.4/1.640/2.4 GHz Turbo 0
CPU 72: governor  performance min/cur/max 2.4/1.952/2.4 GHz Turbo 0
CPU 75: governor  performance min/cur/max 2.4/2.152/2.4 GHz Turbo 0
CPU 76: governor  performance min/cur/max 2.4/2.039/2.4 GHz Turbo 0
CPU 63: governor  performance min/cur/max 2.4/2.076/2.4 GHz Turbo 0
CPU 64: governor  performance min/cur/max 2.4/1.980/2.4 GHz Turbo 0
CPU 67: governor  performance min/cur/max 2.4/2.086/2.4 GHz Turbo 0
CPU 68: governor  performance min/cur/max 2.4/2.173/2.4 GHz Turbo 0
CPU 69: governor  performance min/cur/max 2.4/2.108/2.4 GHz Turbo 0
CPU 73: governor  performance min/cur/max 2.4/1.493/2.4 GHz Turbo 0
CPU 74: governor  performance min/cur/max 2.4/1.646/2.4 GHz Turbo 0
CPU 77: governor  performance min/cur/max 2.4/1.704/2.4 GHz Turbo 0
CPU 78: governor  performance min/cur/max 2.4/1.778/2.4 GHz Turbo 0
CPU 79: governor  performance min/cur/max 2.4/1.533/2.4 GHz Turbo 0
...
Active(file):     432192 kB
Inactive(file):   155776 kB
Unevictable:           0 kB
Mlocked:               0 kB
SwapTotal:      49632252 kB
SwapFree:       49623548 kB
Dirty:               480 kB
Writeback:             0 kB
AnonPages:         39300 kB
Mapped:            53960 kB
Shmem:              1684 kB
Slab:             706076 kB
SReclaimable:     277028 kB
SUnreclaim:       429048 kB
...
OLDPWD=/home/hpc/iwia/iwia84/INSPECT-repo/stencils/3D_r1_isotropic_star_variable/SkylakeSP_Gold-6148_SNC_20190417_071110
...
PWD=/home/hpc/iwia/iwia84/INSPECT-repo/stencils/3D_r1_heterogeneous_star_variable/SkylakeSP_Gold-6148_SNC_20190417_121924
