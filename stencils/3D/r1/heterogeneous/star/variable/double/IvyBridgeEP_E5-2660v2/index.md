...
title:  "Stencil 3D r1 star variable heterogeneous double IvyBridgeEP_E5-2660v2"
...
vmovupd xmm0, xmmword ptr [rdx+rdi*8+0x8]
vmovupd xmm2, xmmword ptr [r9+rdi*8+0x8]
vmovupd ymm6, ymmword ptr [r14+rdi*8+0x8]
vmovupd xmm9, xmmword ptr [r10+rdi*8+0x8]
vmovupd xmm10, xmmword ptr [r15+rdi*8+0x8]
vmulpd ymm8, ymm6, ymmword ptr [rcx+rdi*8+0x10]
vmovupd xmm15, xmmword ptr [r11+rdi*8+0x8]
vmovupd xmm6, xmmword ptr [rbx+rdi*8+0x8]
vinsertf128 ymm1, ymm0, xmmword ptr [rdx+rdi*8+0x18], 0x1
vinsertf128 ymm3, ymm2, xmmword ptr [r9+rdi*8+0x18], 0x1
vmulpd ymm4, ymm1, ymmword ptr [rcx+rdi*8+0x8]
vmulpd ymm5, ymm3, ymmword ptr [rcx+rdi*8]
vmovupd xmm0, xmmword ptr [r12+rdi*8+0x8]
vaddpd ymm7, ymm4, ymm5
vmovupd xmm5, xmmword ptr [rax+rdi*8+0x8]
vaddpd ymm13, ymm7, ymm8
vinsertf128 ymm11, ymm9, xmmword ptr [r10+rdi*8+0x18], 0x1
vinsertf128 ymm12, ymm10, xmmword ptr [r15+rdi*8+0x18], 0x1
vmulpd ymm14, ymm11, ymm12
vmovupd xmm11, xmmword ptr [r13+rdi*8+0x8]
vaddpd ymm3, ymm13, ymm14
vinsertf128 ymm1, ymm15, xmmword ptr [r11+rdi*8+0x18], 0x1
vinsertf128 ymm2, ymm0, xmmword ptr [r12+rdi*8+0x18], 0x1
vmulpd ymm4, ymm1, ymm2
vaddpd ymm9, ymm3, ymm4
vinsertf128 ymm7, ymm5, xmmword ptr [rax+rdi*8+0x18], 0x1
vinsertf128 ymm8, ymm6, xmmword ptr [rbx+rdi*8+0x18], 0x1
vmulpd ymm10, ymm7, ymm8
vaddpd ymm13, ymm9, ymm10
vinsertf128 ymm12, ymm11, xmmword ptr [r13+rdi*8+0x18], 0x1
vmulpd ymm14, ymm12, ymmword ptr [r8+rdi*8+0x8]
vaddpd ymm0, ymm13, ymm14
vmovupd xmmword ptr [rsi+rdi*8+0x8], xmm0
vextractf128 xmmword ptr [rsi+rdi*8+0x18], ymm0, 0x1
add rdi, 0x4
cmp rdi, qword ptr [rsp+0x140]
jb 0xffffffffffffff19
{%- endcapture -%}

{%- capture layercondition -%}
L1: unconditionally fulfilled L2: unconditionally fulfilled L3: unconditionally fulfilled L1: P <= 4107/13 L2: P <= 32779/13 L3: P <= 3276811/13 L1: 72*N*P + 16*P*(N - 1) - 56*P <= 32768 L2: 72*N*P + 16*P*(N - 1) - 56*P <= 262144 L3: 72*N*P + 16*P*(N - 1) - 56*P <= 26214400
{%- endcapture -%}
{%- capture iaca -%}

Throughput Analysis Report
--------------------------
Block Throughput: 15.00 Cycles       Throughput Bottleneck: Backend. Port2_DATA

Port Binding In Cycles Per Iteration:
-------------------------------------------------------------------------
|  Port  |  0   -  DV  |  1   |  2   -  D   |  3   -  D   |  4   |  5   |
-------------------------------------------------------------------------
| Cycles | 8.9    0.0  | 6.0  | 13.0   15.0 | 13.0   14.0 | 2.0  | 9.1  |
-------------------------------------------------------------------------
...
---------------------------------------------------------------------
|   1    |           |     | 1.0   1.0 |           |     |     | CP | vmovupd xmm0, xmmword ptr [rdx+rdi*8+0x8]
|   1    |           |     |           | 1.0   1.0 |     |     |    | vmovupd xmm2, xmmword ptr [r9+rdi*8+0x8]
|   1    |           |     | 1.0   2.0 |           |     |     | CP | vmovupd ymm6, ymmword ptr [r14+rdi*8+0x8]
|   1    |           |     |           | 1.0   1.0 |     |     |    | vmovupd xmm9, xmmword ptr [r10+rdi*8+0x8]
|   1    |           |     | 1.0   1.0 |           |     |     | CP | vmovupd xmm10, xmmword ptr [r15+rdi*8+0x8]
|   2    | 1.0       |     |           | 1.0   2.0 |     |     |    | vmulpd ymm8, ymm6, ymmword ptr [rcx+rdi*8+0x10]
|   1    |           |     | 1.0   1.0 |           |     |     | CP | vmovupd xmm15, xmmword ptr [r11+rdi*8+0x8]
|   1    |           |     |           | 1.0   1.0 |     |     |    | vmovupd xmm6, xmmword ptr [rbx+rdi*8+0x8]
|   2    | 0.1       |     | 1.0   1.0 |           |     | 0.9 | CP | vinsertf128 ymm1, ymm0, xmmword ptr [rdx+rdi*8+0x18], 0x1
|   2    | 0.9       |     |           | 1.0   1.0 |     | 0.1 |    | vinsertf128 ymm3, ymm2, xmmword ptr [r9+rdi*8+0x18], 0x1
|   2    | 1.0       |     | 1.0   2.0 |           |     |     | CP | vmulpd ymm4, ymm1, ymmword ptr [rcx+rdi*8+0x8]
|   2    | 1.0       |     |           | 1.0   2.0 |     |     |    | vmulpd ymm5, ymm3, ymmword ptr [rcx+rdi*8]
|   1    |           |     | 1.0   1.0 |           |     |     | CP | vmovupd xmm0, xmmword ptr [r12+rdi*8+0x8]
|   1    |           | 1.0 |           |           |     |     |    | vaddpd ymm7, ymm4, ymm5
|   1    |           |     |           | 1.0   1.0 |     |     |    | vmovupd xmm5, xmmword ptr [rax+rdi*8+0x8]
|   1    |           | 1.0 |           |           |     |     |    | vaddpd ymm13, ymm7, ymm8
|   2    |           |     | 1.0   1.0 |           |     | 1.0 | CP | vinsertf128 ymm11, ymm9, xmmword ptr [r10+rdi*8+0x18], 0x1
|   2    |           |     |           | 1.0   1.0 |     | 1.0 |    | vinsertf128 ymm12, ymm10, xmmword ptr [r15+rdi*8+0x18], 0x1
|   1    | 1.0       |     |           |           |     |     |    | vmulpd ymm14, ymm11, ymm12
|   1    |           |     | 1.0   1.0 |           |     |     | CP | vmovupd xmm11, xmmword ptr [r13+rdi*8+0x8]
|   1    |           | 1.0 |           |           |     |     |    | vaddpd ymm3, ymm13, ymm14
|   2    |           |     |           | 1.0   1.0 |     | 1.0 |    | vinsertf128 ymm1, ymm15, xmmword ptr [r11+rdi*8+0x18], 0x1
|   2    | 0.1       |     | 1.0   1.0 |           |     | 0.9 | CP | vinsertf128 ymm2, ymm0, xmmword ptr [r12+rdi*8+0x18], 0x1
|   1    | 1.0       |     |           |           |     |     |    | vmulpd ymm4, ymm1, ymm2
|   1    |           | 1.0 |           |           |     |     |    | vaddpd ymm9, ymm3, ymm4
|   2    |           |     |           | 1.0   1.0 |     | 1.0 |    | vinsertf128 ymm7, ymm5, xmmword ptr [rax+rdi*8+0x18], 0x1
|   2    | 0.9       |     | 1.0   1.0 |           |     | 0.1 | CP | vinsertf128 ymm8, ymm6, xmmword ptr [rbx+rdi*8+0x18], 0x1
|   1    | 1.0       |     |           |           |     |     |    | vmulpd ymm10, ymm7, ymm8
|   1    |           | 1.0 |           |           |     |     |    | vaddpd ymm13, ymm9, ymm10
|   2    |           |     |           | 1.0   1.0 |     | 1.0 |    | vinsertf128 ymm12, ymm11, xmmword ptr [r13+rdi*8+0x18], 0x1
|   2    | 1.0       |     | 1.0   2.0 |           |     |     | CP | vmulpd ymm14, ymm12, ymmword ptr [r8+rdi*8+0x8]
|   1    |           | 1.0 |           |           |     |     |    | vaddpd ymm0, ymm13, ymm14
|   2    |           |     |           | 1.0       | 1.0 |     |    | vmovupd xmmword ptr [rsi+rdi*8+0x8], xmm0
|   2    |           |     | 1.0       |           | 1.0 |     |    | vextractf128 xmmword ptr [rsi+rdi*8+0x18], ymm0, 0x1
|   1    |           |     |           |           |     | 1.0 |    | add rdi, 0x4
|   2^   |           |     |           | 1.0   1.0 |     | 1.0 |    | cmp rdi, qword ptr [rsp+0x140]
|   0F   |           |     |           |           |     |     |    | jb 0xffffffffffffff19
...
# Logged in users
################################################################################
 10:34:56 up 1 day, 19:55,  0 users,  load average: 0.05, 1.75, 3.74
...
Inactive(anon):  1885468 kB
Active(file):       3340 kB
Inactive(file):    38940 kB
...
PWD=/home/hpc/iwia/iwia84/INSPECT-repo/stencils/3D_r1_heterogeneous_star_variable/IvyBridgeEP_E5-2660v2_20190523_103456
