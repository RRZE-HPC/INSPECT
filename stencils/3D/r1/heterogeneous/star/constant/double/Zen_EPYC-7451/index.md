...
title:  "Stencil 3D r1 star constant heterogeneous double Zen_EPYC-7451"
...
P vmulpd    8(%r10,%r13,8), %ymm9, %ymm14
vmulpd    (%r10,%r13,8), %ymm8, %ymm15
vaddpd    %ymm15, %ymm14, %ymm14
vmulpd    16(%r10,%r13,8), %ymm7, %ymm15
vaddpd    %ymm15, %ymm14, %ymm15
vmovupd   8(%r11,%r13,8), %xmm14
vinsertf128 $1, 24(%r11,%r13,8), %ymm14, %ymm14
vmulpd    %ymm14, %ymm11, %ymm14
vaddpd    %ymm14, %ymm15, %ymm14
vmovupd   8(%r8,%r13,8), %xmm15
vinsertf128 $1, 24(%r8,%r13,8), %ymm15, %ymm15
vmulpd    %ymm15, %ymm1, %ymm15
vaddpd    %ymm15, %ymm14, %ymm15
vmovupd   8(%r9,%r13,8), %xmm14
vinsertf128 $1, 24(%r9,%r13,8), %ymm14, %ymm14
vmulpd    %ymm14, %ymm2, %ymm14
vaddpd    %ymm14, %ymm15, %ymm14
vmovupd   8(%r15,%r13,8), %xmm15
vinsertf128 $1, 24(%r15,%r13,8), %ymm15, %ymm15
vmulpd    %ymm15, %ymm0, %ymm15
vaddpd    %ymm15, %ymm14, %ymm14
vmovupd   %ymm14, 8(%r14,%r13,8)
addq      $4, %r13
cmpq      %rax, %r13
jb        ..B1.16
{%- endcapture -%}
...
-------------------------------------------------------------------------------
| Cycles | 8.32 | 8.32 | 6.0 | 7.32 |  0  | 0.5 | 0.5 | 0.5 | 0.5 | 6.0 | 6.0 |
-------------------------------------------------------------------------------
...
------------------------------------------------------------------------------
| 1.00 | 1.00 |      |      |      |      |      |      |      |      |      | P vmulpd    8(%r10,%r13,8), %ymm9, %ymm14
| 1.00 | 1.00 |      |      |      |      |      |      |      |      |      | vmulpd    (%r10,%r13,8), %ymm8, %ymm15
|      |      | 1.00 | 1.00 |      |      |      |      |      |      |      | vaddpd    %ymm15, %ymm14, %ymm14
| 1.00 | 1.00 |      |      |      |      |      |      |      |      |      | vmulpd    16(%r10,%r13,8), %ymm7, %ymm15
|      |      | 1.00 | 1.00 |      |      |      |      |      |      |      | vaddpd    %ymm15, %ymm14, %ymm15
|      |      |      |      |      |      |      |      |      | 1.00 | 1.00 | vmovupd   8(%r11,%r13,8), %xmm14
| 0.33 | 0.33 |      | 0.33 |      |      |      |      |      |      |      | vinsertf128 $1, 24(%r11,%r13,8), %ymm14, %ymm14
| 1.00 | 1.00 |      |      |      |      |      |      |      |      |      | vmulpd    %ymm14, %ymm11, %ymm14
|      |      | 1.00 | 1.00 |      |      |      |      |      |      |      | vaddpd    %ymm14, %ymm15, %ymm14
|      |      |      |      |      |      |      |      |      | 1.00 | 1.00 | vmovupd   8(%r8,%r13,8), %xmm15
| 0.33 | 0.33 |      | 0.33 |      |      |      |      |      |      |      | vinsertf128 $1, 24(%r8,%r13,8), %ymm15, %ymm15
| 1.00 | 1.00 |      |      |      |      |      |      |      |      |      | vmulpd    %ymm15, %ymm1, %ymm15
|      |      | 1.00 | 1.00 |      |      |      |      |      |      |      | vaddpd    %ymm15, %ymm14, %ymm15
|      |      |      |      |      |      |      |      |      | 1.00 | 1.00 | vmovupd   8(%r9,%r13,8), %xmm14
| 0.33 | 0.33 |      | 0.33 |      |      |      |      |      |      |      | vinsertf128 $1, 24(%r9,%r13,8), %ymm14, %ymm14
| 1.00 | 1.00 |      |      |      |      |      |      |      |      |      | vmulpd    %ymm14, %ymm2, %ymm14
|      |      | 1.00 | 1.00 |      |      |      |      |      |      |      | vaddpd    %ymm14, %ymm15, %ymm14
|      |      |      |      |      |      |      |      |      | 1.00 | 1.00 | vmovupd   8(%r15,%r13,8), %xmm15
| 0.33 | 0.33 |      | 0.33 |      |      |      |      |      |      |      | vinsertf128 $1, 24(%r15,%r13,8), %ymm15, %ymm15
| 1.00 | 1.00 |      |      |      |      |      |      |      |      |      | vmulpd    %ymm15, %ymm0, %ymm15
|      |      | 1.00 | 1.00 |      |      |      |      |      |      |      | vaddpd    %ymm15, %ymm14, %ymm14
|      |      |      |      |      |      |      |      |      | 2.00 | 2.00 | vmovupd   %ymm14, 8(%r14,%r13,8)
|      |      |      |      |      | 0.25 | 0.25 | 0.25 | 0.25 |      |      | addq      $4, %r13
|      |      |      |      |      | 0.25 | 0.25 | 0.25 | 0.25 |      |      | cmpq      %rax, %r13
|      |      |      |      |      |      |      |      |      |      |      | jb        ..B1.16
Total number of estimated throughput: 8.32
{%- endcapture -%}
{%- capture hostinfo -%}
...
# Logged in users
################################################################################
 11:10:08 up 102 days, 19:06,  0 users,  load average: 5.36, 2.68, 1.62
...
CPU 0: governor  performance min/cur/max 2.3/2.170/2.3 GHz Turbo 0
CPU 1: governor  performance min/cur/max 2.3/2.131/2.3 GHz Turbo 0
CPU 2: governor  performance min/cur/max 2.3/1.854/2.3 GHz Turbo 0
CPU 3: governor  performance min/cur/max 2.3/1.850/2.3 GHz Turbo 0
...
CPU 6: governor  performance min/cur/max 2.3/1.901/2.3 GHz Turbo 0
CPU 7: governor  performance min/cur/max 2.3/2.095/2.3 GHz Turbo 0
...
CPU 24: governor  performance min/cur/max 2.3/1.982/2.3 GHz Turbo 0
CPU 25: governor  performance min/cur/max 2.3/1.848/2.3 GHz Turbo 0
CPU 26: governor  performance min/cur/max 2.3/1.850/2.3 GHz Turbo 0
CPU 27: governor  performance min/cur/max 2.3/2.179/2.3 GHz Turbo 0
CPU 28: governor  performance min/cur/max 2.3/2.182/2.3 GHz Turbo 0
CPU 29: governor  performance min/cur/max 2.3/2.106/2.3 GHz Turbo 0
CPU 30: governor  performance min/cur/max 2.3/1.965/2.3 GHz Turbo 0
CPU 31: governor  performance min/cur/max 2.3/2.058/2.3 GHz Turbo 0
CPU 32: governor  performance min/cur/max 2.3/2.180/2.3 GHz Turbo 0
CPU 33: governor  performance min/cur/max 2.3/1.848/2.3 GHz Turbo 0
CPU 34: governor  performance min/cur/max 2.3/2.250/2.3 GHz Turbo 0
CPU 35: governor  performance min/cur/max 2.3/2.256/2.3 GHz Turbo 0
CPU 36: governor  performance min/cur/max 2.3/2.250/2.3 GHz Turbo 0
CPU 37: governor  performance min/cur/max 2.3/2.279/2.3 GHz Turbo 0
CPU 38: governor  performance min/cur/max 2.3/2.259/2.3 GHz Turbo 0
CPU 39: governor  performance min/cur/max 2.3/2.090/2.3 GHz Turbo 0
CPU 40: governor  performance min/cur/max 2.3/2.238/2.3 GHz Turbo 0
CPU 41: governor  performance min/cur/max 2.3/2.173/2.3 GHz Turbo 0
CPU 42: governor  performance min/cur/max 2.3/2.150/2.3 GHz Turbo 0
CPU 43: governor  performance min/cur/max 2.3/2.185/2.3 GHz Turbo 0
CPU 44: governor  performance min/cur/max 2.3/2.280/2.3 GHz Turbo 0
CPU 45: governor  performance min/cur/max 2.3/2.286/2.3 GHz Turbo 0
CPU 46: governor  performance min/cur/max 2.3/2.216/2.3 GHz Turbo 0
CPU 47: governor  performance min/cur/max 2.3/1.851/2.3 GHz Turbo 0
...
CPU 51: governor  performance min/cur/max 2.3/1.851/2.3 GHz Turbo 0
CPU 52: governor  performance min/cur/max 2.3/1.847/2.3 GHz Turbo 0
CPU 53: governor  performance min/cur/max 2.3/1.852/2.3 GHz Turbo 0
CPU 54: governor  performance min/cur/max 2.3/1.848/2.3 GHz Turbo 0
CPU 55: governor  performance min/cur/max 2.3/2.143/2.3 GHz Turbo 0
CPU 56: governor  performance min/cur/max 2.3/1.920/2.3 GHz Turbo 0
CPU 57: governor  performance min/cur/max 2.3/1.840/2.3 GHz Turbo 0
CPU 58: governor  performance min/cur/max 2.3/1.839/2.3 GHz Turbo 0
...
CPU 61: governor  performance min/cur/max 2.3/1.844/2.3 GHz Turbo 0
CPU 62: governor  performance min/cur/max 2.3/1.850/2.3 GHz Turbo 0
CPU 63: governor  performance min/cur/max 2.3/2.079/2.3 GHz Turbo 0
...
CPU 71: governor  performance min/cur/max 2.3/1.847/2.3 GHz Turbo 0
CPU 72: governor  performance min/cur/max 2.3/2.244/2.3 GHz Turbo 0
CPU 73: governor  performance min/cur/max 2.3/2.072/2.3 GHz Turbo 0
CPU 74: governor  performance min/cur/max 2.3/2.101/2.3 GHz Turbo 0
CPU 75: governor  performance min/cur/max 2.3/2.052/2.3 GHz Turbo 0
CPU 76: governor  performance min/cur/max 2.3/2.205/2.3 GHz Turbo 0
CPU 77: governor  performance min/cur/max 2.3/2.239/2.3 GHz Turbo 0
CPU 78: governor  performance min/cur/max 2.3/2.257/2.3 GHz Turbo 0
CPU 79: governor  performance min/cur/max 2.3/2.060/2.3 GHz Turbo 0
CPU 80: governor  performance min/cur/max 2.3/2.260/2.3 GHz Turbo 0
CPU 81: governor  performance min/cur/max 2.3/1.850/2.3 GHz Turbo 0
CPU 82: governor  performance min/cur/max 2.3/2.263/2.3 GHz Turbo 0
CPU 83: governor  performance min/cur/max 2.3/2.146/2.3 GHz Turbo 0
CPU 84: governor  performance min/cur/max 2.3/2.220/2.3 GHz Turbo 0
CPU 85: governor  performance min/cur/max 2.3/2.227/2.3 GHz Turbo 0
CPU 86: governor  performance min/cur/max 2.3/2.255/2.3 GHz Turbo 0
CPU 87: governor  performance min/cur/max 2.3/2.156/2.3 GHz Turbo 0
CPU 88: governor  performance min/cur/max 2.3/2.204/2.3 GHz Turbo 0
CPU 89: governor  performance min/cur/max 2.3/2.297/2.3 GHz Turbo 0
CPU 90: governor  performance min/cur/max 2.3/1.921/2.3 GHz Turbo 0
CPU 91: governor  performance min/cur/max 2.3/1.849/2.3 GHz Turbo 0
CPU 92: governor  performance min/cur/max 2.3/1.847/2.3 GHz Turbo 0
CPU 93: governor  performance min/cur/max 2.3/2.068/2.3 GHz Turbo 0
CPU 94: governor  performance min/cur/max 2.3/1.848/2.3 GHz Turbo 0
CPU 95: governor  performance min/cur/max 2.3/1.849/2.3 GHz Turbo 0
...
MemFree:        129564560 kB
MemAvailable:   129537488 kB
Buffers:           34784 kB
Cached:           618516 kB
SwapCached:            0 kB
Active:           544980 kB
Inactive:         158092 kB
Active(anon):      50044 kB
Inactive(anon):     1544 kB
Active(file):     494936 kB
Inactive(file):   156548 kB
Unevictable:           0 kB
Mlocked:               0 kB
...
Shmem:              1820 kB
Slab:            1083032 kB
SReclaimable:     406316 kB
SUnreclaim:       676716 kB
...
OLDPWD=/home/hpc/iwia/iwia84/INSPECT-repo/stencils/3D_r1_homogeneous_star_constant/Zen_EPYC-7451_20190522_101718
...
PWD=/home/hpc/iwia/iwia84/INSPECT-repo/stencils/3D_r1_heterogeneous_star_constant/Zen_EPYC-7451_20190522_111008
