...
title:  "Stencil 3D r1 star constant heterogeneous double SkylakeSP_Gold-6148_SNC"
...
--------------------------
Block Throughput: 7.32 Cycles       Throughput Bottleneck: FrontEnd
Loop Count:  22
Port Binding In Cycles Per Iteration:
--------------------------------------------------------------------------------------------------
|  Port  |   0   -  DV   |   1   |   2   -  D    |   3   -  D    |   4   |   5   |   6   |   7   |
--------------------------------------------------------------------------------------------------
| Cycles |  6.0     0.0  |  6.0  |  4.0     4.0  |  4.0     3.0  |  1.0  |  6.0  |  1.0  |  0.0  |
--------------------------------------------------------------------------------------------------
...
-----------------------------------------------------------------------------------------
|   1      |             |      |             |             |      | 1.0  |      |      | vpcmpgtq k1, ymm9, ymm10
|   1      |             |      |             |             |      | 1.0  |      |      | vpaddq ymm10, ymm10, ymm8
|   2      |             |      | 1.0     1.0 |             |      | 1.0  |      |      | vmovupd ymm17{k1}{z}, ymmword ptr [r10+r15*8+0x10]
|   2      | 1.0         |      |             | 1.0     1.0 |      |      |      |      | vmovupd ymm11{k1}{z}, ymmword ptr [rcx+r15*8+0x8]
|   2      |             | 1.0  | 1.0     1.0 |             |      |      |      |      | vmovupd ymm13{k1}{z}, ymmword ptr [rax+r15*8+0x8]
|   2      |             |      |             | 1.0     1.0 |      | 1.0  |      |      | vmovupd ymm18{k1}{z}, ymmword ptr [r10+r15*8]
|   2      | 1.0         |      | 1.0     1.0 |             |      |      |      |      | vmovupd ymm12{k1}{z}, ymmword ptr [r9+r15*8+0x8]
|   1      |             | 1.0  |             |             |      |      |      |      | vmulpd ymm21, ymm4, ymm17
|   2      |             |      |             | 1.0     1.0 |      | 1.0  |      |      | vmovupd ymm14{k1}{z}, ymmword ptr [rdx+r15*8+0x8]
|   1      | 1.0         |      |             |             |      |      |      |      | vmulpd ymm15, ymm1, ymm11
|   1      |             | 1.0  |             |             |      |      |      |      | vmulpd ymm16, ymm0, ymm13
|   2      |             |      | 1.0     1.0 |             |      | 1.0  |      |      | vmovupd ymm19{k1}{z}, ymmword ptr [r10+r15*8+0x8]
|   1      | 1.0         |      |             |             |      |      |      |      | vfmadd231pd ymm21, ymm18, ymm5
|   1      |             | 1.0  |             |             |      |      |      |      | vfmadd231pd ymm15, ymm12, ymm3
|   1      | 1.0         |      |             |             |      |      |      |      | vfmadd231pd ymm16, ymm14, ymm2
|   1      |             | 1.0  |             |             |      |      |      |      | vfmadd231pd ymm21, ymm19, ymm6
|   1      | 1.0         |      |             |             |      |      |      |      | vaddpd ymm20, ymm15, ymm16
|   1      |             | 1.0  |             |             |      |      |      |      | vaddpd ymm22, ymm20, ymm21
|   2      |             |      |             | 1.0         | 1.0  |      |      |      | vmovupd ymmword ptr [r13+r15*8+0x8]{k1}, ymm22
|   1      |             |      |             |             |      |      | 1.0  |      | add r15, 0x4
|   1*     |             |      |             |             |      |      |      |      | cmp r15, r14
|   0*F    |             |      |             |             |      |      |      |      | jb 0xffffffffffffff66
...
# Logged in users
################################################################################
 19:14:32 up 10 days,  5:08,  0 users,  load average: 0.50, 0.77, 0.89
...
CPU 0: governor  performance min/cur/max 2.4/1.199/2.4 GHz Turbo 0
CPU 1: governor  performance min/cur/max 2.4/1.189/2.4 GHz Turbo 0
CPU 2: governor  performance min/cur/max 2.4/2.182/2.4 GHz Turbo 0
CPU 5: governor  performance min/cur/max 2.4/1.805/2.4 GHz Turbo 0
CPU 6: governor  performance min/cur/max 2.4/1.881/2.4 GHz Turbo 0
CPU 10: governor  performance min/cur/max 2.4/2.259/2.4 GHz Turbo 0
CPU 11: governor  performance min/cur/max 2.4/1.782/2.4 GHz Turbo 0
CPU 12: governor  performance min/cur/max 2.4/1.592/2.4 GHz Turbo 0
CPU 15: governor  performance min/cur/max 2.4/1.948/2.4 GHz Turbo 0
CPU 16: governor  performance min/cur/max 2.4/1.564/2.4 GHz Turbo 0
CPU 3: governor  performance min/cur/max 2.4/1.582/2.4 GHz Turbo 0
CPU 4: governor  performance min/cur/max 2.4/2.4/2.4 GHz Turbo 0
CPU 7: governor  performance min/cur/max 2.4/2.402/2.4 GHz Turbo 0
CPU 8: governor  performance min/cur/max 2.4/2.400/2.4 GHz Turbo 0
CPU 9: governor  performance min/cur/max 2.4/2.400/2.4 GHz Turbo 0
CPU 13: governor  performance min/cur/max 2.4/2.402/2.4 GHz Turbo 0
CPU 14: governor  performance min/cur/max 2.4/1.899/2.4 GHz Turbo 0
CPU 17: governor  performance min/cur/max 2.4/1.768/2.4 GHz Turbo 0
CPU 18: governor  performance min/cur/max 2.4/2.137/2.4 GHz Turbo 0
CPU 19: governor  performance min/cur/max 2.4/1.544/2.4 GHz Turbo 0
CPU 20: governor  performance min/cur/max 2.4/1.839/2.4 GHz Turbo 0
CPU 21: governor  performance min/cur/max 2.4/2.202/2.4 GHz Turbo 0
CPU 22: governor  performance min/cur/max 2.4/1.901/2.4 GHz Turbo 0
CPU 25: governor  performance min/cur/max 2.4/1.716/2.4 GHz Turbo 0
CPU 26: governor  performance min/cur/max 2.4/2.098/2.4 GHz Turbo 0
CPU 30: governor  performance min/cur/max 2.4/2.281/2.4 GHz Turbo 0
CPU 31: governor  performance min/cur/max 2.4/2.268/2.4 GHz Turbo 0
CPU 32: governor  performance min/cur/max 2.4/2.161/2.4 GHz Turbo 0
CPU 35: governor  performance min/cur/max 2.4/2.140/2.4 GHz Turbo 0
CPU 36: governor  performance min/cur/max 2.4/2.000/2.4 GHz Turbo 0
CPU 23: governor  performance min/cur/max 2.4/1.469/2.4 GHz Turbo 0
CPU 24: governor  performance min/cur/max 2.4/2.331/2.4 GHz Turbo 0
CPU 27: governor  performance min/cur/max 2.4/1.693/2.4 GHz Turbo 0
CPU 28: governor  performance min/cur/max 2.4/2.077/2.4 GHz Turbo 0
CPU 29: governor  performance min/cur/max 2.4/1.938/2.4 GHz Turbo 0
CPU 33: governor  performance min/cur/max 2.4/2.401/2.4 GHz Turbo 0
CPU 34: governor  performance min/cur/max 2.4/1.361/2.4 GHz Turbo 0
CPU 37: governor  performance min/cur/max 2.4/1.726/2.4 GHz Turbo 0
CPU 38: governor  performance min/cur/max 2.4/2.113/2.4 GHz Turbo 0
CPU 39: governor  performance min/cur/max 2.4/1.835/2.4 GHz Turbo 0
CPU 40: governor  performance min/cur/max 2.4/1.909/2.4 GHz Turbo 0
CPU 41: governor  performance min/cur/max 2.4/1.504/2.4 GHz Turbo 0
CPU 42: governor  performance min/cur/max 2.4/1.542/2.4 GHz Turbo 0
CPU 45: governor  performance min/cur/max 2.4/1.971/2.4 GHz Turbo 0
CPU 46: governor  performance min/cur/max 2.4/1.845/2.4 GHz Turbo 0
CPU 50: governor  performance min/cur/max 2.4/1.914/2.4 GHz Turbo 0
CPU 51: governor  performance min/cur/max 2.4/1.876/2.4 GHz Turbo 0
CPU 52: governor  performance min/cur/max 2.4/2.181/2.4 GHz Turbo 0
CPU 55: governor  performance min/cur/max 2.4/1.840/2.4 GHz Turbo 0
CPU 56: governor  performance min/cur/max 2.4/1.311/2.4 GHz Turbo 0
CPU 43: governor  performance min/cur/max 2.4/2.136/2.4 GHz Turbo 0
CPU 44: governor  performance min/cur/max 2.4/2.254/2.4 GHz Turbo 0
CPU 47: governor  performance min/cur/max 2.4/1.996/2.4 GHz Turbo 0
CPU 48: governor  performance min/cur/max 2.4/1.858/2.4 GHz Turbo 0
CPU 49: governor  performance min/cur/max 2.4/2.400/2.4 GHz Turbo 0
CPU 53: governor  performance min/cur/max 2.4/2.115/2.4 GHz Turbo 0
CPU 54: governor  performance min/cur/max 2.4/1.754/2.4 GHz Turbo 0
CPU 57: governor  performance min/cur/max 2.4/1.927/2.4 GHz Turbo 0
CPU 58: governor  performance min/cur/max 2.4/1.315/2.4 GHz Turbo 0
CPU 59: governor  performance min/cur/max 2.4/2.012/2.4 GHz Turbo 0
CPU 60: governor  performance min/cur/max 2.4/1.924/2.4 GHz Turbo 0
CPU 61: governor  performance min/cur/max 2.4/1.430/2.4 GHz Turbo 0
CPU 62: governor  performance min/cur/max 2.4/2.019/2.4 GHz Turbo 0
CPU 65: governor  performance min/cur/max 2.4/2.068/2.4 GHz Turbo 0
CPU 66: governor  performance min/cur/max 2.4/1.560/2.4 GHz Turbo 0
CPU 70: governor  performance min/cur/max 2.4/1.526/2.4 GHz Turbo 0
CPU 71: governor  performance min/cur/max 2.4/1.761/2.4 GHz Turbo 0
CPU 72: governor  performance min/cur/max 2.4/2.351/2.4 GHz Turbo 0
CPU 75: governor  performance min/cur/max 2.4/2.103/2.4 GHz Turbo 0
CPU 76: governor  performance min/cur/max 2.4/2.288/2.4 GHz Turbo 0
CPU 63: governor  performance min/cur/max 2.4/2.017/2.4 GHz Turbo 0
CPU 64: governor  performance min/cur/max 2.4/2.206/2.4 GHz Turbo 0
CPU 67: governor  performance min/cur/max 2.4/2.124/2.4 GHz Turbo 0
CPU 68: governor  performance min/cur/max 2.4/1.723/2.4 GHz Turbo 0
CPU 69: governor  performance min/cur/max 2.4/1.672/2.4 GHz Turbo 0
CPU 73: governor  performance min/cur/max 2.4/2.118/2.4 GHz Turbo 0
CPU 74: governor  performance min/cur/max 2.4/2.033/2.4 GHz Turbo 0
CPU 77: governor  performance min/cur/max 2.4/1.879/2.4 GHz Turbo 0
CPU 78: governor  performance min/cur/max 2.4/2.174/2.4 GHz Turbo 0
CPU 79: governor  performance min/cur/max 2.4/1.373/2.4 GHz Turbo 0
...
MemFree:        95697144 kB
MemAvailable:   95672140 kB
Buffers:           27536 kB
Cached:           493188 kB
SwapCached:           56 kB
Active:           403792 kB
Inactive:         153792 kB
Active(anon):      31100 kB
Inactive(anon):     7400 kB
Active(file):     372692 kB
Inactive(file):   146392 kB
Unevictable:           0 kB
Mlocked:               0 kB
SwapTotal:      49632252 kB
SwapFree:       49630972 kB
Dirty:               444 kB
Writeback:             0 kB
AnonPages:         36808 kB
Mapped:            52940 kB
Shmem:              1640 kB
Slab:             662448 kB
SReclaimable:     238768 kB
SUnreclaim:       423680 kB
...
OLDPWD=/home/hpc/iwia/iwia84/INSPECT-repo/stencils/3D_r1_isotropic_star_constant/SkylakeSP_Gold-6148_SNC_20190416_151447
...
PWD=/home/hpc/iwia/iwia84/INSPECT-repo/stencils/3D_r1_heterogeneous_star_constant/SkylakeSP_Gold-6148_SNC_20190416_191431
