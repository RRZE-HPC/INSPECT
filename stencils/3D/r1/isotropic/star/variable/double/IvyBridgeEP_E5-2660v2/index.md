...
L2: P <= 16387/4
L3: P <= 1638403/4
L1: 32*N*P + 16*P*(N - 1) - 16*P <= 32768
L2: 32*N*P + 16*P*(N - 1) - 16*P <= 262144
L3: 32*N*P + 16*P*(N - 1) - 16*P <= 26214400
{%- endcapture -%}
{%- capture iaca -%}
...
|   2    |           | 1.0 | 0.5   0.5 | 0.5   0.5 |     |     | CP | vaddpd xmm0, xmm15, xmmword ptr [r9+r15*8+0x38]
