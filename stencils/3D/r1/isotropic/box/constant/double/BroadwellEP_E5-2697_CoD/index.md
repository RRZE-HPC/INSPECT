...
title:  "Stencil 3D r1 box constant isotropic double BroadwellEP_E5-2697_CoD"
...
vmovupd ymm12, ymmword ptr [r10+r9*8]
vmovupd ymm9, ymmword ptr [r14+r9*8+0x10]
vmovupd ymm8, ymmword ptr [r12+r9*8+0x10]
vmovupd ymm4, ymmword ptr [r12+r9*8]
vmovupd ymm0, ymmword ptr [r14+r9*8]
vmovupd ymm14, ymmword ptr [r15+r9*8+0x8]
vaddpd ymm13, ymm12, ymmword ptr [r14+r9*8+0x8]
vaddpd ymm9, ymm9, ymmword ptr [r13+r9*8+0x10]
vaddpd ymm8, ymm8, ymmword ptr [r11+r9*8+0x10]
vaddpd ymm15, ymm13, ymmword ptr [r13+r9*8+0x8]
vaddpd ymm0, ymm0, ymmword ptr [r13+r9*8]
vaddpd ymm9, ymm9, ymm8
vaddpd ymm12, ymm15, ymmword ptr [r12+r9*8+0x8]
vaddpd ymm4, ymm4, ymmword ptr [r11+r9*8]
vaddpd ymm14, ymm14, ymmword ptr [rsi+r9*8+0x8]
vaddpd ymm13, ymm12, ymmword ptr [r11+r9*8+0x8]
vaddpd ymm0, ymm0, ymm4
vmovupd ymm8, ymmword ptr [rdi+r9*8+0x8]
vmovupd ymm4, ymmword ptr [rdi+r9*8+0x10]
vaddpd ymm15, ymm13, ymmword ptr [r10+r9*8+0x10]
vaddpd ymm8, ymm8, ymmword ptr [r8+r9*8+0x8]
vaddpd ymm4, ymm4, ymmword ptr [r8+r9*8+0x10]
vmulpd ymm12, ymm6, ymm15
vmovupd ymm13, ymmword ptr [r15+r9*8+0x10]
vmovupd ymm15, ymmword ptr [r15+r9*8]
vaddpd ymm14, ymm14, ymm8
vaddpd ymm13, ymm13, ymmword ptr [rsi+r9*8+0x10]
vmovupd ymm8, ymmword ptr [rdi+r9*8]
vfmadd231pd ymm12, ymm11, ymmword ptr [r10+r9*8+0x8]
vaddpd ymm0, ymm0, ymm14
vaddpd ymm8, ymm8, ymmword ptr [r8+r9*8]
vaddpd ymm14, ymm13, ymm4
vaddpd ymm9, ymm0, ymm9
vaddpd ymm0, ymm15, ymmword ptr [rsi+r9*8]
vfmadd231pd ymm12, ymm9, ymm7
vaddpd ymm9, ymm0, ymm8
vaddpd ymm15, ymm9, ymm14
vfmadd231pd ymm12, ymm15, ymm5
vmovupd ymmword ptr [rax+r9*8+0x8], ymm12
add r9, 0x4
cmp r9, rdx
jb 0xffffffffffffff08
{%- endcapture -%}
...
--------------------------------------------------------------------------------------------------
| Cycles |  4.0     0.0  | 23.0  | 14.0    14.0  | 14.0    13.0  |  1.0  |  0.5  |  0.5  |  0.0  |
--------------------------------------------------------------------------------------------------
...
-----------------------------------------------------------------------------------------
|   1      |             |      | 1.0     1.0 |             |      |      |      |      | vmovupd ymm12, ymmword ptr [r10+r9*8]
|   1      |             |      |             | 1.0     1.0 |      |      |      |      | vmovupd ymm9, ymmword ptr [r14+r9*8+0x10]
|   1      |             |      | 1.0     1.0 |             |      |      |      |      | vmovupd ymm8, ymmword ptr [r12+r9*8+0x10]
|   1      |             |      |             | 1.0     1.0 |      |      |      |      | vmovupd ymm4, ymmword ptr [r12+r9*8]
|   1      |             |      | 1.0     1.0 |             |      |      |      |      | vmovupd ymm0, ymmword ptr [r14+r9*8]
|   1      |             |      |             | 1.0     1.0 |      |      |      |      | vmovupd ymm14, ymmword ptr [r15+r9*8+0x8]
|   2      |             | 1.0  | 1.0     1.0 |             |      |      |      |      | vaddpd ymm13, ymm12, ymmword ptr [r14+r9*8+0x8]
|   2      |             | 1.0  |             | 1.0     1.0 |      |      |      |      | vaddpd ymm9, ymm9, ymmword ptr [r13+r9*8+0x10]
|   2      |             | 1.0  | 1.0     1.0 |             |      |      |      |      | vaddpd ymm8, ymm8, ymmword ptr [r11+r9*8+0x10]
|   2      |             | 1.0  |             | 1.0     1.0 |      |      |      |      | vaddpd ymm15, ymm13, ymmword ptr [r13+r9*8+0x8]
|   2      |             | 1.0  | 1.0     1.0 |             |      |      |      |      | vaddpd ymm0, ymm0, ymmword ptr [r13+r9*8]
|   1      |             | 1.0  |             |             |      |      |      |      | vaddpd ymm9, ymm9, ymm8
|   2      |             | 1.0  |             | 1.0     1.0 |      |      |      |      | vaddpd ymm12, ymm15, ymmword ptr [r12+r9*8+0x8]
|   2      |             | 1.0  | 1.0     1.0 |             |      |      |      |      | vaddpd ymm4, ymm4, ymmword ptr [r11+r9*8]
|   2      |             | 1.0  |             | 1.0     1.0 |      |      |      |      | vaddpd ymm14, ymm14, ymmword ptr [rsi+r9*8+0x8]
|   2      |             | 1.0  | 1.0     1.0 |             |      |      |      |      | vaddpd ymm13, ymm12, ymmword ptr [r11+r9*8+0x8]
|   1      |             | 1.0  |             |             |      |      |      |      | vaddpd ymm0, ymm0, ymm4
|   1      |             |      |             | 1.0     1.0 |      |      |      |      | vmovupd ymm8, ymmword ptr [rdi+r9*8+0x8]
|   1      |             |      | 1.0     1.0 |             |      |      |      |      | vmovupd ymm4, ymmword ptr [rdi+r9*8+0x10]
|   2      |             | 1.0  |             | 1.0     1.0 |      |      |      |      | vaddpd ymm15, ymm13, ymmword ptr [r10+r9*8+0x10]
|   2      |             | 1.0  | 1.0     1.0 |             |      |      |      |      | vaddpd ymm8, ymm8, ymmword ptr [r8+r9*8+0x8]
|   2      |             | 1.0  |             | 1.0     1.0 |      |      |      |      | vaddpd ymm4, ymm4, ymmword ptr [r8+r9*8+0x10]
|   1      | 1.0         |      |             |             |      |      |      |      | vmulpd ymm12, ymm6, ymm15
|   1      |             |      | 1.0     1.0 |             |      |      |      |      | vmovupd ymm13, ymmword ptr [r15+r9*8+0x10]
|   1      |             |      |             | 1.0     1.0 |      |      |      |      | vmovupd ymm15, ymmword ptr [r15+r9*8]
|   1      |             | 1.0  |             |             |      |      |      |      | vaddpd ymm14, ymm14, ymm8
|   2      |             | 1.0  | 1.0     1.0 |             |      |      |      |      | vaddpd ymm13, ymm13, ymmword ptr [rsi+r9*8+0x10]
|   1      |             |      |             | 1.0     1.0 |      |      |      |      | vmovupd ymm8, ymmword ptr [rdi+r9*8]
|   2      | 1.0         |      | 1.0     1.0 |             |      |      |      |      | vfmadd231pd ymm12, ymm11, ymmword ptr [r10+r9*8+0x8]
|   1      |             | 1.0  |             |             |      |      |      |      | vaddpd ymm0, ymm0, ymm14
|   2      |             | 1.0  |             | 1.0     1.0 |      |      |      |      | vaddpd ymm8, ymm8, ymmword ptr [r8+r9*8]
|   1      |             | 1.0  |             |             |      |      |      |      | vaddpd ymm14, ymm13, ymm4
|   1      |             | 1.0  |             |             |      |      |      |      | vaddpd ymm9, ymm0, ymm9
|   2      |             | 1.0  | 1.0     1.0 |             |      |      |      |      | vaddpd ymm0, ymm15, ymmword ptr [rsi+r9*8]
|   1      | 1.0         |      |             |             |      |      |      |      | vfmadd231pd ymm12, ymm9, ymm7
|   1      |             | 1.0  |             |             |      |      |      |      | vaddpd ymm9, ymm0, ymm8
|   1      |             | 1.0  |             |             |      |      |      |      | vaddpd ymm15, ymm9, ymm14
|   1      | 1.0         |      |             |             |      |      |      |      | vfmadd231pd ymm12, ymm15, ymm5
|   2      |             |      |             | 1.0         | 1.0  |      |      |      | vmovupd ymmword ptr [rax+r9*8+0x8], ymm12
|   1      |             |      |             |             |      | 0.5  | 0.5  |      | add r9, 0x4
|   1*     |             |      |             |             |      |      |      |      | cmp r9, rdx
...
# Logged in users
################################################################################
 10:05:45 up 7 days, 19 min,  0 users,  load average: 0.35, 0.08, 0.03
...
CPU 0: governor  performance min/cur/max 2.3/1.609/2.3 GHz Turbo 0
CPU 1: governor  performance min/cur/max 2.3/1.357/2.3 GHz Turbo 0
CPU 2: governor  performance min/cur/max 2.3/2.287/2.3 GHz Turbo 0
CPU 3: governor  performance min/cur/max 2.3/2.139/2.3 GHz Turbo 0
CPU 4: governor  performance min/cur/max 2.3/2.238/2.3 GHz Turbo 0
CPU 5: governor  performance min/cur/max 2.3/2.264/2.3 GHz Turbo 0
CPU 6: governor  performance min/cur/max 2.3/1.493/2.3 GHz Turbo 0
CPU 7: governor  performance min/cur/max 2.3/1.667/2.3 GHz Turbo 0
CPU 8: governor  performance min/cur/max 2.3/1.873/2.3 GHz Turbo 0
CPU 9: governor  performance min/cur/max 2.3/2.124/2.3 GHz Turbo 0
CPU 10: governor  performance min/cur/max 2.3/2.127/2.3 GHz Turbo 0
CPU 11: governor  performance min/cur/max 2.3/2.267/2.3 GHz Turbo 0
CPU 12: governor  performance min/cur/max 2.3/2.282/2.3 GHz Turbo 0
CPU 13: governor  performance min/cur/max 2.3/2.250/2.3 GHz Turbo 0
CPU 14: governor  performance min/cur/max 2.3/1.991/2.3 GHz Turbo 0
CPU 15: governor  performance min/cur/max 2.3/1.991/2.3 GHz Turbo 0
CPU 16: governor  performance min/cur/max 2.3/1.959/2.3 GHz Turbo 0
CPU 17: governor  performance min/cur/max 2.3/1.926/2.3 GHz Turbo 0
CPU 18: governor  performance min/cur/max 2.3/2.290/2.3 GHz Turbo 0
CPU 19: governor  performance min/cur/max 2.3/2.280/2.3 GHz Turbo 0
CPU 20: governor  performance min/cur/max 2.3/2.255/2.3 GHz Turbo 0
CPU 21: governor  performance min/cur/max 2.3/2.280/2.3 GHz Turbo 0
CPU 22: governor  performance min/cur/max 2.3/1.719/2.3 GHz Turbo 0
CPU 23: governor  performance min/cur/max 2.3/2.210/2.3 GHz Turbo 0
CPU 24: governor  performance min/cur/max 2.3/2.292/2.3 GHz Turbo 0
CPU 25: governor  performance min/cur/max 2.3/2.278/2.3 GHz Turbo 0
...
CPU 28: governor  performance min/cur/max 2.3/2.117/2.3 GHz Turbo 0
CPU 29: governor  performance min/cur/max 2.3/2.297/2.3 GHz Turbo 0
CPU 30: governor  performance min/cur/max 2.3/2.278/2.3 GHz Turbo 0
CPU 31: governor  performance min/cur/max 2.3/2.283/2.3 GHz Turbo 0
CPU 32: governor  performance min/cur/max 2.3/2.166/2.3 GHz Turbo 0
CPU 33: governor  performance min/cur/max 2.3/2.294/2.3 GHz Turbo 0
CPU 34: governor  performance min/cur/max 2.3/2.296/2.3 GHz Turbo 0
CPU 35: governor  performance min/cur/max 2.3/2.290/2.3 GHz Turbo 0
CPU 36: governor  performance min/cur/max 2.3/1.791/2.3 GHz Turbo 0
CPU 37: governor  performance min/cur/max 2.3/2.071/2.3 GHz Turbo 0
CPU 38: governor  performance min/cur/max 2.3/1.666/2.3 GHz Turbo 0
CPU 39: governor  performance min/cur/max 2.3/1.955/2.3 GHz Turbo 0
CPU 40: governor  performance min/cur/max 2.3/1.239/2.3 GHz Turbo 0
CPU 41: governor  performance min/cur/max 2.3/1.921/2.3 GHz Turbo 0
CPU 42: governor  performance min/cur/max 2.3/1.462/2.3 GHz Turbo 0
CPU 43: governor  performance min/cur/max 2.3/2.298/2.3 GHz Turbo 0
CPU 44: governor  performance min/cur/max 2.3/2.279/2.3 GHz Turbo 0
CPU 45: governor  performance min/cur/max 2.3/1.251/2.3 GHz Turbo 0
CPU 46: governor  performance min/cur/max 2.3/1.880/2.3 GHz Turbo 0
CPU 47: governor  performance min/cur/max 2.3/1.497/2.3 GHz Turbo 0
CPU 48: governor  performance min/cur/max 2.3/1.543/2.3 GHz Turbo 0
CPU 49: governor  performance min/cur/max 2.3/2.264/2.3 GHz Turbo 0
CPU 50: governor  performance min/cur/max 2.3/1.630/2.3 GHz Turbo 0
CPU 51: governor  performance min/cur/max 2.3/2.219/2.3 GHz Turbo 0
CPU 52: governor  performance min/cur/max 2.3/2.035/2.3 GHz Turbo 0
CPU 53: governor  performance min/cur/max 2.3/1.509/2.3 GHz Turbo 0
CPU 54: governor  performance min/cur/max 2.3/2.296/2.3 GHz Turbo 0
CPU 55: governor  performance min/cur/max 2.3/2.277/2.3 GHz Turbo 0
CPU 56: governor  performance min/cur/max 2.3/2.297/2.3 GHz Turbo 0
CPU 57: governor  performance min/cur/max 2.3/2.251/2.3 GHz Turbo 0
CPU 58: governor  performance min/cur/max 2.3/2.265/2.3 GHz Turbo 0
CPU 59: governor  performance min/cur/max 2.3/2.296/2.3 GHz Turbo 0
...
CPU 62: governor  performance min/cur/max 2.3/2.292/2.3 GHz Turbo 0
CPU 63: governor  performance min/cur/max 2.3/2.297/2.3 GHz Turbo 0
CPU 64: governor  performance min/cur/max 2.3/2.282/2.3 GHz Turbo 0
CPU 65: governor  performance min/cur/max 2.3/2.267/2.3 GHz Turbo 0
CPU 66: governor  performance min/cur/max 2.3/2.283/2.3 GHz Turbo 0
CPU 67: governor  performance min/cur/max 2.3/2.232/2.3 GHz Turbo 0
CPU 68: governor  performance min/cur/max 2.3/2.246/2.3 GHz Turbo 0
CPU 69: governor  performance min/cur/max 2.3/2.284/2.3 GHz Turbo 0
CPU 70: governor  performance min/cur/max 2.3/2.271/2.3 GHz Turbo 0
CPU 71: governor  performance min/cur/max 2.3/2.293/2.3 GHz Turbo 0
...
MemFree:        129715128 kB
MemAvailable:   129823324 kB
Buffers:          137664 kB
Cached:           665784 kB
SwapCached:            0 kB
Active:           484868 kB
Inactive:         362496 kB
Active(anon):      44268 kB
Inactive(anon):     1624 kB
Active(file):     440600 kB
Inactive(file):   360872 kB
Unevictable:           0 kB
Mlocked:               0 kB
...
Shmem:              1916 kB
Slab:             544784 kB
SReclaimable:     218356 kB
SUnreclaim:       326428 kB
...
DirectMap4k:      590592 kB
DirectMap2M:    11864064 kB
...
PWD=/home/hpc/iwia/iwia84/INSPECT-repo/stencils/3D_r1_isotropic_box_constant/BroadwellEP_E5-2697_CoD_20190503_100545
