...
L1: unconditionally fulfilled L2: unconditionally fulfilled L3: unconditionally fulfilled L1: P <= 4096/11 L2: P <= 32768/11 L3: P <= 3276800/11 L1: 40*N*P + 16*P*(N - 2) + 32*P <= 32768 L2: 40*N*P + 16*P*(N - 2) + 32*P <= 262144 L3: 40*N*P + 16*P*(N - 2) + 32*P <= 26214400
{%- endcapture -%}
{%- capture iaca -%}
