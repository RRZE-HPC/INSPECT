...
--------------------------------------------------------------------------------------------------
| Cycles |  1.0     0.0  | 12.0  |  7.5     7.0  |  7.5     7.0  |  1.0  |  0.5  |  0.5  |  0.0  |
--------------------------------------------------------------------------------------------------
...
-----------------------------------------------------------------------------------------
|   1      |             |      | 0.5     0.5 | 0.5     0.5 |      |      |      |      | vmovupd ymm1, ymmword ptr [rax+r8*8+0x18]
|   1      |             |      | 0.5     0.5 | 0.5     0.5 |      |      |      |      | vmovupd ymm0, ymmword ptr [rax+r8*8+0x10]
|   1      |             |      | 0.5     0.5 | 0.5     0.5 |      |      |      |      | vmovupd ymm10, ymmword ptr [rax+r8*8+0x20]
|   1      |             |      | 0.5     0.5 | 0.5     0.5 |      |      |      |      | vmovupd ymm4, ymmword ptr [r13+r8*8+0x10]
|   1      |             |      | 0.5     0.5 | 0.5     0.5 |      |      |      |      | vmovupd ymm5, ymmword ptr [r11+r8*8+0x10]
|   1      |             |      | 0.5     0.5 | 0.5     0.5 |      |      |      |      | vmovupd ymm11, ymmword ptr [r9+r8*8+0x10]
|   2      |             | 1.0  | 0.5     0.5 | 0.5     0.5 |      |      |      |      | vaddpd ymm2, ymm0, ymmword ptr [rax+r8*8+0x8]
|   2      |             | 1.0  | 0.5     0.5 | 0.5     0.5 |      |      |      |      | vaddpd ymm7, ymm5, ymmword ptr [rax+r8*8]
|   2      |             | 1.0  | 0.5     0.5 | 0.5     0.5 |      |      |      |      | vaddpd ymm3, ymm1, ymmword ptr [r14+r8*8+0x10]
|   2      |             | 1.0  | 0.5     0.5 | 0.5     0.5 |      |      |      |      | vaddpd ymm6, ymm4, ymmword ptr [r12+r8*8+0x10]
|   2      |             | 1.0  | 0.5     0.5 | 0.5     0.5 |      |      |      |      | vaddpd ymm12, ymm10, ymmword ptr [r15+r8*8+0x10]
|   2      |             | 1.0  | 0.5     0.5 | 0.5     0.5 |      |      |      |      | vaddpd ymm13, ymm11, ymmword ptr [rbx+r8*8+0x10]
|   1      |             | 1.0  |             |             |      |      |      |      | vaddpd ymm8, ymm2, ymm3
|   1      |             | 1.0  |             |             |      |      |      |      | vaddpd ymm9, ymm6, ymm7
|   1      |             | 1.0  |             |             |      |      |      |      | vaddpd ymm14, ymm12, ymm13
|   1      |             | 1.0  |             |             |      |      |      |      | vaddpd ymm15, ymm8, ymm9
|   2      |             | 1.0  | 0.5     0.5 | 0.5     0.5 |      |      |      |      | vaddpd ymm0, ymm14, ymmword ptr [rsi+r8*8+0x10]
|   1      |             | 1.0  |             |             |      |      |      |      | vaddpd ymm1, ymm15, ymm0
|   2      | 1.0         |      | 0.5     0.5 | 0.5     0.5 |      |      |      |      | vmulpd ymm2, ymm1, ymmword ptr [r10+r8*8+0x10]
|   2      |             |      | 0.5         | 0.5         | 1.0  |      |      |      | vmovupd ymmword ptr [rdi+r8*8+0x10], ymm2
|   1      |             |      |             |             |      | 0.5  | 0.5  |      | add r8, 0x4
|   1*     |             |      |             |             |      |      |      |      | cmp r8, rdx
|   0*F    |             |      |             |             |      |      |      |      | jb 0xffffffffffffff7b
...
# Logged in users
################################################################################
 06:59:22 up 27 days, 18:03,  0 users,  load average: 0.61, 0.84, 1.01
...
CPU 0: governor  performance min/cur/max 2.3/1.705/2.3 GHz Turbo 0
CPU 1: governor  performance min/cur/max 2.3/1.352/2.3 GHz Turbo 0
CPU 2: governor  performance min/cur/max 2.3/1.376/2.3 GHz Turbo 0
CPU 3: governor  performance min/cur/max 2.3/2.301/2.3 GHz Turbo 0
CPU 4: governor  performance min/cur/max 2.3/1.722/2.3 GHz Turbo 0
CPU 5: governor  performance min/cur/max 2.3/1.437/2.3 GHz Turbo 0
CPU 6: governor  performance min/cur/max 2.3/1.676/2.3 GHz Turbo 0
CPU 7: governor  performance min/cur/max 2.3/1.496/2.3 GHz Turbo 0
CPU 8: governor  performance min/cur/max 2.3/1.656/2.3 GHz Turbo 0
CPU 9: governor  performance min/cur/max 2.3/1.696/2.3 GHz Turbo 0
CPU 10: governor  performance min/cur/max 2.3/1.453/2.3 GHz Turbo 0
CPU 11: governor  performance min/cur/max 2.3/1.433/2.3 GHz Turbo 0
CPU 12: governor  performance min/cur/max 2.3/2.301/2.3 GHz Turbo 0
CPU 13: governor  performance min/cur/max 2.3/1.495/2.3 GHz Turbo 0
CPU 14: governor  performance min/cur/max 2.3/2.251/2.3 GHz Turbo 0
CPU 15: governor  performance min/cur/max 2.3/2.253/2.3 GHz Turbo 0
...
CPU 28: governor  performance min/cur/max 2.3/1.580/2.3 GHz Turbo 0
CPU 29: governor  performance min/cur/max 2.3/1.942/2.3 GHz Turbo 0
CPU 30: governor  performance min/cur/max 2.3/1.755/2.3 GHz Turbo 0
CPU 31: governor  performance min/cur/max 2.3/1.524/2.3 GHz Turbo 0
CPU 32: governor  performance min/cur/max 2.3/1.259/2.3 GHz Turbo 0
CPU 33: governor  performance min/cur/max 2.3/1.741/2.3 GHz Turbo 0
CPU 34: governor  performance min/cur/max 2.3/1.424/2.3 GHz Turbo 0
CPU 35: governor  performance min/cur/max 2.3/1.527/2.3 GHz Turbo 0
CPU 36: governor  performance min/cur/max 2.3/1.745/2.3 GHz Turbo 0
CPU 37: governor  performance min/cur/max 2.3/1.693/2.3 GHz Turbo 0
CPU 38: governor  performance min/cur/max 2.3/1.745/2.3 GHz Turbo 0
CPU 39: governor  performance min/cur/max 2.3/1.659/2.3 GHz Turbo 0
CPU 40: governor  performance min/cur/max 2.3/1.603/2.3 GHz Turbo 0
CPU 41: governor  performance min/cur/max 2.3/1.781/2.3 GHz Turbo 0
...
CPU 45: governor  performance min/cur/max 2.3/2.277/2.3 GHz Turbo 0
CPU 46: governor  performance min/cur/max 2.3/2.241/2.3 GHz Turbo 0
CPU 47: governor  performance min/cur/max 2.3/2.288/2.3 GHz Turbo 0
CPU 48: governor  performance min/cur/max 2.3/2.225/2.3 GHz Turbo 0
CPU 49: governor  performance min/cur/max 2.3/2.242/2.3 GHz Turbo 0
CPU 50: governor  performance min/cur/max 2.3/2.279/2.3 GHz Turbo 0
CPU 51: governor  performance min/cur/max 2.3/2.285/2.3 GHz Turbo 0
CPU 52: governor  performance min/cur/max 2.3/2.213/2.3 GHz Turbo 0
CPU 53: governor  performance min/cur/max 2.3/2.232/2.3 GHz Turbo 0
CPU 54: governor  performance min/cur/max 2.3/2.264/2.3 GHz Turbo 0
...
MemFree:        64033048 kB
MemAvailable:   64488120 kB
Buffers:          126456 kB
Cached:           743764 kB
SwapCached:           40 kB
Active:           625808 kB
Inactive:         291340 kB
Active(anon):      44188 kB
Inactive(anon):    10896 kB
Active(file):     581620 kB
Inactive(file):   280444 kB
Unevictable:           0 kB
Mlocked:               0 kB
...
Shmem:              8152 kB
Slab:             560792 kB
SReclaimable:     265744 kB
SUnreclaim:       295048 kB
...
OLDPWD=/home/hpc/iwia/iwia84/INSPECT-repo/stencils/3D_r2_heterogeneous_star_variable/HaswellEP_E5-2695v3_CoD_20190424_052200
...
PWD=/home/hpc/iwia/iwia84/INSPECT-repo/stencils/3D_r2_homogeneous_star_variable/HaswellEP_E5-2695v3_CoD_20190424_065922
