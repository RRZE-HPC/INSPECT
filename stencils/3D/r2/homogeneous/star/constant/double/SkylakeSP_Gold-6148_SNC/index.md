...
title:  "Stencil 3D r2 star constant homogeneous double SkylakeSP_Gold-6148_SNC"
...
--------------------------
Block Throughput: 11.68 Cycles       Throughput Bottleneck: Backend
Loop Count:  22
Port Binding In Cycles Per Iteration:
--------------------------------------------------------------------------------------------------
|  Port  |   0   -  DV   |   1   |   2   -  D    |   3   -  D    |   4   |   5   |   6   |   7   |
--------------------------------------------------------------------------------------------------
| Cycles |  9.3     0.0  |  9.4  |  7.0     7.0  |  7.0     6.0  |  1.0  |  9.3  |  1.0  |  0.0  |
--------------------------------------------------------------------------------------------------
...
-----------------------------------------------------------------------------------------
|   1      |             |      |             |             |      | 1.0  |      |      | vpcmpgtq k1, ymm4, ymm5
|   1      |             |      |             |             |      | 1.0  |      |      | vpaddq ymm5, ymm5, ymm1
|   2      |             |      | 1.0     1.0 |             |      | 1.0  |      |      | vmovupd ymm6{k1}{z}, ymmword ptr [r13+r9*8+0x10]
|   2      |             |      |             | 1.0     1.0 |      | 1.0  |      |      | vmovupd ymm7{k1}{z}, ymmword ptr [r13+r9*8+0x8]
|   2      |             |      | 1.0     1.0 |             |      | 1.0  |      |      | vmovupd ymm8{k1}{z}, ymmword ptr [r13+r9*8+0x18]
|   2      |             |      |             | 1.0     1.0 |      | 1.0  |      |      | vmovupd ymm15{k1}{z}, ymmword ptr [r13+r9*8]
|   2      |             | 0.4  | 1.0     1.0 |             |      | 0.6  |      |      | vmovupd ymm20{k1}{z}, ymmword ptr [r13+r9*8+0x20]
|   2      | 0.3         | 0.3  |             | 1.0     1.0 |      | 0.4  |      |      | vmovupd ymm9{k1}{z}, ymmword ptr [rsi+r9*8+0x10]
|   2      | 0.4         | 0.3  | 1.0     1.0 |             |      | 0.3  |      |      | vmovupd ymm12{k1}{z}, ymmword ptr [r10+r9*8+0x10]
|   2      | 0.3         | 0.4  |             | 1.0     1.0 |      | 0.3  |      |      | vmovupd ymm13{k1}{z}, ymmword ptr [rdi+r9*8+0x10]
|   2      | 0.3         | 0.3  | 1.0     1.0 |             |      | 0.4  |      |      | vmovupd ymm14{k1}{z}, ymmword ptr [r11+r9*8+0x10]
|   2      | 0.4         | 0.3  |             | 1.0     1.0 |      | 0.3  |      |      | vmovupd ymm21{k1}{z}, ymmword ptr [r8+r9*8+0x10]
|   2      | 0.3         | 0.4  | 1.0     1.0 |             |      | 0.3  |      |      | vmovupd ymm22{k1}{z}, ymmword ptr [r12+r9*8+0x10]
|   2      | 0.3         | 0.3  |             | 1.0     1.0 |      | 0.4  |      |      | vmovupd ymm23{k1}{z}, ymmword ptr [r15+r9*8+0x10]
|   2      | 0.4         | 0.3  | 1.0     1.0 |             |      | 0.3  |      |      | vmovupd ymm27{k1}{z}, ymmword ptr [rcx+r9*8+0x10]
|   1      | 0.6         | 0.4  |             |             |      |      |      |      | vaddpd ymm10, ymm6, ymm7
|   1      | 0.4         | 0.6  |             |             |      |      |      |      | vaddpd ymm11, ymm8, ymm9
|   1      | 0.6         | 0.4  |             |             |      |      |      |      | vaddpd ymm16, ymm12, ymm13
|   1      | 0.4         | 0.6  |             |             |      |      |      |      | vaddpd ymm17, ymm14, ymm15
|   1      | 0.6         | 0.4  |             |             |      |      |      |      | vaddpd ymm24, ymm20, ymm21
|   1      | 0.4         | 0.6  |             |             |      |      |      |      | vaddpd ymm25, ymm22, ymm23
|   1      | 0.6         | 0.4  |             |             |      |      |      |      | vaddpd ymm18, ymm10, ymm11
|   1      | 0.4         | 0.6  |             |             |      |      |      |      | vaddpd ymm19, ymm16, ymm17
|   1      | 0.6         | 0.4  |             |             |      |      |      |      | vaddpd ymm26, ymm24, ymm25
|   1      | 0.4         | 0.6  |             |             |      |      |      |      | vaddpd ymm28, ymm18, ymm19
|   1      | 0.6         | 0.4  |             |             |      |      |      |      | vaddpd ymm29, ymm26, ymm27
|   1      | 0.4         | 0.6  |             |             |      |      |      |      | vaddpd ymm30, ymm28, ymm29
|   1      | 0.6         | 0.4  |             |             |      |      |      |      | vmulpd ymm31, ymm0, ymm30
|   2      |             |      |             | 1.0         | 1.0  |      |      |      | vmovupd ymmword ptr [r14+r9*8+0x10]{k1}, ymm31
|   1      |             |      |             |             |      |      | 1.0  |      | add r9, 0x4
|   1*     |             |      |             |             |      |      |      |      | cmp r9, rax
|   0*F    |             |      |             |             |      |      |      |      | jb 0xffffffffffffff10
...
# Logged in users
################################################################################
 23:23:08 up 17 days,  9:17,  0 users,  load average: 0.63, 0.87, 0.96
...
CPU 0: governor  performance min/cur/max 2.4/1.022/2.4 GHz Turbo 0
CPU 1: governor  performance min/cur/max 2.4/1.706/2.4 GHz Turbo 0
CPU 2: governor  performance min/cur/max 2.4/1.388/2.4 GHz Turbo 0
CPU 5: governor  performance min/cur/max 2.4/1.410/2.4 GHz Turbo 0
CPU 6: governor  performance min/cur/max 2.4/2.084/2.4 GHz Turbo 0
CPU 10: governor  performance min/cur/max 2.4/2.291/2.4 GHz Turbo 0
CPU 11: governor  performance min/cur/max 2.4/1.734/2.4 GHz Turbo 0
CPU 12: governor  performance min/cur/max 2.4/1.649/2.4 GHz Turbo 0
CPU 15: governor  performance min/cur/max 2.4/1.243/2.4 GHz Turbo 0
CPU 16: governor  performance min/cur/max 2.4/1.898/2.4 GHz Turbo 0
CPU 3: governor  performance min/cur/max 2.4/1.298/2.4 GHz Turbo 0
CPU 4: governor  performance min/cur/max 2.4/2.400/2.4 GHz Turbo 0
CPU 7: governor  performance min/cur/max 2.4/2.400/2.4 GHz Turbo 0
CPU 8: governor  performance min/cur/max 2.4/1.495/2.4 GHz Turbo 0
CPU 9: governor  performance min/cur/max 2.4/2.101/2.4 GHz Turbo 0
CPU 13: governor  performance min/cur/max 2.4/1.909/2.4 GHz Turbo 0
CPU 14: governor  performance min/cur/max 2.4/1.328/2.4 GHz Turbo 0
CPU 17: governor  performance min/cur/max 2.4/2.218/2.4 GHz Turbo 0
CPU 18: governor  performance min/cur/max 2.4/2.171/2.4 GHz Turbo 0
CPU 19: governor  performance min/cur/max 2.4/1.617/2.4 GHz Turbo 0
CPU 20: governor  performance min/cur/max 2.4/2.088/2.4 GHz Turbo 0
CPU 21: governor  performance min/cur/max 2.4/2.087/2.4 GHz Turbo 0
CPU 22: governor  performance min/cur/max 2.4/2.390/2.4 GHz Turbo 0
CPU 25: governor  performance min/cur/max 2.4/2.386/2.4 GHz Turbo 0
CPU 26: governor  performance min/cur/max 2.4/1.747/2.4 GHz Turbo 0
CPU 30: governor  performance min/cur/max 2.4/2.212/2.4 GHz Turbo 0
CPU 31: governor  performance min/cur/max 2.4/1.864/2.4 GHz Turbo 0
CPU 32: governor  performance min/cur/max 2.4/2.015/2.4 GHz Turbo 0
CPU 35: governor  performance min/cur/max 2.4/1.535/2.4 GHz Turbo 0
CPU 36: governor  performance min/cur/max 2.4/2.322/2.4 GHz Turbo 0
CPU 23: governor  performance min/cur/max 2.4/1.842/2.4 GHz Turbo 0
CPU 24: governor  performance min/cur/max 2.4/2.155/2.4 GHz Turbo 0
CPU 27: governor  performance min/cur/max 2.4/1.686/2.4 GHz Turbo 0
CPU 28: governor  performance min/cur/max 2.4/1.999/2.4 GHz Turbo 0
CPU 29: governor  performance min/cur/max 2.4/2.329/2.4 GHz Turbo 0
CPU 33: governor  performance min/cur/max 2.4/2.137/2.4 GHz Turbo 0
CPU 34: governor  performance min/cur/max 2.4/2.322/2.4 GHz Turbo 0
...
CPU 39: governor  performance min/cur/max 2.4/2.402/2.4 GHz Turbo 0
CPU 40: governor  performance min/cur/max 2.4/2.400/2.4 GHz Turbo 0
CPU 41: governor  performance min/cur/max 2.4/1.881/2.4 GHz Turbo 0
CPU 42: governor  performance min/cur/max 2.4/1.965/2.4 GHz Turbo 0
CPU 45: governor  performance min/cur/max 2.4/1.551/2.4 GHz Turbo 0
CPU 46: governor  performance min/cur/max 2.4/1.988/2.4 GHz Turbo 0
CPU 50: governor  performance min/cur/max 2.4/2.191/2.4 GHz Turbo 0
CPU 51: governor  performance min/cur/max 2.4/2.058/2.4 GHz Turbo 0
CPU 52: governor  performance min/cur/max 2.4/2.233/2.4 GHz Turbo 0
CPU 55: governor  performance min/cur/max 2.4/1.787/2.4 GHz Turbo 0
CPU 56: governor  performance min/cur/max 2.4/1.917/2.4 GHz Turbo 0
CPU 43: governor  performance min/cur/max 2.4/1.814/2.4 GHz Turbo 0
CPU 44: governor  performance min/cur/max 2.4/2.052/2.4 GHz Turbo 0
CPU 47: governor  performance min/cur/max 2.4/1.827/2.4 GHz Turbo 0
CPU 48: governor  performance min/cur/max 2.4/2.267/2.4 GHz Turbo 0
CPU 49: governor  performance min/cur/max 2.4/1.942/2.4 GHz Turbo 0
CPU 53: governor  performance min/cur/max 2.4/2.207/2.4 GHz Turbo 0
CPU 54: governor  performance min/cur/max 2.4/2.042/2.4 GHz Turbo 0
CPU 57: governor  performance min/cur/max 2.4/1.784/2.4 GHz Turbo 0
CPU 58: governor  performance min/cur/max 2.4/2.329/2.4 GHz Turbo 0
CPU 59: governor  performance min/cur/max 2.4/1.498/2.4 GHz Turbo 0
CPU 60: governor  performance min/cur/max 2.4/2.336/2.4 GHz Turbo 0
CPU 61: governor  performance min/cur/max 2.4/1.972/2.4 GHz Turbo 0
CPU 62: governor  performance min/cur/max 2.4/1.863/2.4 GHz Turbo 0
CPU 65: governor  performance min/cur/max 2.4/1.832/2.4 GHz Turbo 0
CPU 66: governor  performance min/cur/max 2.4/1.885/2.4 GHz Turbo 0
CPU 70: governor  performance min/cur/max 2.4/1.689/2.4 GHz Turbo 0
CPU 71: governor  performance min/cur/max 2.4/1.873/2.4 GHz Turbo 0
CPU 72: governor  performance min/cur/max 2.4/2.016/2.4 GHz Turbo 0
CPU 75: governor  performance min/cur/max 2.4/2.261/2.4 GHz Turbo 0
CPU 76: governor  performance min/cur/max 2.4/1.959/2.4 GHz Turbo 0
CPU 63: governor  performance min/cur/max 2.4/2.109/2.4 GHz Turbo 0
CPU 64: governor  performance min/cur/max 2.4/1.491/2.4 GHz Turbo 0
CPU 67: governor  performance min/cur/max 2.4/2.217/2.4 GHz Turbo 0
CPU 68: governor  performance min/cur/max 2.4/2.053/2.4 GHz Turbo 0
CPU 69: governor  performance min/cur/max 2.4/2.055/2.4 GHz Turbo 0
CPU 73: governor  performance min/cur/max 2.4/2.089/2.4 GHz Turbo 0
CPU 74: governor  performance min/cur/max 2.4/1.306/2.4 GHz Turbo 0
CPU 77: governor  performance min/cur/max 2.4/1.554/2.4 GHz Turbo 0
CPU 78: governor  performance min/cur/max 2.4/2.237/2.4 GHz Turbo 0
CPU 79: governor  performance min/cur/max 2.4/1.796/2.4 GHz Turbo 0
...
MemFree:        95570664 kB
MemAvailable:   95611352 kB
Buffers:           37060 kB
Cached:           533260 kB
SwapCached:          352 kB
Active:           420468 kB
Inactive:         194156 kB
Active(anon):      34176 kB
Inactive(anon):    11796 kB
Active(file):     386292 kB
Inactive(file):   182360 kB
Unevictable:           0 kB
Mlocked:               0 kB
...
Shmem:              1668 kB
Slab:             728832 kB
SReclaimable:     271012 kB
SUnreclaim:       457820 kB
...
OLDPWD=/home/hpc/iwia/iwia84/INSPECT-repo/stencils/3D_r2_heterogeneous_star_constant/SkylakeSP_Gold-6148_SNC_20190423_182911
...
PWD=/home/hpc/iwia/iwia84/INSPECT-repo/stencils/3D_r2_homogeneous_star_constant/SkylakeSP_Gold-6148_SNC_20190423_232308
