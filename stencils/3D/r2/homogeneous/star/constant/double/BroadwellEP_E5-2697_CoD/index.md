...
--------------------------------------------------------------------------------------------------
| Cycles |  1.0     0.0  | 12.0  |  7.0     7.0  |  7.0     6.0  |  1.0  |  0.5  |  0.5  |  0.0  |
--------------------------------------------------------------------------------------------------
...
-----------------------------------------------------------------------------------------
|   1      |             |      | 1.0     1.0 |             |      |      |      |      | vmovupd ymm3, ymmword ptr [rax+r9*8+0x18]
|   1      |             |      |             | 1.0     1.0 |      |      |      |      | vmovupd ymm2, ymmword ptr [rax+r9*8+0x10]
|   1      |             |      | 1.0     1.0 |             |      |      |      |      | vmovupd ymm12, ymmword ptr [rax+r9*8+0x20]
|   1      |             |      |             | 1.0     1.0 |      |      |      |      | vmovupd ymm6, ymmword ptr [r14+r9*8+0x10]
|   1      |             |      | 1.0     1.0 |             |      |      |      |      | vmovupd ymm7, ymmword ptr [r12+r9*8+0x10]
|   1      |             |      |             | 1.0     1.0 |      |      |      |      | vmovupd ymm13, ymmword ptr [r15+r9*8+0x10]
|   2      |             | 1.0  | 1.0     1.0 |             |      |      |      |      | vaddpd ymm4, ymm2, ymmword ptr [rax+r9*8+0x8]
|   2      |             | 1.0  |             | 1.0     1.0 |      |      |      |      | vaddpd ymm9, ymm7, ymmword ptr [rax+r9*8]
|   2      |             | 1.0  | 1.0     1.0 |             |      |      |      |      | vaddpd ymm5, ymm3, ymmword ptr [r10+r9*8+0x10]
|   2      |             | 1.0  |             | 1.0     1.0 |      |      |      |      | vaddpd ymm8, ymm6, ymmword ptr [r13+r9*8+0x10]
|   2      |             | 1.0  | 1.0     1.0 |             |      |      |      |      | vaddpd ymm14, ymm12, ymmword ptr [r11+r9*8+0x10]
|   2      |             | 1.0  |             | 1.0     1.0 |      |      |      |      | vaddpd ymm15, ymm13, ymmword ptr [rsi+r9*8+0x10]
|   1      |             | 1.0  |             |             |      |      |      |      | vaddpd ymm10, ymm4, ymm5
|   1      |             | 1.0  |             |             |      |      |      |      | vaddpd ymm11, ymm8, ymm9
|   1      |             | 1.0  |             |             |      |      |      |      | vaddpd ymm12, ymm14, ymm15
|   1      |             | 1.0  |             |             |      |      |      |      | vaddpd ymm2, ymm10, ymm11
|   2      |             | 1.0  | 1.0     1.0 |             |      |      |      |      | vaddpd ymm3, ymm12, ymmword ptr [rdi+r9*8+0x10]
|   1      |             | 1.0  |             |             |      |      |      |      | vaddpd ymm4, ymm2, ymm3
|   1      | 1.0         |      |             |             |      |      |      |      | vmulpd ymm5, ymm0, ymm4
|   2      |             |      |             | 1.0         | 1.0  |      |      |      | vmovupd ymmword ptr [r8+r9*8+0x10], ymm5
|   1      |             |      |             |             |      | 0.5  | 0.5  |      | add r9, 0x4
|   1*     |             |      |             |             |      |      |      |      | cmp r9, rdx
|   0*F    |             |      |             |             |      |      |      |      | jb 0xffffffffffffff7d
...
# Logged in users
################################################################################
 22:12:14 up 132 days,  5:44,  0 users,  load average: 0.72, 0.87, 0.95
...
CPU 0: governor  performance min/cur/max 2.3/1.832/2.3 GHz Turbo 0
CPU 1: governor  performance min/cur/max 2.3/2.249/2.3 GHz Turbo 0
CPU 2: governor  performance min/cur/max 2.3/1.353/2.3 GHz Turbo 0
CPU 3: governor  performance min/cur/max 2.3/1.218/2.3 GHz Turbo 0
CPU 4: governor  performance min/cur/max 2.3/2.219/2.3 GHz Turbo 0
CPU 5: governor  performance min/cur/max 2.3/2.261/2.3 GHz Turbo 0
CPU 6: governor  performance min/cur/max 2.3/1.297/2.3 GHz Turbo 0
CPU 7: governor  performance min/cur/max 2.3/1.258/2.3 GHz Turbo 0
CPU 8: governor  performance min/cur/max 2.3/1.757/2.3 GHz Turbo 0
CPU 9: governor  performance min/cur/max 2.3/1.761/2.3 GHz Turbo 0
CPU 10: governor  performance min/cur/max 2.3/1.821/2.3 GHz Turbo 0
CPU 11: governor  performance min/cur/max 2.3/1.220/2.3 GHz Turbo 0
CPU 12: governor  performance min/cur/max 2.3/1.363/2.3 GHz Turbo 0
CPU 13: governor  performance min/cur/max 2.3/2.140/2.3 GHz Turbo 0
CPU 14: governor  performance min/cur/max 2.3/2.057/2.3 GHz Turbo 0
CPU 15: governor  performance min/cur/max 2.3/1.347/2.3 GHz Turbo 0
CPU 16: governor  performance min/cur/max 2.3/2.020/2.3 GHz Turbo 0
CPU 17: governor  performance min/cur/max 2.3/1.768/2.3 GHz Turbo 0
CPU 18: governor  performance min/cur/max 2.3/2.278/2.3 GHz Turbo 0
...
CPU 22: governor  performance min/cur/max 2.3/2.293/2.3 GHz Turbo 0
CPU 23: governor  performance min/cur/max 2.3/2.282/2.3 GHz Turbo 0
CPU 24: governor  performance min/cur/max 2.3/2.287/2.3 GHz Turbo 0
CPU 25: governor  performance min/cur/max 2.3/2.290/2.3 GHz Turbo 0
CPU 26: governor  performance min/cur/max 2.3/2.284/2.3 GHz Turbo 0
...
CPU 29: governor  performance min/cur/max 2.3/2.267/2.3 GHz Turbo 0
CPU 30: governor  performance min/cur/max 2.3/1.924/2.3 GHz Turbo 0
...
CPU 36: governor  performance min/cur/max 2.3/2.019/2.3 GHz Turbo 0
CPU 37: governor  performance min/cur/max 2.3/1.237/2.3 GHz Turbo 0
CPU 38: governor  performance min/cur/max 2.3/2.256/2.3 GHz Turbo 0
CPU 39: governor  performance min/cur/max 2.3/1.925/2.3 GHz Turbo 0
CPU 40: governor  performance min/cur/max 2.3/2.162/2.3 GHz Turbo 0
CPU 41: governor  performance min/cur/max 2.3/1.206/2.3 GHz Turbo 0
CPU 42: governor  performance min/cur/max 2.3/2.186/2.3 GHz Turbo 0
CPU 43: governor  performance min/cur/max 2.3/2.010/2.3 GHz Turbo 0
CPU 44: governor  performance min/cur/max 2.3/2.266/2.3 GHz Turbo 0
CPU 45: governor  performance min/cur/max 2.3/2.017/2.3 GHz Turbo 0
CPU 46: governor  performance min/cur/max 2.3/1.788/2.3 GHz Turbo 0
CPU 47: governor  performance min/cur/max 2.3/2.086/2.3 GHz Turbo 0
CPU 48: governor  performance min/cur/max 2.3/1.597/2.3 GHz Turbo 0
CPU 49: governor  performance min/cur/max 2.3/1.766/2.3 GHz Turbo 0
CPU 50: governor  performance min/cur/max 2.3/2.297/2.3 GHz Turbo 0
CPU 51: governor  performance min/cur/max 2.3/2.131/2.3 GHz Turbo 0
CPU 52: governor  performance min/cur/max 2.3/2.260/2.3 GHz Turbo 0
CPU 53: governor  performance min/cur/max 2.3/1.804/2.3 GHz Turbo 0
CPU 54: governor  performance min/cur/max 2.3/2.188/2.3 GHz Turbo 0
CPU 55: governor  performance min/cur/max 2.3/2.297/2.3 GHz Turbo 0
CPU 56: governor  performance min/cur/max 2.3/2.296/2.3 GHz Turbo 0
CPU 57: governor  performance min/cur/max 2.3/2.257/2.3 GHz Turbo 0
CPU 58: governor  performance min/cur/max 2.3/2.267/2.3 GHz Turbo 0
...
CPU 63: governor  performance min/cur/max 2.3/2.292/2.3 GHz Turbo 0
CPU 64: governor  performance min/cur/max 2.3/2.268/2.3 GHz Turbo 0
CPU 65: governor  performance min/cur/max 2.3/2.285/2.3 GHz Turbo 0
CPU 66: governor  performance min/cur/max 2.3/2.161/2.3 GHz Turbo 0
CPU 67: governor  performance min/cur/max 2.3/2.297/2.3 GHz Turbo 0
CPU 68: governor  performance min/cur/max 2.3/2.285/2.3 GHz Turbo 0
CPU 69: governor  performance min/cur/max 2.3/2.289/2.3 GHz Turbo 0
CPU 70: governor  performance min/cur/max 2.3/2.259/2.3 GHz Turbo 0
CPU 71: governor  performance min/cur/max 2.3/2.271/2.3 GHz Turbo 0
...
MemFree:        129749844 kB
MemAvailable:   129665344 kB
Buffers:           43992 kB
Cached:           519932 kB
SwapCached:         5028 kB
Active:           399736 kB
...
Active(file):     378592 kB
Inactive(file):   184932 kB
Unevictable:           0 kB
Mlocked:               0 kB
...
Shmem:               384 kB
Slab:             732704 kB
SReclaimable:     308872 kB
SUnreclaim:       423832 kB
...
OLDPWD=/home/hpc/iwia/iwia84/INSPECT-repo/stencils/3D_r2_heterogeneous_star_constant/BroadwellEP_E5-2697_CoD_20190423_172351
...
PWD=/home/hpc/iwia/iwia84/INSPECT-repo/stencils/3D_r2_homogeneous_star_constant/BroadwellEP_E5-2697_CoD_20190423_221214
