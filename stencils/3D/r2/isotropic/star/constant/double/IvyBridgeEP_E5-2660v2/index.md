...
title:  "Stencil 3D r2 star constant isotropic double IvyBridgeEP_E5-2660v2"
...
vmovupd ymm8, ymmword ptr [r11+r8*8+0x8]
vmovupd xmm9, xmmword ptr [r10+r8*8+0x10]
vmovupd xmm12, xmmword ptr [r12+r8*8+0x10]
vaddpd ymm10, ymm8, ymmword ptr [r11+r8*8+0x18]
vmovupd xmm15, xmmword ptr [rdi+r8*8+0x10]
vmulpd ymm1, ymm4, ymmword ptr [r11+r8*8+0x10]
vinsertf128 ymm11, ymm9, xmmword ptr [r10+r8*8+0x20], 0x1
vaddpd ymm13, ymm10, ymm11
vmovupd xmm9, xmmword ptr [r13+r8*8+0x10]
vinsertf128 ymm14, ymm12, xmmword ptr [r12+r8*8+0x20], 0x1
vaddpd ymm0, ymm13, ymm14
vinsertf128 ymm8, ymm15, xmmword ptr [rdi+r8*8+0x20], 0x1
vaddpd ymm10, ymm0, ymm8
vinsertf128 ymm11, ymm9, xmmword ptr [r13+r8*8+0x20], 0x1
vaddpd ymm12, ymm10, ymm11
vmovupd xmm10, xmmword ptr [r9+r8*8+0x10]
vmulpd ymm13, ymm3, ymm12
vaddpd ymm0, ymm1, ymm13
vmovupd xmm1, xmmword ptr [r11+r8*8+0x20]
vinsertf128 ymm14, ymm1, xmmword ptr [r11+r8*8+0x30], 0x1
vmovupd xmm1, xmmword ptr [r14+r8*8+0x10]
vaddpd ymm8, ymm14, ymmword ptr [r11+r8*8]
vinsertf128 ymm9, ymm1, xmmword ptr [r14+r8*8+0x20], 0x1
vaddpd ymm11, ymm8, ymm9
vinsertf128 ymm12, ymm10, xmmword ptr [r9+r8*8+0x20], 0x1
vaddpd ymm13, ymm11, ymm12
vaddpd ymm14, ymm13, ymmword ptr [rdx+r8*8+0x10]
vaddpd ymm15, ymm14, ymmword ptr [r15+r8*8+0x10]
...
--------------------------
Block Throughput: 14.00 Cycles       Throughput Bottleneck: Backend. Port3_DATA

Port Binding In Cycles Per Iteration:
-------------------------------------------------------------------------
|  Port  |  0   -  DV  |  1   |  2   -  D   |  3   -  D   |  4   |  5   |
-------------------------------------------------------------------------
| Cycles | 4.4    0.0  | 12.0 | 11.0   12.0 | 11.0   14.0 | 2.0  | 7.6  |
-------------------------------------------------------------------------
...
---------------------------------------------------------------------
|   1    |           |     | 1.0   2.0 |           |     |     |    | vmovupd ymm8, ymmword ptr [r11+r8*8+0x8]
|   1    |           |     |           | 1.0   1.0 |     |     | CP | vmovupd xmm9, xmmword ptr [r10+r8*8+0x10]
|   1    |           |     | 1.0   1.0 |           |     |     |    | vmovupd xmm12, xmmword ptr [r12+r8*8+0x10]
|   2    |           | 1.0 |           | 1.0   2.0 |     |     | CP | vaddpd ymm10, ymm8, ymmword ptr [r11+r8*8+0x18]
|   1    |           |     | 1.0   1.0 |           |     |     |    | vmovupd xmm15, xmmword ptr [rdi+r8*8+0x10]
|   2    | 1.0       |     |           | 1.0   2.0 |     |     | CP | vmulpd ymm1, ymm4, ymmword ptr [r11+r8*8+0x10]
|   2    |           |     | 1.0   1.0 |           |     | 1.0 |    | vinsertf128 ymm11, ymm9, xmmword ptr [r10+r8*8+0x20], 0x1
|   1    |           | 1.0 |           |           |     |     |    | vaddpd ymm13, ymm10, ymm11
|   1    |           |     |           | 1.0   1.0 |     |     | CP | vmovupd xmm9, xmmword ptr [r13+r8*8+0x10]
|   2    |           |     | 1.0   1.0 |           |     | 1.0 |    | vinsertf128 ymm14, ymm12, xmmword ptr [r12+r8*8+0x20], 0x1
|   1    |           | 1.0 |           |           |     |     |    | vaddpd ymm0, ymm13, ymm14
|   2    | 0.6       |     |           | 1.0   1.0 |     | 0.3 | CP | vinsertf128 ymm8, ymm15, xmmword ptr [rdi+r8*8+0x20], 0x1
|   1    |           | 1.0 |           |           |     |     |    | vaddpd ymm10, ymm0, ymm8
|   2    | 0.1       |     | 1.0   1.0 |           |     | 0.9 |    | vinsertf128 ymm11, ymm9, xmmword ptr [r13+r8*8+0x20], 0x1
|   1    |           | 1.0 |           |           |     |     |    | vaddpd ymm12, ymm10, ymm11
|   1    |           |     |           | 1.0   1.0 |     |     | CP | vmovupd xmm10, xmmword ptr [r9+r8*8+0x10]
|   1    | 1.0       |     |           |           |     |     |    | vmulpd ymm13, ymm3, ymm12
|   1    |           | 1.0 |           |           |     |     |    | vaddpd ymm0, ymm1, ymm13
|   1    |           |     | 1.0   1.0 |           |     |     |    | vmovupd xmm1, xmmword ptr [r11+r8*8+0x20]
|   2    | 0.1       |     |           | 1.0   1.0 |     | 0.9 | CP | vinsertf128 ymm14, ymm1, xmmword ptr [r11+r8*8+0x30], 0x1
|   1    |           |     | 1.0   1.0 |           |     |     |    | vmovupd xmm1, xmmword ptr [r14+r8*8+0x10]
|   2    |           | 1.0 |           | 1.0   2.0 |     |     | CP | vaddpd ymm8, ymm14, ymmword ptr [r11+r8*8]
|   2    |           |     | 1.0   1.0 |           |     | 1.0 |    | vinsertf128 ymm9, ymm1, xmmword ptr [r14+r8*8+0x20], 0x1
|   1    |           | 1.0 |           |           |     |     |    | vaddpd ymm11, ymm8, ymm9
|   2    | 0.6       |     |           | 1.0   1.0 |     | 0.4 | CP | vinsertf128 ymm12, ymm10, xmmword ptr [r9+r8*8+0x20], 0x1
|   1    |           | 1.0 |           |           |     |     |    | vaddpd ymm13, ymm11, ymm12
|   2    |           | 1.0 | 1.0   2.0 |           |     |     |    | vaddpd ymm14, ymm13, ymmword ptr [rdx+r8*8+0x10]
|   2    |           | 1.0 |           | 1.0   2.0 |     |     | CP | vaddpd ymm15, ymm14, ymmword ptr [r15+r8*8+0x10]
|   1    | 1.0       |     |           |           |     |     |    | vmulpd ymm1, ymm2, ymm15
...
|   1    | 0.1       |     |           |           |     | 0.9 |    | add r8, 0x4
|   1    |           |     |           |           |     | 1.0 |    | cmp r8, rax
|   0F   |           |     |           |           |     |     |    | jb 0xffffffffffffff27
...
# Logged in users
################################################################################
 22:00:15 up 2 days,  7:21,  0 users,  load average: 0.71, 1.09, 1.60
...
MemFree:        62360816 kB
MemAvailable:   62326908 kB
Buffers:               0 kB
Cached:          2170108 kB
SwapCached:            0 kB
Active:           120844 kB
Inactive:        2064344 kB
Active(anon):      46364 kB
Inactive(anon):  1821100 kB
Active(file):      74480 kB
Inactive(file):   243244 kB
...
Shmem:           1852384 kB
Slab:             243448 kB
SReclaimable:      65448 kB
SUnreclaim:       178000 kB
KernelStack:        8640 kB
PageTables:         3452 kB
NFS_Unstable:          0 kB
Bounce:                0 kB
...
PWD=/home/hpc/iwia/iwia84/INSPECT-repo/stencils/3D_r2_isotropic_star_constant/IvyBridgeEP_E5-2660v2_20190523_220015
