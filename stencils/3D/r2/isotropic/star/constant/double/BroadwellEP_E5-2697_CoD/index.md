...
--------------------------------------------------------------------------------------------------
| Cycles |  3.0     0.0  | 10.0  |  7.0     7.0  |  7.0     6.0  |  1.0  |  0.5  |  0.5  |  0.0  |
--------------------------------------------------------------------------------------------------
...
-----------------------------------------------------------------------------------------
|   1      |             |      | 1.0     1.0 |             |      |      |      |      | vmovupd ymm6, ymmword ptr [rax+r9*8+0x8]
|   1      |             |      |             | 1.0     1.0 |      |      |      |      | vmovupd ymm12, ymmword ptr [rax+r9*8]
|   2      |             | 1.0  | 1.0     1.0 |             |      |      |      |      | vaddpd ymm7, ymm6, ymmword ptr [rax+r9*8+0x18]
|   2      |             | 1.0  |             | 1.0     1.0 |      |      |      |      | vaddpd ymm13, ymm12, ymmword ptr [rax+r9*8+0x20]
|   2      |             | 1.0  | 1.0     1.0 |             |      |      |      |      | vaddpd ymm8, ymm7, ymmword ptr [r10+r9*8+0x10]
|   2      |             | 1.0  |             | 1.0     1.0 |      |      |      |      | vaddpd ymm14, ymm13, ymmword ptr [r11+r9*8+0x10]
|   2      |             | 1.0  | 1.0     1.0 |             |      |      |      |      | vaddpd ymm9, ymm8, ymmword ptr [r14+r9*8+0x10]
|   2      |             | 1.0  |             | 1.0     1.0 |      |      |      |      | vaddpd ymm15, ymm14, ymmword ptr [r15+r9*8+0x10]
|   2      |             | 1.0  | 1.0     1.0 |             |      |      |      |      | vaddpd ymm10, ymm9, ymmword ptr [r13+r9*8+0x10]
|   2      |             | 1.0  |             | 1.0     1.0 |      |      |      |      | vaddpd ymm12, ymm15, ymmword ptr [rsi+r9*8+0x10]
|   2      |             | 1.0  | 1.0     1.0 |             |      |      |      |      | vaddpd ymm11, ymm10, ymmword ptr [r12+r9*8+0x10]
|   2      |             | 1.0  |             | 1.0     1.0 |      |      |      |      | vaddpd ymm13, ymm12, ymmword ptr [rdi+r9*8+0x10]
|   1      | 1.0         |      |             |             |      |      |      |      | vmulpd ymm6, ymm1, ymm11
|   2      | 1.0         |      | 1.0     1.0 |             |      |      |      |      | vfmadd231pd ymm6, ymm2, ymmword ptr [rax+r9*8+0x10]
|   1      | 1.0         |      |             |             |      |      |      |      | vfmadd231pd ymm6, ymm13, ymm0
|   2      |             |      |             | 1.0         | 1.0  |      |      |      | vmovupd ymmword ptr [r8+r9*8+0x10], ymm6
|   1      |             |      |             |             |      | 0.5  | 0.5  |      | add r9, 0x4
|   1*     |             |      |             |             |      |      |      |      | cmp r9, rdx
|   0*F    |             |      |             |             |      |      |      |      | jb 0xffffffffffffff8e
...
# Logged in users
################################################################################
 12:38:47 up 131 days, 20:10,  0 users,  load average: 0.14, 0.03, 0.01
...
CPU 0: governor  performance min/cur/max 2.3/1.955/2.3 GHz Turbo 0
CPU 1: governor  performance min/cur/max 2.3/1.413/2.3 GHz Turbo 0
CPU 2: governor  performance min/cur/max 2.3/1.343/2.3 GHz Turbo 0
CPU 3: governor  performance min/cur/max 2.3/2.277/2.3 GHz Turbo 0
CPU 4: governor  performance min/cur/max 2.3/1.460/2.3 GHz Turbo 0
CPU 5: governor  performance min/cur/max 2.3/2.297/2.3 GHz Turbo 0
CPU 6: governor  performance min/cur/max 2.3/1.927/2.3 GHz Turbo 0
CPU 7: governor  performance min/cur/max 2.3/2.231/2.3 GHz Turbo 0
CPU 8: governor  performance min/cur/max 2.3/2.090/2.3 GHz Turbo 0
CPU 9: governor  performance min/cur/max 2.3/1.997/2.3 GHz Turbo 0
CPU 10: governor  performance min/cur/max 2.3/1.894/2.3 GHz Turbo 0
CPU 11: governor  performance min/cur/max 2.3/2.256/2.3 GHz Turbo 0
CPU 12: governor  performance min/cur/max 2.3/1.480/2.3 GHz Turbo 0
CPU 13: governor  performance min/cur/max 2.3/1.651/2.3 GHz Turbo 0
CPU 14: governor  performance min/cur/max 2.3/2.209/2.3 GHz Turbo 0
CPU 15: governor  performance min/cur/max 2.3/1.450/2.3 GHz Turbo 0
CPU 16: governor  performance min/cur/max 2.3/1.636/2.3 GHz Turbo 0
CPU 17: governor  performance min/cur/max 2.3/2.230/2.3 GHz Turbo 0
CPU 18: governor  performance min/cur/max 2.3/2.268/2.3 GHz Turbo 0
CPU 19: governor  performance min/cur/max 2.3/2.275/2.3 GHz Turbo 0
CPU 20: governor  performance min/cur/max 2.3/2.286/2.3 GHz Turbo 0
CPU 21: governor  performance min/cur/max 2.3/2.289/2.3 GHz Turbo 0
CPU 22: governor  performance min/cur/max 2.3/2.284/2.3 GHz Turbo 0
CPU 23: governor  performance min/cur/max 2.3/2.282/2.3 GHz Turbo 0
CPU 24: governor  performance min/cur/max 2.3/2.285/2.3 GHz Turbo 0
CPU 25: governor  performance min/cur/max 2.3/2.297/2.3 GHz Turbo 0
CPU 26: governor  performance min/cur/max 2.3/2.282/2.3 GHz Turbo 0
CPU 27: governor  performance min/cur/max 2.3/2.297/2.3 GHz Turbo 0
CPU 28: governor  performance min/cur/max 2.3/2.299/2.3 GHz Turbo 0
...
CPU 32: governor  performance min/cur/max 2.3/2.298/2.3 GHz Turbo 0
...
CPU 35: governor  performance min/cur/max 2.3/2.296/2.3 GHz Turbo 0
CPU 36: governor  performance min/cur/max 2.3/1.458/2.3 GHz Turbo 0
CPU 37: governor  performance min/cur/max 2.3/1.681/2.3 GHz Turbo 0
CPU 38: governor  performance min/cur/max 2.3/1.371/2.3 GHz Turbo 0
CPU 39: governor  performance min/cur/max 2.3/1.342/2.3 GHz Turbo 0
CPU 40: governor  performance min/cur/max 2.3/1.212/2.3 GHz Turbo 0
CPU 41: governor  performance min/cur/max 2.3/2.244/2.3 GHz Turbo 0
CPU 42: governor  performance min/cur/max 2.3/1.717/2.3 GHz Turbo 0
CPU 43: governor  performance min/cur/max 2.3/1.989/2.3 GHz Turbo 0
CPU 44: governor  performance min/cur/max 2.3/2.144/2.3 GHz Turbo 0
CPU 45: governor  performance min/cur/max 2.3/1.281/2.3 GHz Turbo 0
CPU 46: governor  performance min/cur/max 2.3/1.942/2.3 GHz Turbo 0
CPU 47: governor  performance min/cur/max 2.3/1.971/2.3 GHz Turbo 0
CPU 48: governor  performance min/cur/max 2.3/1.375/2.3 GHz Turbo 0
CPU 49: governor  performance min/cur/max 2.3/1.755/2.3 GHz Turbo 0
CPU 50: governor  performance min/cur/max 2.3/1.750/2.3 GHz Turbo 0
CPU 51: governor  performance min/cur/max 2.3/1.284/2.3 GHz Turbo 0
CPU 52: governor  performance min/cur/max 2.3/2.264/2.3 GHz Turbo 0
CPU 53: governor  performance min/cur/max 2.3/2.135/2.3 GHz Turbo 0
CPU 54: governor  performance min/cur/max 2.3/2.161/2.3 GHz Turbo 0
CPU 55: governor  performance min/cur/max 2.3/2.293/2.3 GHz Turbo 0
CPU 56: governor  performance min/cur/max 2.3/2.265/2.3 GHz Turbo 0
CPU 57: governor  performance min/cur/max 2.3/2.275/2.3 GHz Turbo 0
...
CPU 60: governor  performance min/cur/max 2.3/2.285/2.3 GHz Turbo 0
CPU 61: governor  performance min/cur/max 2.3/2.285/2.3 GHz Turbo 0
CPU 62: governor  performance min/cur/max 2.3/2.297/2.3 GHz Turbo 0
CPU 63: governor  performance min/cur/max 2.3/2.247/2.3 GHz Turbo 0
CPU 64: governor  performance min/cur/max 2.3/1.960/2.3 GHz Turbo 0
CPU 65: governor  performance min/cur/max 2.3/2.295/2.3 GHz Turbo 0
CPU 66: governor  performance min/cur/max 2.3/2.177/2.3 GHz Turbo 0
CPU 67: governor  performance min/cur/max 2.3/2.294/2.3 GHz Turbo 0
CPU 68: governor  performance min/cur/max 2.3/2.179/2.3 GHz Turbo 0
CPU 69: governor  performance min/cur/max 2.3/2.271/2.3 GHz Turbo 0
CPU 70: governor  performance min/cur/max 2.3/2.261/2.3 GHz Turbo 0
CPU 71: governor  performance min/cur/max 2.3/2.258/2.3 GHz Turbo 0
...
MemFree:        130244196 kB
MemAvailable:   129908100 kB
Buffers:           10520 kB
Cached:            98308 kB
SwapCached:         5028 kB
Active:            57976 kB
Inactive:          75568 kB
Active(anon):      19212 kB
Inactive(anon):     5904 kB
Active(file):      38764 kB
Inactive(file):    69664 kB
Unevictable:           0 kB
Mlocked:               0 kB
...
Shmem:               384 kB
Slab:             711092 kB
SReclaimable:     290236 kB
SUnreclaim:       420856 kB
...
PWD=/home/hpc/iwia/iwia84/INSPECT-repo/stencils/3D_r2_isotropic_star_constant/BroadwellEP_E5-2697_CoD_20190423_123847
