...
title:  "Stencil 3D r2 star constant isotropic double SkylakeSP_Gold-6148_SNC"
...
--------------------------
Block Throughput: 13.55 Cycles       Throughput Bottleneck: Backend
Loop Count:  23
Port Binding In Cycles Per Iteration:
--------------------------------------------------------------------------------------------------
|  Port  |   0   -  DV   |   1   |   2   -  D    |   3   -  D    |   4   |   5   |   6   |   7   |
--------------------------------------------------------------------------------------------------
| Cycles |  9.3     0.0  |  9.3  |  7.0     7.0  |  7.0     6.0  |  1.0  |  9.3  |  1.0  |  0.0  |
--------------------------------------------------------------------------------------------------
...
-----------------------------------------------------------------------------------------
|   1      |             |      |             |             |      | 1.0  |      |      | vpcmpgtq k1, ymm5, ymm6
|   1      |             |      |             |             |      | 1.0  |      |      | vpaddq ymm6, ymm6, ymm4
|   2      |             |      | 1.0     1.0 |             |      | 1.0  |      |      | vmovupd ymm7{k1}{z}, ymmword ptr [rdi+r15*8+0x8]
|   2      |             |      |             | 1.0     1.0 |      | 1.0  |      |      | vmovupd ymm8{k1}{z}, ymmword ptr [rdi+r15*8+0x18]
|   2      |             |      | 1.0     1.0 |             |      | 1.0  |      |      | vmovupd ymm10{k1}{z}, ymmword ptr [r8+r15*8+0x10]
|   2      |             |      |             | 1.0     1.0 |      | 1.0  |      |      | vmovupd ymm12{k1}{z}, ymmword ptr [rsi+r15*8+0x10]
|   2      |             | 0.3  | 1.0     1.0 |             |      | 0.7  |      |      | vmovupd ymm14{k1}{z}, ymmword ptr [r9+r15*8+0x10]
|   2      | 0.3         | 0.3  |             | 1.0     1.0 |      | 0.3  |      |      | vmovupd ymm19{k1}{z}, ymmword ptr [rdi+r15*8]
|   2      | 0.3         | 0.3  | 1.0     1.0 |             |      | 0.3  |      |      | vmovupd ymm20{k1}{z}, ymmword ptr [rdi+r15*8+0x20]
|   2      | 0.3         | 0.3  |             | 1.0     1.0 |      | 0.3  |      |      | vmovupd ymm16{k1}{z}, ymmword ptr [rbx+r15*8+0x10]
|   2      | 0.3         | 0.3  | 1.0     1.0 |             |      | 0.3  |      |      | vmovupd ymm22{k1}{z}, ymmword ptr [r10+r15*8+0x10]
|   2      | 0.3         | 0.3  |             | 1.0     1.0 |      | 0.3  |      |      | vmovupd ymm24{k1}{z}, ymmword ptr [rcx+r15*8+0x10]
|   2      | 0.3         | 0.3  | 1.0     1.0 |             |      | 0.3  |      |      | vmovupd ymm26{k1}{z}, ymmword ptr [r11+r15*8+0x10]
|   2      | 0.3         | 0.3  |             | 1.0     1.0 |      | 0.3  |      |      | vmovupd ymm18{k1}{z}, ymmword ptr [rdi+r15*8+0x10]
|   2      | 0.3         | 0.3  | 1.0     1.0 |             |      | 0.3  |      |      | vmovupd ymm28{k1}{z}, ymmword ptr [rdx+r15*8+0x10]
|   1      | 0.7         | 0.3  |             |             |      |      |      |      | vaddpd ymm9, ymm7, ymm8
|   1      | 0.3         | 0.7  |             |             |      |      |      |      | vaddpd ymm21, ymm19, ymm20
|   1      | 0.7         | 0.3  |             |             |      |      |      |      | vaddpd ymm11, ymm9, ymm10
|   1      | 0.3         | 0.7  |             |             |      |      |      |      | vaddpd ymm23, ymm21, ymm22
|   1      | 0.7         | 0.3  |             |             |      |      |      |      | vaddpd ymm13, ymm11, ymm12
|   1      | 0.3         | 0.7  |             |             |      |      |      |      | vaddpd ymm25, ymm23, ymm24
|   1      | 0.7         | 0.3  |             |             |      |      |      |      | vaddpd ymm15, ymm13, ymm14
|   1      | 0.3         | 0.7  |             |             |      |      |      |      | vaddpd ymm27, ymm25, ymm26
|   1      | 0.7         | 0.3  |             |             |      |      |      |      | vaddpd ymm17, ymm15, ymm16
|   1      | 0.3         | 0.7  |             |             |      |      |      |      | vaddpd ymm29, ymm27, ymm28
|   1      | 0.7         | 0.3  |             |             |      |      |      |      | vmulpd ymm30, ymm1, ymm17
|   1      | 0.3         | 0.7  |             |             |      |      |      |      | vfmadd231pd ymm30, ymm18, ymm2
|   1      | 0.7         | 0.3  |             |             |      |      |      |      | vfmadd231pd ymm30, ymm29, ymm0
|   2      |             |      |             | 1.0         | 1.0  |      |      |      | vmovupd ymmword ptr [rax+r15*8+0x10]{k1}, ymm30
|   1      |             |      |             |             |      |      | 1.0  |      | add r15, 0x4
|   1*     |             |      |             |             |      |      |      |      | cmp r15, r12
|   0*F    |             |      |             |             |      |      |      |      | jb 0xffffffffffffff12
...
# Logged in users
################################################################################
 13:39:29 up 16 days, 23:33,  0 users,  load average: 0.15, 0.03, 0.11
...
CPU 0: governor  performance min/cur/max 2.4/1.254/2.4 GHz Turbo 0
CPU 1: governor  performance min/cur/max 2.4/1.568/2.4 GHz Turbo 0
CPU 2: governor  performance min/cur/max 2.4/1.683/2.4 GHz Turbo 0
CPU 5: governor  performance min/cur/max 2.4/1.308/2.4 GHz Turbo 0
CPU 6: governor  performance min/cur/max 2.4/2.239/2.4 GHz Turbo 0
CPU 10: governor  performance min/cur/max 2.4/2.154/2.4 GHz Turbo 0
CPU 11: governor  performance min/cur/max 2.4/1.388/2.4 GHz Turbo 0
CPU 12: governor  performance min/cur/max 2.4/2.185/2.4 GHz Turbo 0
CPU 15: governor  performance min/cur/max 2.4/1.858/2.4 GHz Turbo 0
CPU 16: governor  performance min/cur/max 2.4/1.889/2.4 GHz Turbo 0
CPU 3: governor  performance min/cur/max 2.4/2.337/2.4 GHz Turbo 0
CPU 4: governor  performance min/cur/max 2.4/1.528/2.4 GHz Turbo 0
CPU 7: governor  performance min/cur/max 2.4/2.173/2.4 GHz Turbo 0
CPU 8: governor  performance min/cur/max 2.4/2.152/2.4 GHz Turbo 0
CPU 9: governor  performance min/cur/max 2.4/2.010/2.4 GHz Turbo 0
CPU 13: governor  performance min/cur/max 2.4/1.879/2.4 GHz Turbo 0
CPU 14: governor  performance min/cur/max 2.4/1.590/2.4 GHz Turbo 0
CPU 17: governor  performance min/cur/max 2.4/1.173/2.4 GHz Turbo 0
CPU 18: governor  performance min/cur/max 2.4/1.498/2.4 GHz Turbo 0
CPU 19: governor  performance min/cur/max 2.4/2.245/2.4 GHz Turbo 0
CPU 20: governor  performance min/cur/max 2.4/2.007/2.4 GHz Turbo 0
CPU 21: governor  performance min/cur/max 2.4/1.894/2.4 GHz Turbo 0
CPU 22: governor  performance min/cur/max 2.4/1.328/2.4 GHz Turbo 0
CPU 25: governor  performance min/cur/max 2.4/2.060/2.4 GHz Turbo 0
CPU 26: governor  performance min/cur/max 2.4/2.302/2.4 GHz Turbo 0
CPU 30: governor  performance min/cur/max 2.4/1.459/2.4 GHz Turbo 0
CPU 31: governor  performance min/cur/max 2.4/1.560/2.4 GHz Turbo 0
CPU 32: governor  performance min/cur/max 2.4/2.107/2.4 GHz Turbo 0
CPU 35: governor  performance min/cur/max 2.4/2.265/2.4 GHz Turbo 0
CPU 36: governor  performance min/cur/max 2.4/1.891/2.4 GHz Turbo 0
CPU 23: governor  performance min/cur/max 2.4/1.874/2.4 GHz Turbo 0
CPU 24: governor  performance min/cur/max 2.4/2.106/2.4 GHz Turbo 0
CPU 27: governor  performance min/cur/max 2.4/2.055/2.4 GHz Turbo 0
CPU 28: governor  performance min/cur/max 2.4/2.149/2.4 GHz Turbo 0
CPU 29: governor  performance min/cur/max 2.4/1.599/2.4 GHz Turbo 0
CPU 33: governor  performance min/cur/max 2.4/1.765/2.4 GHz Turbo 0
CPU 34: governor  performance min/cur/max 2.4/1.914/2.4 GHz Turbo 0
CPU 37: governor  performance min/cur/max 2.4/1.502/2.4 GHz Turbo 0
CPU 38: governor  performance min/cur/max 2.4/1.285/2.4 GHz Turbo 0
CPU 39: governor  performance min/cur/max 2.4/1.747/2.4 GHz Turbo 0
CPU 40: governor  performance min/cur/max 2.4/2.025/2.4 GHz Turbo 0
CPU 41: governor  performance min/cur/max 2.4/1.578/2.4 GHz Turbo 0
CPU 42: governor  performance min/cur/max 2.4/2.273/2.4 GHz Turbo 0
CPU 45: governor  performance min/cur/max 2.4/1.839/2.4 GHz Turbo 0
CPU 46: governor  performance min/cur/max 2.4/2.229/2.4 GHz Turbo 0
CPU 50: governor  performance min/cur/max 2.4/1.980/2.4 GHz Turbo 0
CPU 51: governor  performance min/cur/max 2.4/1.840/2.4 GHz Turbo 0
CPU 52: governor  performance min/cur/max 2.4/1.789/2.4 GHz Turbo 0
CPU 55: governor  performance min/cur/max 2.4/2.295/2.4 GHz Turbo 0
CPU 56: governor  performance min/cur/max 2.4/2.224/2.4 GHz Turbo 0
CPU 43: governor  performance min/cur/max 2.4/1.670/2.4 GHz Turbo 0
CPU 44: governor  performance min/cur/max 2.4/2.142/2.4 GHz Turbo 0
CPU 47: governor  performance min/cur/max 2.4/2.285/2.4 GHz Turbo 0
CPU 48: governor  performance min/cur/max 2.4/1.968/2.4 GHz Turbo 0
CPU 49: governor  performance min/cur/max 2.4/1.763/2.4 GHz Turbo 0
CPU 53: governor  performance min/cur/max 2.4/1.676/2.4 GHz Turbo 0
CPU 54: governor  performance min/cur/max 2.4/2.041/2.4 GHz Turbo 0
CPU 57: governor  performance min/cur/max 2.4/1.672/2.4 GHz Turbo 0
CPU 58: governor  performance min/cur/max 2.4/2.211/2.4 GHz Turbo 0
CPU 59: governor  performance min/cur/max 2.4/2.072/2.4 GHz Turbo 0
CPU 60: governor  performance min/cur/max 2.4/2.100/2.4 GHz Turbo 0
CPU 61: governor  performance min/cur/max 2.4/1.967/2.4 GHz Turbo 0
CPU 62: governor  performance min/cur/max 2.4/2.179/2.4 GHz Turbo 0
CPU 65: governor  performance min/cur/max 2.4/2.084/2.4 GHz Turbo 0
CPU 66: governor  performance min/cur/max 2.4/1.995/2.4 GHz Turbo 0
CPU 70: governor  performance min/cur/max 2.4/2.121/2.4 GHz Turbo 0
CPU 71: governor  performance min/cur/max 2.4/1.839/2.4 GHz Turbo 0
CPU 72: governor  performance min/cur/max 2.4/2.159/2.4 GHz Turbo 0
CPU 75: governor  performance min/cur/max 2.4/2.219/2.4 GHz Turbo 0
CPU 76: governor  performance min/cur/max 2.4/2.073/2.4 GHz Turbo 0
CPU 63: governor  performance min/cur/max 2.4/1.991/2.4 GHz Turbo 0
CPU 64: governor  performance min/cur/max 2.4/2.170/2.4 GHz Turbo 0
CPU 67: governor  performance min/cur/max 2.4/1.925/2.4 GHz Turbo 0
CPU 68: governor  performance min/cur/max 2.4/2.293/2.4 GHz Turbo 0
CPU 69: governor  performance min/cur/max 2.4/2.285/2.4 GHz Turbo 0
CPU 73: governor  performance min/cur/max 2.4/1.947/2.4 GHz Turbo 0
CPU 74: governor  performance min/cur/max 2.4/1.185/2.4 GHz Turbo 0
CPU 77: governor  performance min/cur/max 2.4/1.376/2.4 GHz Turbo 0
CPU 78: governor  performance min/cur/max 2.4/1.928/2.4 GHz Turbo 0
CPU 79: governor  performance min/cur/max 2.4/1.312/2.4 GHz Turbo 0
...
Active(file):      49820 kB
Inactive(file):    74224 kB
Unevictable:           0 kB
Mlocked:               0 kB
SwapTotal:      49632252 kB
SwapFree:       49622780 kB
Dirty:               344 kB
Writeback:            12 kB
AnonPages:         41480 kB
Mapped:            87924 kB
Shmem:              1684 kB
Slab:             709892 kB
SReclaimable:     251204 kB
SUnreclaim:       458688 kB
...
PWD=/home/hpc/iwia/iwia84/INSPECT-repo/stencils/3D_r2_isotropic_star_constant/SkylakeSP_Gold-6148_SNC_20190423_133929
