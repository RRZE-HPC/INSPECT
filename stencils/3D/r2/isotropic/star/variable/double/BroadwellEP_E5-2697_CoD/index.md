...
--------------------------------------------------------------------------------------------------
| Cycles |  3.0     0.0  | 10.0  |  9.0     8.0  |  9.0     9.0  |  1.0  |  1.0  |  1.0  |  0.0  |
--------------------------------------------------------------------------------------------------
...
-----------------------------------------------------------------------------------------
|   1      |             |      | 1.0     1.0 |             |      |      |      |      | vmovupd ymm0, ymmword ptr [rax+rdx*8+0x8]
|   1      |             |      |             | 1.0     1.0 |      |      |      |      | vmovupd ymm7, ymmword ptr [rax+rdx*8]
|   1      |             |      | 1.0     1.0 |             |      |      |      |      | vmovupd ymm6, ymmword ptr [rax+rdx*8+0x10]
|   2      |             | 1.0  |             | 1.0     1.0 |      |      |      |      | vaddpd ymm1, ymm0, ymmword ptr [rax+rdx*8+0x18]
|   2      |             | 1.0  | 1.0     1.0 |             |      |      |      |      | vaddpd ymm8, ymm7, ymmword ptr [rax+rdx*8+0x20]
|   2      |             | 1.0  |             | 1.0     1.0 |      |      |      |      | vaddpd ymm2, ymm1, ymmword ptr [r13+rdx*8+0x10]
|   2      |             | 1.0  | 1.0     1.0 |             |      |      |      |      | vaddpd ymm9, ymm8, ymmword ptr [rbx+rdx*8+0x10]
|   2      |             | 1.0  |             | 1.0     1.0 |      |      |      |      | vaddpd ymm3, ymm2, ymmword ptr [r12+rdx*8+0x10]
|   2      |             | 1.0  | 1.0     1.0 |             |      |      |      |      | vaddpd ymm10, ymm9, ymmword ptr [rsi+rdx*8+0x10]
|   2      |             | 1.0  |             | 1.0     1.0 |      |      |      |      | vaddpd ymm4, ymm3, ymmword ptr [r15+rdx*8+0x10]
|   2      |             | 1.0  | 1.0     1.0 |             |      |      |      |      | vaddpd ymm11, ymm10, ymmword ptr [rdi+rdx*8+0x10]
|   2      |             | 1.0  |             | 1.0     1.0 |      |      |      |      | vaddpd ymm5, ymm4, ymmword ptr [r11+rdx*8+0x10]
|   2      |             | 1.0  | 1.0     1.0 |             |      |      |      |      | vaddpd ymm12, ymm11, ymmword ptr [r8+rdx*8+0x10]
|   2      | 1.0         |      |             | 1.0     1.0 |      |      |      |      | vmulpd ymm13, ymm5, ymmword ptr [r14+rdx*8+0x10]
|   2      | 1.0         |      | 1.0     1.0 |             |      |      |      |      | vfmadd231pd ymm13, ymm6, ymmword ptr [rcx+rdx*8+0x10]
|   2      | 1.0         |      |             | 1.0     1.0 |      |      |      |      | vfmadd231pd ymm13, ymm12, ymmword ptr [r10+rdx*8+0x10]
|   2      |             |      | 1.0         |             | 1.0  |      |      |      | vmovupd ymmword ptr [r9+rdx*8+0x10], ymm13
|   1      |             |      |             |             |      |      | 1.0  |      | add rdx, 0x4
|   2^     |             |      |             | 1.0     1.0 |      | 1.0  |      |      | cmp rdx, qword ptr [rsp+0x148]
|   0*F    |             |      |             |             |      |      |      |      | jb 0xffffffffffffff86
...
# Logged in users
################################################################################
 07:39:30 up 132 days, 15:11,  0 users,  load average: 0.57, 0.81, 0.95
...
CPU 0: governor  performance min/cur/max 2.3/1.463/2.3 GHz Turbo 0
CPU 1: governor  performance min/cur/max 2.3/1.219/2.3 GHz Turbo 0
CPU 2: governor  performance min/cur/max 2.3/2.241/2.3 GHz Turbo 0
CPU 3: governor  performance min/cur/max 2.3/1.844/2.3 GHz Turbo 0
CPU 4: governor  performance min/cur/max 2.3/1.758/2.3 GHz Turbo 0
CPU 5: governor  performance min/cur/max 2.3/2.294/2.3 GHz Turbo 0
CPU 6: governor  performance min/cur/max 2.3/1.483/2.3 GHz Turbo 0
CPU 7: governor  performance min/cur/max 2.3/1.233/2.3 GHz Turbo 0
CPU 8: governor  performance min/cur/max 2.3/2.219/2.3 GHz Turbo 0
CPU 9: governor  performance min/cur/max 2.3/2.121/2.3 GHz Turbo 0
CPU 10: governor  performance min/cur/max 2.3/1.990/2.3 GHz Turbo 0
CPU 11: governor  performance min/cur/max 2.3/2.270/2.3 GHz Turbo 0
CPU 12: governor  performance min/cur/max 2.3/1.793/2.3 GHz Turbo 0
CPU 13: governor  performance min/cur/max 2.3/2.254/2.3 GHz Turbo 0
CPU 14: governor  performance min/cur/max 2.3/2.256/2.3 GHz Turbo 0
CPU 15: governor  performance min/cur/max 2.3/1.701/2.3 GHz Turbo 0
CPU 16: governor  performance min/cur/max 2.3/1.558/2.3 GHz Turbo 0
CPU 17: governor  performance min/cur/max 2.3/2.207/2.3 GHz Turbo 0
CPU 18: governor  performance min/cur/max 2.3/2.276/2.3 GHz Turbo 0
CPU 19: governor  performance min/cur/max 2.3/2.287/2.3 GHz Turbo 0
CPU 20: governor  performance min/cur/max 2.3/2.288/2.3 GHz Turbo 0
CPU 21: governor  performance min/cur/max 2.3/2.290/2.3 GHz Turbo 0
CPU 22: governor  performance min/cur/max 2.3/2.295/2.3 GHz Turbo 0
CPU 23: governor  performance min/cur/max 2.3/2.292/2.3 GHz Turbo 0
CPU 24: governor  performance min/cur/max 2.3/2.296/2.3 GHz Turbo 0
...
CPU 27: governor  performance min/cur/max 2.3/2.294/2.3 GHz Turbo 0
CPU 28: governor  performance min/cur/max 2.3/2.247/2.3 GHz Turbo 0
CPU 29: governor  performance min/cur/max 2.3/2.293/2.3 GHz Turbo 0
CPU 30: governor  performance min/cur/max 2.3/2.266/2.3 GHz Turbo 0
...
CPU 33: governor  performance min/cur/max 2.3/2.231/2.3 GHz Turbo 0
CPU 34: governor  performance min/cur/max 2.3/2.210/2.3 GHz Turbo 0
CPU 35: governor  performance min/cur/max 2.3/2.297/2.3 GHz Turbo 0
CPU 36: governor  performance min/cur/max 2.3/2.055/2.3 GHz Turbo 0
CPU 37: governor  performance min/cur/max 2.3/1.327/2.3 GHz Turbo 0
CPU 38: governor  performance min/cur/max 2.3/1.503/2.3 GHz Turbo 0
CPU 39: governor  performance min/cur/max 2.3/1.199/2.3 GHz Turbo 0
CPU 40: governor  performance min/cur/max 2.3/1.221/2.3 GHz Turbo 0
CPU 41: governor  performance min/cur/max 2.3/1.545/2.3 GHz Turbo 0
CPU 42: governor  performance min/cur/max 2.3/1.323/2.3 GHz Turbo 0
CPU 43: governor  performance min/cur/max 2.3/1.922/2.3 GHz Turbo 0
CPU 44: governor  performance min/cur/max 2.3/2.257/2.3 GHz Turbo 0
CPU 45: governor  performance min/cur/max 2.3/2.174/2.3 GHz Turbo 0
CPU 46: governor  performance min/cur/max 2.3/1.816/2.3 GHz Turbo 0
CPU 47: governor  performance min/cur/max 2.3/2.226/2.3 GHz Turbo 0
CPU 48: governor  performance min/cur/max 2.3/1.813/2.3 GHz Turbo 0
CPU 49: governor  performance min/cur/max 2.3/1.268/2.3 GHz Turbo 0
CPU 50: governor  performance min/cur/max 2.3/2.256/2.3 GHz Turbo 0
CPU 51: governor  performance min/cur/max 2.3/2.258/2.3 GHz Turbo 0
CPU 52: governor  performance min/cur/max 2.3/1.785/2.3 GHz Turbo 0
CPU 53: governor  performance min/cur/max 2.3/2.228/2.3 GHz Turbo 0
CPU 54: governor  performance min/cur/max 2.3/2.263/2.3 GHz Turbo 0
...
CPU 64: governor  performance min/cur/max 2.3/2.252/2.3 GHz Turbo 0
CPU 65: governor  performance min/cur/max 2.3/2.283/2.3 GHz Turbo 0
CPU 66: governor  performance min/cur/max 2.3/2.230/2.3 GHz Turbo 0
CPU 67: governor  performance min/cur/max 2.3/2.297/2.3 GHz Turbo 0
CPU 68: governor  performance min/cur/max 2.3/2.259/2.3 GHz Turbo 0
CPU 69: governor  performance min/cur/max 2.3/2.280/2.3 GHz Turbo 0
CPU 70: governor  performance min/cur/max 2.3/2.272/2.3 GHz Turbo 0
CPU 71: governor  performance min/cur/max 2.3/2.285/2.3 GHz Turbo 0
...
MemFree:        129383892 kB
MemAvailable:   129621440 kB
Buffers:          234168 kB
Cached:           604396 kB
SwapCached:         5028 kB
Active:           613044 kB
...
Shmem:               384 kB
Slab:             826280 kB
SReclaimable:     403732 kB
SUnreclaim:       422548 kB
...
OLDPWD=/home/hpc/iwia/iwia84/INSPECT-repo/stencils/3D_r2_point-symmetric_star_constant/BroadwellEP_E5-2697_CoD_20190424_025436
...
PWD=/home/hpc/iwia/iwia84/INSPECT-repo/stencils/3D_r2_isotropic_star_variable/BroadwellEP_E5-2697_CoD_20190424_073930
