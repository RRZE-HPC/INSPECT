...
--------------------------
Block Throughput: 19.58 Cycles       Throughput Bottleneck: Backend
Loop Count:  22
Port Binding In Cycles Per Iteration:
--------------------------------------------------------------------------------------------------
|  Port  |   0   -  DV   |   1   |   2   -  D    |   3   -  D    |   4   |   5   |   6   |   7   |
--------------------------------------------------------------------------------------------------
| Cycles |  8.5     0.0  |  8.5  | 19.5    19.1  | 19.5    18.9  |  1.0  |  1.0  |  1.0  |  0.0  |
--------------------------------------------------------------------------------------------------
...
-----------------------------------------------------------------------------------------
|   1      |             |      | 0.5     0.5 | 0.5     0.5 |      |      |      |      | mov rdi, qword ptr [rsp+0x230]
|   1      |             |      | 0.5     0.5 | 0.5     0.5 |      |      |      |      | vmovupd ymm8, ymmword ptr [r13+r14*8+0x10]
|   1      |             |      | 0.5     0.5 | 0.5     0.5 |      |      |      |      | vmovupd ymm0, ymmword ptr [r15+r14*8+0x10]
|   1      |             |      | 0.5     0.5 | 0.5     0.5 |      |      |      |      | vmovupd ymm3, ymmword ptr [rdi+r14*8+0x10]
|   1      |             |      | 0.5     0.5 | 0.5     0.5 |      |      |      |      | vmovupd ymm9, ymmword ptr [rsi+r14*8+0x10]
|   1      |             |      | 0.5     0.5 | 0.5     0.5 |      |      |      |      | vmovupd ymm2, ymmword ptr [r9+r14*8+0x10]
|   2      | 1.0         |      | 0.5     0.5 | 0.5     0.5 |      |      |      |      | vmulpd ymm12, ymm8, ymmword ptr [rax+r14*8+0x10]
|   1      |             |      | 0.5     0.5 | 0.5     0.5 |      |      |      |      | vmovupd ymm10, ymmword ptr [rcx+r14*8+0x10]
|   1      |             |      | 0.5     0.5 | 0.5     0.5 |      |      |      |      | vmovupd ymm4, ymmword ptr [r8+r14*8+0x18]
|   1      |             |      | 0.5     0.5 | 0.5     0.5 |      |      |      |      | vmovupd ymm11, ymmword ptr [r11+r14*8+0x10]
|   1      |             |      | 0.5     0.5 | 0.5     0.5 |      |      |      |      | vmovupd ymm5, ymmword ptr [r8+r14*8+0x8]
|   1      |             |      | 0.5     0.5 | 0.5     0.5 |      |      |      |      | vmovupd ymm6, ymmword ptr [r8+r14*8+0x10]
|   2      | 0.5         | 0.5  | 0.5     0.5 | 0.5     0.5 |      |      |      |      | vmulpd ymm13, ymm10, ymmword ptr [r10+r14*8+0x10]
|   1      |             |      | 0.5     0.5 | 0.5     0.5 |      |      |      |      | mov rdi, qword ptr [rsp+0x228]
|   2      | 0.5         | 0.5  | 0.5     0.5 | 0.5     0.5 |      |      |      |      | vfmadd231pd ymm13, ymm11, ymmword ptr [r12+r14*8+0x10]
|   1      |             |      | 0.5     0.5 | 0.5     0.5 |      |      |      |      | vmovupd ymm7, ymmword ptr [rdi+r14*8+0x10]
|   1      |             |      | 0.5     0.5 | 0.5     0.5 |      |      |      |      | mov rdi, qword ptr [rsp+0x208]
|   1      |             |      | 0.5     0.5 | 0.5     0.5 |      |      |      |      | vmovupd ymm14, ymmword ptr [rdi+r14*8+0x10]
|   1      |             |      | 0.5     0.5 | 0.5     0.5 |      |      |      |      | mov rdi, qword ptr [rsp+0x280]
|   2      | 0.5         | 0.5  | 0.5     0.5 | 0.5     0.5 |      |      |      |      | vmulpd ymm15, ymm14, ymmword ptr [r8+r14*8]
|   1      |             |      | 0.5     0.5 | 0.5     0.5 |      |      |      |      | vmovupd ymm1, ymmword ptr [rdi+r14*8+0x10]
|   2      | 0.5         | 0.5  | 0.5     0.5 | 0.5     0.5 |      |      |      |      | vfmadd231pd ymm15, ymm0, ymmword ptr [rbx+r14*8+0x10]
|   2      | 0.5         | 0.5  | 0.5     0.5 | 0.5     0.5 |      |      |      |      | vmulpd ymm0, ymm1, ymmword ptr [r8+r14*8+0x20]
|   1      |             |      | 0.5     0.5 | 0.5     0.5 |      |      |      |      | mov rdi, qword ptr [rsp+0x220]
|   2      | 0.5         | 0.5  | 0.5     0.5 | 0.5     0.5 |      |      |      |      | vfmadd231pd ymm12, ymm9, ymmword ptr [rdi+r14*8+0x10]
|   1      |             |      | 0.5     0.5 | 0.5     0.5 |      |      |      |      | mov rdi, qword ptr [rsp+0x200]
|   1      |             | 1.0  |             |             |      |      |      |      | vaddpd ymm8, ymm12, ymm13
|   2      | 1.0         |      | 0.5     0.5 | 0.5     0.5 |      |      |      |      | vfmadd231pd ymm0, ymm2, ymmword ptr [rdi+r14*8+0x10]
|   1      |             |      | 0.5     0.5 | 0.5     0.5 |      |      |      |      | mov rdi, qword ptr [rsp+0x268]
|   1      |             | 1.0  |             |             |      |      |      |      | vaddpd ymm1, ymm15, ymm0
|   2      | 1.0         |      | 0.5     0.5 | 0.5     0.5 |      |      |      |      | vmulpd ymm2, ymm7, ymmword ptr [rdi+r14*8+0x10]
|   1      |             |      | 0.5     0.5 | 0.5     0.5 |      |      |      |      | mov rdi, qword ptr [rsp+0x270]
|   2      | 0.5         | 0.5  | 0.5     0.5 | 0.5     0.5 |      |      |      |      | vfmadd231pd ymm2, ymm3, ymmword ptr [rdi+r14*8+0x10]
|   1      |             | 1.0  |             |             |      |      |      |      | vaddpd ymm3, ymm8, ymm1
|   1      |             |      | 0.5     0.5 | 0.5     0.5 |      |      |      |      | mov rdi, qword ptr [rsp+0x278]
|   2      | 1.0         |      | 0.5     0.5 | 0.5     0.5 |      |      |      |      | vfmadd231pd ymm2, ymm4, ymmword ptr [rdi+r14*8+0x10]
|   1      |             |      | 0.5     0.5 | 0.5     0.5 |      |      |      |      | mov rdi, qword ptr [rsp+0x260]
|   2      | 0.5         | 0.5  | 0.5     0.5 | 0.5     0.5 |      |      |      |      | vfmadd231pd ymm2, ymm5, ymmword ptr [rdi+r14*8+0x10]
|   1      |             |      | 0.5     0.5 | 0.5     0.5 |      |      |      |      | mov rdi, qword ptr [rsp+0x210]
|   2      | 0.5         | 0.5  | 0.5     0.5 | 0.5     0.5 |      |      |      |      | vfmadd231pd ymm2, ymm6, ymmword ptr [rdi+r14*8+0x10]
|   1      |             | 1.0  |             |             |      |      |      |      | vaddpd ymm4, ymm3, ymm2
|   2      |             |      | 0.5         | 0.5         | 1.0  |      |      |      | vmovupd ymmword ptr [rdx+r14*8+0x10], ymm4
|   1      |             |      |             |             |      |      | 1.0  |      | add r14, 0x4
|   2^     |             |      | 0.5     0.5 | 0.5     0.5 |      | 1.0  |      |      | cmp r14, qword ptr [rsp+0x1f0]
|   0*F    |             |      |             |             |      |      |      |      | jb 0xfffffffffffffecf
...
# Logged in users
################################################################################
 05:22:01 up 27 days, 16:25,  0 users,  load average: 0.59, 0.81, 0.96
...
CPU 0: governor  performance min/cur/max 2.3/1.288/2.3 GHz Turbo 0
CPU 1: governor  performance min/cur/max 2.3/1.461/2.3 GHz Turbo 0
CPU 2: governor  performance min/cur/max 2.3/2.301/2.3 GHz Turbo 0
CPU 3: governor  performance min/cur/max 2.3/1.312/2.3 GHz Turbo 0
CPU 4: governor  performance min/cur/max 2.3/1.398/2.3 GHz Turbo 0
CPU 5: governor  performance min/cur/max 2.3/1.741/2.3 GHz Turbo 0
CPU 6: governor  performance min/cur/max 2.3/1.440/2.3 GHz Turbo 0
CPU 7: governor  performance min/cur/max 2.3/1.538/2.3 GHz Turbo 0
CPU 8: governor  performance min/cur/max 2.3/1.445/2.3 GHz Turbo 0
CPU 9: governor  performance min/cur/max 2.3/1.400/2.3 GHz Turbo 0
CPU 10: governor  performance min/cur/max 2.3/1.837/2.3 GHz Turbo 0
CPU 11: governor  performance min/cur/max 2.3/1.543/2.3 GHz Turbo 0
CPU 12: governor  performance min/cur/max 2.3/1.836/2.3 GHz Turbo 0
CPU 13: governor  performance min/cur/max 2.3/1.463/2.3 GHz Turbo 0
CPU 14: governor  performance min/cur/max 2.3/2.280/2.3 GHz Turbo 0
CPU 15: governor  performance min/cur/max 2.3/2.296/2.3 GHz Turbo 0
CPU 16: governor  performance min/cur/max 2.3/2.288/2.3 GHz Turbo 0
CPU 17: governor  performance min/cur/max 2.3/2.123/2.3 GHz Turbo 0
CPU 18: governor  performance min/cur/max 2.3/2.262/2.3 GHz Turbo 0
CPU 19: governor  performance min/cur/max 2.3/2.300/2.3 GHz Turbo 0
...
CPU 26: governor  performance min/cur/max 2.3/2.171/2.3 GHz Turbo 0
CPU 27: governor  performance min/cur/max 2.3/2.300/2.3 GHz Turbo 0
CPU 28: governor  performance min/cur/max 2.3/1.578/2.3 GHz Turbo 0
CPU 29: governor  performance min/cur/max 2.3/1.464/2.3 GHz Turbo 0
CPU 30: governor  performance min/cur/max 2.3/2.303/2.3 GHz Turbo 0
CPU 31: governor  performance min/cur/max 2.3/1.356/2.3 GHz Turbo 0
CPU 32: governor  performance min/cur/max 2.3/1.281/2.3 GHz Turbo 0
CPU 33: governor  performance min/cur/max 2.3/1.770/2.3 GHz Turbo 0
CPU 34: governor  performance min/cur/max 2.3/1.318/2.3 GHz Turbo 0
CPU 35: governor  performance min/cur/max 2.3/1.362/2.3 GHz Turbo 0
CPU 36: governor  performance min/cur/max 2.3/1.761/2.3 GHz Turbo 0
CPU 37: governor  performance min/cur/max 2.3/1.444/2.3 GHz Turbo 0
CPU 38: governor  performance min/cur/max 2.3/1.757/2.3 GHz Turbo 0
CPU 39: governor  performance min/cur/max 2.3/1.728/2.3 GHz Turbo 0
CPU 40: governor  performance min/cur/max 2.3/1.573/2.3 GHz Turbo 0
CPU 41: governor  performance min/cur/max 2.3/1.750/2.3 GHz Turbo 0
CPU 42: governor  performance min/cur/max 2.3/2.274/2.3 GHz Turbo 0
CPU 43: governor  performance min/cur/max 2.3/2.138/2.3 GHz Turbo 0
CPU 44: governor  performance min/cur/max 2.3/2.298/2.3 GHz Turbo 0
CPU 45: governor  performance min/cur/max 2.3/2.299/2.3 GHz Turbo 0
CPU 46: governor  performance min/cur/max 2.3/2.269/2.3 GHz Turbo 0
CPU 47: governor  performance min/cur/max 2.3/2.200/2.3 GHz Turbo 0
CPU 48: governor  performance min/cur/max 2.3/2.289/2.3 GHz Turbo 0
CPU 49: governor  performance min/cur/max 2.3/2.223/2.3 GHz Turbo 0
CPU 50: governor  performance min/cur/max 2.3/2.250/2.3 GHz Turbo 0
...
CPU 54: governor  performance min/cur/max 2.3/2.301/2.3 GHz Turbo 0
CPU 55: governor  performance min/cur/max 2.3/2.308/2.3 GHz Turbo 0
...
MemFree:        64018696 kB
MemAvailable:   64489088 kB
Buffers:          126756 kB
Cached:           760068 kB
SwapCached:           24 kB
Active:           594000 kB
Inactive:         339456 kB
Active(anon):      43832 kB
Inactive(anon):    10856 kB
Active(file):     550168 kB
Inactive(file):   328600 kB
Unevictable:           0 kB
Mlocked:               0 kB
SwapTotal:      31998972 kB
SwapFree:       31992572 kB
Dirty:               204 kB
Writeback:             0 kB
AnonPages:         46536 kB
Mapped:            72752 kB
Shmem:              8128 kB
Slab:             556000 kB
SReclaimable:     262976 kB
SUnreclaim:       293024 kB
...
DirectMap4k:      543872 kB
DirectMap2M:    23463936 kB
...
OLDPWD=/home/hpc/iwia/iwia84/INSPECT-repo/stencils/3D_r2_isotropic_star_variable/HaswellEP_E5-2695v3_CoD_20190424_025020
...
PBS_NODEFILE=/var/spool/pbspro/aux/3116.catstor
GROUP=iwia
PBS_TASKNUM=1
LIKWID_DEFINES=-DLIKWID_PERFMON
PWD=/home/hpc/iwia/iwia84/INSPECT-repo/stencils/3D_r2_heterogeneous_star_variable/HaswellEP_E5-2695v3_CoD_20190424_052200
...
PBS_JOBCOOKIE=68A2786679F5749D377672BA16A6A1AB
...
LESS_TERMCAP_me=[0m
TMPDIR=/scratch/pbs.3116.catstor
