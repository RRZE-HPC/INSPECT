...
title:  "Stencil 3D r2 star constant heterogeneous double SkylakeSP_Gold-6148_SNC"
...
--------------------------
Block Throughput: 12.37 Cycles       Throughput Bottleneck: Backend
Loop Count:  22
Port Binding In Cycles Per Iteration:
--------------------------------------------------------------------------------------------------
|  Port  |   0   -  DV   |   1   |   2   -  D    |   3   -  D    |   4   |   5   |   6   |   7   |
--------------------------------------------------------------------------------------------------
| Cycles | 10.7     0.0  | 10.7  |  7.0     7.0  |  7.0     6.0  |  1.0  | 10.6  |  1.0  |  0.0  |
--------------------------------------------------------------------------------------------------
...
-----------------------------------------------------------------------------------------
|   1      |             |      |             |             |      | 1.0  |      |      | vpcmpgtq k1, ymm9, ymm8
|   1      |             |      |             |             |      | 1.0  |      |      | vpaddq ymm8, ymm8, ymm18
|   2      |             |      | 1.0     1.0 |             |      | 1.0  |      |      | vmovupd ymm7{k1}{z}, ymmword ptr [rsi+r15*8+0x10]
|   2      |             |      |             | 1.0     1.0 |      | 1.0  |      |      | vmovupd ymm3{k1}{z}, ymmword ptr [r8+r15*8+0x10]
|   2      |             |      | 1.0     1.0 |             |      | 1.0  |      |      | vmovupd ymm0{k1}{z}, ymmword ptr [rdi+r15*8]
|   2      |             | 0.4  |             | 1.0     1.0 |      | 0.6  |      |      | vmovupd ymm1{k1}{z}, ymmword ptr [rdi+r15*8+0x20]
|   2      | 0.3         | 0.3  | 1.0     1.0 |             |      | 0.4  |      |      | vmovupd ymm26{k1}{z}, ymmword ptr [r11+r15*8+0x10]
|   1      | 0.7         | 0.3  |             |             |      |      |      |      | vmulpd ymm7, ymm24, ymm7
|   2      |             | 0.4  |             | 1.0     1.0 |      | 0.6  |      |      | vmovupd ymm28{k1}{z}, ymmword ptr [rdx+r15*8+0x10]
|   2      | 0.3         | 0.3  | 1.0     1.0 |             |      | 0.4  |      |      | vmovupd ymm4{k1}{z}, ymmword ptr [rdi+r15*8+0x18]
|   2      | 0.4         | 0.3  |             | 1.0     1.0 |      | 0.3  |      |      | vmovupd ymm10{k1}{z}, ymmword ptr [r9+r15*8+0x10]
|   2      | 0.3         | 0.4  | 1.0     1.0 |             |      | 0.3  |      |      | vmovupd ymm2{k1}{z}, ymmword ptr [rbx+r15*8+0x10]
|   1      | 0.7         | 0.3  |             |             |      |      |      |      | vfmadd231pd ymm7, ymm3, ymm23
|   2      |             | 0.3  |             | 1.0     1.0 |      | 0.7  |      |      | vmovupd ymm27{k1}{z}, ymmword ptr [r10+r15*8+0x10]
|   2      | 0.3         | 0.4  | 1.0     1.0 |             |      | 0.3  |      |      | vmovupd ymm29{k1}{z}, ymmword ptr [rcx+r15*8+0x10]
|   1      | 0.7         | 0.3  |             |             |      |      |      |      | vmulpd ymm30, ymm12, ymm26
|   1      | 0.3         | 0.7  |             |             |      |      |      |      | vmulpd ymm31, ymm11, ymm28
|   1      | 0.7         | 0.3  |             |             |      |      |      |      | vmulpd ymm0, ymm16, ymm0
|   1      | 0.3         | 0.7  |             |             |      |      |      |      | vmulpd ymm1, ymm15, ymm1
|   2      |             |      |             | 1.0     1.0 |      | 1.0  |      |      | vmovupd ymm5{k1}{z}, ymmword ptr [rdi+r15*8+0x8]
|   1      | 0.7         | 0.3  |             |             |      |      |      |      | vfmadd231pd ymm7, ymm4, ymm22
|   1      | 0.3         | 0.7  |             |             |      |      |      |      | vfmadd231pd ymm30, ymm27, ymm14
|   1      | 0.7         | 0.3  |             |             |      |      |      |      | vfmadd231pd ymm31, ymm29, ymm13
|   1      | 0.3         | 0.7  |             |             |      |      |      |      | vfmadd231pd ymm0, ymm10, ymm25
|   1      | 0.7         | 0.3  |             |             |      |      |      |      | vfmadd231pd ymm1, ymm2, ymm17
|   2      |             |      | 1.0     1.0 |             |      | 1.0  |      |      | vmovupd ymm6{k1}{z}, ymmword ptr [rdi+r15*8+0x10]
|   1      | 0.3         | 0.7  |             |             |      |      |      |      | vfmadd231pd ymm7, ymm5, ymm21
|   1      | 0.7         | 0.3  |             |             |      |      |      |      | vaddpd ymm26, ymm30, ymm31
|   1      | 0.3         | 0.7  |             |             |      |      |      |      | vaddpd ymm2, ymm0, ymm1
|   1      | 0.7         | 0.3  |             |             |      |      |      |      | vfmadd231pd ymm7, ymm6, ymm20
|   1      | 0.3         | 0.7  |             |             |      |      |      |      | vaddpd ymm3, ymm26, ymm2
|   1      | 0.7         | 0.3  |             |             |      |      |      |      | vaddpd ymm4, ymm3, ymm7
|   2      |             |      |             | 1.0         | 1.0  |      |      |      | vmovupd ymmword ptr [rax+r15*8+0x10]{k1}, ymm4
|   1      |             |      |             |             |      |      | 1.0  |      | add r15, 0x4
|   1*     |             |      |             |             |      |      |      |      | cmp r15, r12
|   0*F    |             |      |             |             |      |      |      |      | jb 0xfffffffffffffefa
...
# Logged in users
################################################################################
 18:29:11 up 17 days,  4:23,  0 users,  load average: 0.52, 0.81, 0.93
...
CPU 0: governor  performance min/cur/max 2.4/1.350/2.4 GHz Turbo 0
CPU 1: governor  performance min/cur/max 2.4/1.645/2.4 GHz Turbo 0
CPU 2: governor  performance min/cur/max 2.4/2.088/2.4 GHz Turbo 0
CPU 5: governor  performance min/cur/max 2.4/2.340/2.4 GHz Turbo 0
CPU 6: governor  performance min/cur/max 2.4/2.093/2.4 GHz Turbo 0
CPU 10: governor  performance min/cur/max 2.4/1.752/2.4 GHz Turbo 0
CPU 11: governor  performance min/cur/max 2.4/2.094/2.4 GHz Turbo 0
CPU 12: governor  performance min/cur/max 2.4/1.961/2.4 GHz Turbo 0
CPU 15: governor  performance min/cur/max 2.4/1.409/2.4 GHz Turbo 0
CPU 16: governor  performance min/cur/max 2.4/1.514/2.4 GHz Turbo 0
CPU 3: governor  performance min/cur/max 2.4/1.929/2.4 GHz Turbo 0
CPU 4: governor  performance min/cur/max 2.4/1.382/2.4 GHz Turbo 0
CPU 7: governor  performance min/cur/max 2.4/1.723/2.4 GHz Turbo 0
CPU 8: governor  performance min/cur/max 2.4/2.163/2.4 GHz Turbo 0
CPU 9: governor  performance min/cur/max 2.4/1.904/2.4 GHz Turbo 0
CPU 13: governor  performance min/cur/max 2.4/1.728/2.4 GHz Turbo 0
CPU 14: governor  performance min/cur/max 2.4/1.787/2.4 GHz Turbo 0
CPU 17: governor  performance min/cur/max 2.4/1.994/2.4 GHz Turbo 0
CPU 18: governor  performance min/cur/max 2.4/1.882/2.4 GHz Turbo 0
CPU 19: governor  performance min/cur/max 2.4/1.904/2.4 GHz Turbo 0
CPU 20: governor  performance min/cur/max 2.4/1.996/2.4 GHz Turbo 0
CPU 21: governor  performance min/cur/max 2.4/2.208/2.4 GHz Turbo 0
CPU 22: governor  performance min/cur/max 2.4/2.018/2.4 GHz Turbo 0
CPU 25: governor  performance min/cur/max 2.4/1.297/2.4 GHz Turbo 0
CPU 26: governor  performance min/cur/max 2.4/2.347/2.4 GHz Turbo 0
CPU 30: governor  performance min/cur/max 2.4/1.926/2.4 GHz Turbo 0
CPU 31: governor  performance min/cur/max 2.4/1.445/2.4 GHz Turbo 0
CPU 32: governor  performance min/cur/max 2.4/1.295/2.4 GHz Turbo 0
CPU 35: governor  performance min/cur/max 2.4/1.208/2.4 GHz Turbo 0
CPU 36: governor  performance min/cur/max 2.4/1.997/2.4 GHz Turbo 0
CPU 23: governor  performance min/cur/max 2.4/1.542/2.4 GHz Turbo 0
CPU 24: governor  performance min/cur/max 2.4/2.126/2.4 GHz Turbo 0
CPU 27: governor  performance min/cur/max 2.4/2.200/2.4 GHz Turbo 0
CPU 28: governor  performance min/cur/max 2.4/1.864/2.4 GHz Turbo 0
CPU 29: governor  performance min/cur/max 2.4/2.114/2.4 GHz Turbo 0
CPU 33: governor  performance min/cur/max 2.4/1.368/2.4 GHz Turbo 0
CPU 34: governor  performance min/cur/max 2.4/2.202/2.4 GHz Turbo 0
CPU 37: governor  performance min/cur/max 2.4/1.873/2.4 GHz Turbo 0
CPU 38: governor  performance min/cur/max 2.4/1.885/2.4 GHz Turbo 0
CPU 39: governor  performance min/cur/max 2.4/2.400/2.4 GHz Turbo 0
CPU 40: governor  performance min/cur/max 2.4/1.980/2.4 GHz Turbo 0
CPU 41: governor  performance min/cur/max 2.4/2.056/2.4 GHz Turbo 0
CPU 42: governor  performance min/cur/max 2.4/1.724/2.4 GHz Turbo 0
CPU 45: governor  performance min/cur/max 2.4/2.104/2.4 GHz Turbo 0
CPU 46: governor  performance min/cur/max 2.4/1.530/2.4 GHz Turbo 0
CPU 50: governor  performance min/cur/max 2.4/1.949/2.4 GHz Turbo 0
CPU 51: governor  performance min/cur/max 2.4/2.146/2.4 GHz Turbo 0
CPU 52: governor  performance min/cur/max 2.4/2.213/2.4 GHz Turbo 0
CPU 55: governor  performance min/cur/max 2.4/2.211/2.4 GHz Turbo 0
CPU 56: governor  performance min/cur/max 2.4/1.890/2.4 GHz Turbo 0
CPU 43: governor  performance min/cur/max 2.4/1.638/2.4 GHz Turbo 0
CPU 44: governor  performance min/cur/max 2.4/2.046/2.4 GHz Turbo 0
CPU 47: governor  performance min/cur/max 2.4/2.165/2.4 GHz Turbo 0
CPU 48: governor  performance min/cur/max 2.4/2.111/2.4 GHz Turbo 0
CPU 49: governor  performance min/cur/max 2.4/1.694/2.4 GHz Turbo 0
CPU 53: governor  performance min/cur/max 2.4/1.683/2.4 GHz Turbo 0
CPU 54: governor  performance min/cur/max 2.4/2.329/2.4 GHz Turbo 0
CPU 57: governor  performance min/cur/max 2.4/1.947/2.4 GHz Turbo 0
CPU 58: governor  performance min/cur/max 2.4/1.506/2.4 GHz Turbo 0
CPU 59: governor  performance min/cur/max 2.4/1.499/2.4 GHz Turbo 0
CPU 60: governor  performance min/cur/max 2.4/2.001/2.4 GHz Turbo 0
CPU 61: governor  performance min/cur/max 2.4/1.677/2.4 GHz Turbo 0
CPU 62: governor  performance min/cur/max 2.4/2.312/2.4 GHz Turbo 0
CPU 65: governor  performance min/cur/max 2.4/1.290/2.4 GHz Turbo 0
CPU 66: governor  performance min/cur/max 2.4/2.359/2.4 GHz Turbo 0
CPU 70: governor  performance min/cur/max 2.4/1.568/2.4 GHz Turbo 0
CPU 71: governor  performance min/cur/max 2.4/1.943/2.4 GHz Turbo 0
CPU 72: governor  performance min/cur/max 2.4/1.790/2.4 GHz Turbo 0
CPU 75: governor  performance min/cur/max 2.4/1.877/2.4 GHz Turbo 0
CPU 76: governor  performance min/cur/max 2.4/2.115/2.4 GHz Turbo 0
CPU 63: governor  performance min/cur/max 2.4/1.914/2.4 GHz Turbo 0
CPU 64: governor  performance min/cur/max 2.4/2.257/2.4 GHz Turbo 0
CPU 67: governor  performance min/cur/max 2.4/2.029/2.4 GHz Turbo 0
CPU 68: governor  performance min/cur/max 2.4/1.982/2.4 GHz Turbo 0
CPU 69: governor  performance min/cur/max 2.4/1.910/2.4 GHz Turbo 0
CPU 73: governor  performance min/cur/max 2.4/1.688/2.4 GHz Turbo 0
CPU 74: governor  performance min/cur/max 2.4/1.412/2.4 GHz Turbo 0
CPU 77: governor  performance min/cur/max 2.4/1.750/2.4 GHz Turbo 0
CPU 78: governor  performance min/cur/max 2.4/1.859/2.4 GHz Turbo 0
CPU 79: governor  performance min/cur/max 2.4/1.573/2.4 GHz Turbo 0
...
MemFree:        95599796 kB
MemAvailable:   95620104 kB
Buffers:           26312 kB
Cached:           526332 kB
SwapCached:          352 kB
Active:           406632 kB
Inactive:         188584 kB
Active(anon):      34680 kB
Inactive(anon):     9560 kB
Active(file):     371952 kB
Inactive(file):   179024 kB
Unevictable:           0 kB
Mlocked:               0 kB
...
OLDPWD=/home/hpc/iwia/iwia84/INSPECT-repo/stencils/3D_r2_isotropic_star_constant/SkylakeSP_Gold-6148_SNC_20190423_133929
...
PWD=/home/hpc/iwia/iwia84/INSPECT-repo/stencils/3D_r2_heterogeneous_star_constant/SkylakeSP_Gold-6148_SNC_20190423_182911
