...
--------------------------
Block Throughput: 8.74 Cycles       Throughput Bottleneck: Backend
Loop Count:  22
Port Binding In Cycles Per Iteration:
--------------------------------------------------------------------------------------------------
|  Port  |   0   -  DV   |   1   |   2   -  D    |   3   -  D    |   4   |   5   |   6   |   7   |
--------------------------------------------------------------------------------------------------
| Cycles |  8.5     0.0  |  8.5  |  7.0     7.0  |  7.0     6.0  |  1.0  |  0.5  |  0.5  |  0.0  |
--------------------------------------------------------------------------------------------------
...
-----------------------------------------------------------------------------------------
|   2      | 1.0         |      | 1.0     1.0 |             |      |      |      |      | vmulpd ymm14, ymm2, ymmword ptr [rsi+r9*8+0x10]
|   2      | 0.5         | 0.5  |             | 1.0     1.0 |      |      |      |      | vmulpd ymm15, ymm1, ymmword ptr [rdi+r9*8+0x10]
|   2      | 0.5         | 0.5  | 1.0     1.0 |             |      |      |      |      | vfmadd231pd ymm14, ymm4, ymmword ptr [r11+r9*8+0x10]
|   2      | 0.5         | 0.5  |             | 1.0     1.0 |      |      |      |      | vfmadd231pd ymm15, ymm3, ymmword ptr [r15+r9*8+0x10]
|   1      |             | 1.0  |             |             |      |      |      |      | vaddpd ymm0, ymm14, ymm15
|   2      | 1.0         |      | 1.0     1.0 |             |      |      |      |      | vmulpd ymm14, ymm6, ymmword ptr [rax+r9*8]
|   2      | 0.5         | 0.5  |             | 1.0     1.0 |      |      |      |      | vmulpd ymm15, ymm5, ymmword ptr [rax+r9*8+0x20]
|   2      | 0.5         | 0.5  | 1.0     1.0 |             |      |      |      |      | vfmadd231pd ymm14, ymm8, ymmword ptr [r13+r9*8+0x10]
|   2      | 0.5         | 0.5  |             | 1.0     1.0 |      |      |      |      | vfmadd231pd ymm15, ymm7, ymmword ptr [r12+r9*8+0x10]
|   1      |             | 1.0  |             |             |      |      |      |      | vaddpd ymm14, ymm14, ymm15
|   1      |             | 1.0  |             |             |      |      |      |      | vaddpd ymm0, ymm0, ymm14
|   2      | 1.0         |      | 1.0     1.0 |             |      |      |      |      | vmulpd ymm14, ymm9, ymmword ptr [r14+r9*8+0x10]
|   2      | 1.0         |      |             | 1.0     1.0 |      |      |      |      | vfmadd231pd ymm14, ymm10, ymmword ptr [r10+r9*8+0x10]
|   2      | 0.5         | 0.5  | 1.0     1.0 |             |      |      |      |      | vfmadd231pd ymm14, ymm11, ymmword ptr [rax+r9*8+0x18]
|   2      | 0.5         | 0.5  |             | 1.0     1.0 |      |      |      |      | vfmadd231pd ymm14, ymm12, ymmword ptr [rax+r9*8+0x8]
|   2      | 0.5         | 0.5  | 1.0     1.0 |             |      |      |      |      | vfmadd231pd ymm14, ymm13, ymmword ptr [rax+r9*8+0x10]
|   1      |             | 1.0  |             |             |      |      |      |      | vaddpd ymm0, ymm0, ymm14
|   2      |             |      |             | 1.0         | 1.0  |      |      |      | vmovupd ymmword ptr [r8+r9*8+0x10], ymm0
|   1      |             |      |             |             |      | 0.5  | 0.5  |      | add r9, 0x4
|   1*     |             |      |             |             |      |      |      |      | cmp r9, rdx
|   0*F    |             |      |             |             |      |      |      |      | jb 0xffffffffffffff84
...
# Logged in users
################################################################################
 17:23:51 up 132 days, 55 min,  0 users,  load average: 0.59, 0.86, 0.96
...
CPU 0: governor  performance min/cur/max 2.3/1.480/2.3 GHz Turbo 0
CPU 1: governor  performance min/cur/max 2.3/1.751/2.3 GHz Turbo 0
CPU 2: governor  performance min/cur/max 2.3/1.625/2.3 GHz Turbo 0
CPU 3: governor  performance min/cur/max 2.3/1.331/2.3 GHz Turbo 0
CPU 4: governor  performance min/cur/max 2.3/2.141/2.3 GHz Turbo 0
CPU 5: governor  performance min/cur/max 2.3/1.502/2.3 GHz Turbo 0
CPU 6: governor  performance min/cur/max 2.3/1.507/2.3 GHz Turbo 0
CPU 7: governor  performance min/cur/max 2.3/1.257/2.3 GHz Turbo 0
CPU 8: governor  performance min/cur/max 2.3/2.295/2.3 GHz Turbo 0
CPU 9: governor  performance min/cur/max 2.3/1.710/2.3 GHz Turbo 0
CPU 10: governor  performance min/cur/max 2.3/1.743/2.3 GHz Turbo 0
CPU 11: governor  performance min/cur/max 2.3/2.040/2.3 GHz Turbo 0
CPU 12: governor  performance min/cur/max 2.3/1.922/2.3 GHz Turbo 0
CPU 13: governor  performance min/cur/max 2.3/1.667/2.3 GHz Turbo 0
CPU 14: governor  performance min/cur/max 2.3/1.466/2.3 GHz Turbo 0
CPU 15: governor  performance min/cur/max 2.3/1.587/2.3 GHz Turbo 0
CPU 16: governor  performance min/cur/max 2.3/2.000/2.3 GHz Turbo 0
CPU 17: governor  performance min/cur/max 2.3/2.279/2.3 GHz Turbo 0
CPU 18: governor  performance min/cur/max 2.3/2.297/2.3 GHz Turbo 0
CPU 19: governor  performance min/cur/max 2.3/2.285/2.3 GHz Turbo 0
CPU 20: governor  performance min/cur/max 2.3/2.295/2.3 GHz Turbo 0
CPU 21: governor  performance min/cur/max 2.3/2.274/2.3 GHz Turbo 0
CPU 22: governor  performance min/cur/max 2.3/2.240/2.3 GHz Turbo 0
CPU 23: governor  performance min/cur/max 2.3/2.291/2.3 GHz Turbo 0
CPU 24: governor  performance min/cur/max 2.3/2.293/2.3 GHz Turbo 0
CPU 25: governor  performance min/cur/max 2.3/2.289/2.3 GHz Turbo 0
CPU 26: governor  performance min/cur/max 2.3/2.292/2.3 GHz Turbo 0
CPU 27: governor  performance min/cur/max 2.3/2.293/2.3 GHz Turbo 0
CPU 28: governor  performance min/cur/max 2.3/2.293/2.3 GHz Turbo 0
CPU 29: governor  performance min/cur/max 2.3/2.280/2.3 GHz Turbo 0
...
CPU 32: governor  performance min/cur/max 2.3/2.170/2.3 GHz Turbo 0
CPU 33: governor  performance min/cur/max 2.3/2.174/2.3 GHz Turbo 0
CPU 34: governor  performance min/cur/max 2.3/2.139/2.3 GHz Turbo 0
CPU 35: governor  performance min/cur/max 2.3/2.295/2.3 GHz Turbo 0
CPU 36: governor  performance min/cur/max 2.3/1.954/2.3 GHz Turbo 0
CPU 37: governor  performance min/cur/max 2.3/1.198/2.3 GHz Turbo 0
CPU 38: governor  performance min/cur/max 2.3/2.047/2.3 GHz Turbo 0
CPU 39: governor  performance min/cur/max 2.3/2.240/2.3 GHz Turbo 0
CPU 40: governor  performance min/cur/max 2.3/1.202/2.3 GHz Turbo 0
CPU 41: governor  performance min/cur/max 2.3/2.144/2.3 GHz Turbo 0
CPU 42: governor  performance min/cur/max 2.3/2.232/2.3 GHz Turbo 0
CPU 43: governor  performance min/cur/max 2.3/1.699/2.3 GHz Turbo 0
CPU 44: governor  performance min/cur/max 2.3/2.278/2.3 GHz Turbo 0
CPU 45: governor  performance min/cur/max 2.3/2.237/2.3 GHz Turbo 0
CPU 46: governor  performance min/cur/max 2.3/2.075/2.3 GHz Turbo 0
CPU 47: governor  performance min/cur/max 2.3/2.130/2.3 GHz Turbo 0
CPU 48: governor  performance min/cur/max 2.3/1.789/2.3 GHz Turbo 0
CPU 49: governor  performance min/cur/max 2.3/2.128/2.3 GHz Turbo 0
CPU 50: governor  performance min/cur/max 2.3/2.227/2.3 GHz Turbo 0
CPU 51: governor  performance min/cur/max 2.3/2.118/2.3 GHz Turbo 0
CPU 52: governor  performance min/cur/max 2.3/1.556/2.3 GHz Turbo 0
...
MemFree:        129794728 kB
MemAvailable:   129689356 kB
Buffers:           30652 kB
Cached:           514972 kB
SwapCached:         5028 kB
Active:           383232 kB
Inactive:         187808 kB
Active(anon):      20220 kB
Inactive(anon):     5612 kB
Active(file):     363012 kB
Inactive(file):   182196 kB
Unevictable:           0 kB
Mlocked:               0 kB
...
OLDPWD=/home/hpc/iwia/iwia84/INSPECT-repo/stencils/3D_r2_isotropic_star_constant/BroadwellEP_E5-2697_CoD_20190423_123847
...
PWD=/home/hpc/iwia/iwia84/INSPECT-repo/stencils/3D_r2_heterogeneous_star_constant/BroadwellEP_E5-2697_CoD_20190423_172351
