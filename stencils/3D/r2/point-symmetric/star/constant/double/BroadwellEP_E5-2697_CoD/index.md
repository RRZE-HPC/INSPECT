...
--------------------------
Block Throughput: 8.16 Cycles       Throughput Bottleneck: FrontEnd
Loop Count:  22
Port Binding In Cycles Per Iteration:
--------------------------------------------------------------------------------------------------
|  Port  |   0   -  DV   |   1   |   2   -  D    |   3   -  D    |   4   |   5   |   6   |   7   |
--------------------------------------------------------------------------------------------------
| Cycles |  7.0     0.0  |  8.0  |  7.0     7.0  |  7.0     6.0  |  1.0  |  0.5  |  0.5  |  0.0  |
--------------------------------------------------------------------------------------------------
...
-----------------------------------------------------------------------------------------
|   1      |             |      | 1.0     1.0 |             |      |      |      |      | vmovupd ymm3, ymmword ptr [rax+r9*8+0x8]
|   1      |             |      |             | 1.0     1.0 |      |      |      |      | vmovupd ymm15, ymmword ptr [r10+r9*8+0x10]
|   1      |             |      | 1.0     1.0 |             |      |      |      |      | vmovupd ymm2, ymmword ptr [rax+r9*8]
|   2      |             | 1.0  |             | 1.0     1.0 |      |      |      |      | vaddpd ymm14, ymm3, ymmword ptr [rax+r9*8+0x18]
|   2      |             | 1.0  | 1.0     1.0 |             |      |      |      |      | vaddpd ymm3, ymm15, ymmword ptr [r14+r9*8+0x10]
|   2      |             | 1.0  |             | 1.0     1.0 |      |      |      |      | vaddpd ymm2, ymm2, ymmword ptr [rax+r9*8+0x20]
|   1      | 1.0         |      |             |             |      |      |      |      | vmulpd ymm3, ymm7, ymm3
|   1      | 1.0         |      |             |             |      |      |      |      | vfmadd231pd ymm3, ymm14, ymm0
|   1      |             |      | 1.0     1.0 |             |      |      |      |      | vmovupd ymm14, ymmword ptr [r13+r9*8+0x10]
|   2      | 1.0         |      |             | 1.0     1.0 |      |      |      |      | vfmadd231pd ymm3, ymm1, ymmword ptr [rax+r9*8+0x10]
|   2      |             | 1.0  | 1.0     1.0 |             |      |      |      |      | vaddpd ymm15, ymm14, ymmword ptr [r12+r9*8+0x10]
|   1      |             |      |             | 1.0     1.0 |      |      |      |      | vmovupd ymm14, ymmword ptr [r11+r9*8+0x10]
|   2      |             | 1.0  | 1.0     1.0 |             |      |      |      |      | vaddpd ymm14, ymm14, ymmword ptr [r15+r9*8+0x10]
|   1      | 1.0         |      |             |             |      |      |      |      | vmulpd ymm14, ymm10, ymm14
|   1      | 1.0         |      |             |             |      |      |      |      | vfmadd231pd ymm14, ymm15, ymm13
|   1      |             |      |             | 1.0     1.0 |      |      |      |      | vmovupd ymm15, ymmword ptr [rsi+r9*8+0x10]
|   2      |             | 1.0  | 1.0     1.0 |             |      |      |      |      | vaddpd ymm15, ymm15, ymmword ptr [rdi+r9*8+0x10]
|   1      | 1.0         |      |             |             |      |      |      |      | vmulpd ymm15, ymm9, ymm15
|   1      | 1.0         |      |             |             |      |      |      |      | vfmadd231pd ymm15, ymm2, ymm12
|   1      |             | 1.0  |             |             |      |      |      |      | vaddpd ymm2, ymm14, ymm15
|   1      |             | 1.0  |             |             |      |      |      |      | vaddpd ymm2, ymm2, ymm3
|   2      |             |      |             | 1.0         | 1.0  |      |      |      | vmovupd ymmword ptr [r8+r9*8+0x10], ymm2
...
# Logged in users
################################################################################
 02:54:36 up 132 days, 10:26,  0 users,  load average: 0.85, 0.90, 0.98
...
CPU 0: governor  performance min/cur/max 2.3/1.851/2.3 GHz Turbo 0
CPU 1: governor  performance min/cur/max 2.3/1.203/2.3 GHz Turbo 0
CPU 2: governor  performance min/cur/max 2.3/1.551/2.3 GHz Turbo 0
CPU 3: governor  performance min/cur/max 2.3/2.284/2.3 GHz Turbo 0
CPU 4: governor  performance min/cur/max 2.3/2.295/2.3 GHz Turbo 0
CPU 5: governor  performance min/cur/max 2.3/2.282/2.3 GHz Turbo 0
CPU 6: governor  performance min/cur/max 2.3/2.292/2.3 GHz Turbo 0
CPU 7: governor  performance min/cur/max 2.3/2.270/2.3 GHz Turbo 0
CPU 8: governor  performance min/cur/max 2.3/2.278/2.3 GHz Turbo 0
CPU 9: governor  performance min/cur/max 2.3/2.241/2.3 GHz Turbo 0
CPU 10: governor  performance min/cur/max 2.3/2.039/2.3 GHz Turbo 0
CPU 11: governor  performance min/cur/max 2.3/2.287/2.3 GHz Turbo 0
CPU 12: governor  performance min/cur/max 2.3/2.117/2.3 GHz Turbo 0
CPU 13: governor  performance min/cur/max 2.3/2.260/2.3 GHz Turbo 0
CPU 14: governor  performance min/cur/max 2.3/2.295/2.3 GHz Turbo 0
CPU 15: governor  performance min/cur/max 2.3/2.284/2.3 GHz Turbo 0
CPU 16: governor  performance min/cur/max 2.3/2.145/2.3 GHz Turbo 0
CPU 17: governor  performance min/cur/max 2.3/2.289/2.3 GHz Turbo 0
CPU 18: governor  performance min/cur/max 2.3/2.213/2.3 GHz Turbo 0
CPU 19: governor  performance min/cur/max 2.3/2.241/2.3 GHz Turbo 0
CPU 20: governor  performance min/cur/max 2.3/1.204/2.3 GHz Turbo 0
CPU 21: governor  performance min/cur/max 2.3/1.762/2.3 GHz Turbo 0
CPU 22: governor  performance min/cur/max 2.3/2.163/2.3 GHz Turbo 0
CPU 23: governor  performance min/cur/max 2.3/2.086/2.3 GHz Turbo 0
CPU 24: governor  performance min/cur/max 2.3/2.148/2.3 GHz Turbo 0
CPU 25: governor  performance min/cur/max 2.3/1.232/2.3 GHz Turbo 0
CPU 26: governor  performance min/cur/max 2.3/1.209/2.3 GHz Turbo 0
CPU 27: governor  performance min/cur/max 2.3/1.325/2.3 GHz Turbo 0
CPU 28: governor  performance min/cur/max 2.3/1.477/2.3 GHz Turbo 0
CPU 29: governor  performance min/cur/max 2.3/2.274/2.3 GHz Turbo 0
CPU 30: governor  performance min/cur/max 2.3/1.270/2.3 GHz Turbo 0
CPU 31: governor  performance min/cur/max 2.3/1.624/2.3 GHz Turbo 0
CPU 32: governor  performance min/cur/max 2.3/2.052/2.3 GHz Turbo 0
CPU 33: governor  performance min/cur/max 2.3/1.928/2.3 GHz Turbo 0
CPU 34: governor  performance min/cur/max 2.3/1.414/2.3 GHz Turbo 0
CPU 35: governor  performance min/cur/max 2.3/1.464/2.3 GHz Turbo 0
CPU 36: governor  performance min/cur/max 2.3/2.226/2.3 GHz Turbo 0
CPU 37: governor  performance min/cur/max 2.3/2.290/2.3 GHz Turbo 0
CPU 38: governor  performance min/cur/max 2.3/2.283/2.3 GHz Turbo 0
CPU 39: governor  performance min/cur/max 2.3/2.282/2.3 GHz Turbo 0
CPU 40: governor  performance min/cur/max 2.3/2.294/2.3 GHz Turbo 0
CPU 41: governor  performance min/cur/max 2.3/2.293/2.3 GHz Turbo 0
CPU 42: governor  performance min/cur/max 2.3/2.294/2.3 GHz Turbo 0
CPU 43: governor  performance min/cur/max 2.3/2.194/2.3 GHz Turbo 0
CPU 44: governor  performance min/cur/max 2.3/2.286/2.3 GHz Turbo 0
CPU 45: governor  performance min/cur/max 2.3/2.283/2.3 GHz Turbo 0
CPU 46: governor  performance min/cur/max 2.3/2.292/2.3 GHz Turbo 0
CPU 47: governor  performance min/cur/max 2.3/2.289/2.3 GHz Turbo 0
CPU 48: governor  performance min/cur/max 2.3/2.051/2.3 GHz Turbo 0
CPU 49: governor  performance min/cur/max 2.3/2.275/2.3 GHz Turbo 0
CPU 50: governor  performance min/cur/max 2.3/1.736/2.3 GHz Turbo 0
CPU 51: governor  performance min/cur/max 2.3/2.255/2.3 GHz Turbo 0
CPU 52: governor  performance min/cur/max 2.3/2.291/2.3 GHz Turbo 0
...
CPU 55: governor  performance min/cur/max 2.3/1.228/2.3 GHz Turbo 0
CPU 56: governor  performance min/cur/max 2.3/1.198/2.3 GHz Turbo 0
CPU 57: governor  performance min/cur/max 2.3/2.278/2.3 GHz Turbo 0
CPU 58: governor  performance min/cur/max 2.3/1.214/2.3 GHz Turbo 0
CPU 59: governor  performance min/cur/max 2.3/1.217/2.3 GHz Turbo 0
CPU 60: governor  performance min/cur/max 2.3/1.243/2.3 GHz Turbo 0
...
CPU 63: governor  performance min/cur/max 2.3/1.203/2.3 GHz Turbo 0
CPU 64: governor  performance min/cur/max 2.3/1.758/2.3 GHz Turbo 0
CPU 65: governor  performance min/cur/max 2.3/2.157/2.3 GHz Turbo 0
CPU 66: governor  performance min/cur/max 2.3/1.422/2.3 GHz Turbo 0
CPU 67: governor  performance min/cur/max 2.3/1.250/2.3 GHz Turbo 0
CPU 68: governor  performance min/cur/max 2.3/2.031/2.3 GHz Turbo 0
CPU 69: governor  performance min/cur/max 2.3/1.235/2.3 GHz Turbo 0
CPU 70: governor  performance min/cur/max 2.3/2.097/2.3 GHz Turbo 0
CPU 71: governor  performance min/cur/max 2.3/2.155/2.3 GHz Turbo 0
...
MemFree:        129727556 kB
MemAvailable:   129669636 kB
Buffers:           56596 kB
Cached:           530920 kB
SwapCached:         5028 kB
Active:           468156 kB
Inactive:         146712 kB
Active(anon):      22104 kB
Inactive(anon):     5632 kB
Active(file):     446052 kB
Inactive(file):   141080 kB
Unevictable:           0 kB
Mlocked:               0 kB
SwapTotal:      67043324 kB
SwapFree:       67000572 kB
Dirty:               424 kB
Writeback:             0 kB
AnonPages:         23468 kB
Mapped:            66500 kB
Shmem:               384 kB
Slab:             736700 kB
SReclaimable:     314812 kB
SUnreclaim:       421888 kB
...
DirectMap4k:      920320 kB
DirectMap2M:    46137344 kB
...
OLDPWD=/home/hpc/iwia/iwia84/INSPECT-repo/stencils/3D_r2_homogeneous_star_constant/BroadwellEP_E5-2697_CoD_20190423_221214
...
PBS_NODEFILE=/var/spool/pbspro/aux/3117.catstor
GROUP=iwia
PBS_TASKNUM=1
I_MPI_OFA_ADAPTER_NAME=mlx4_0
LIKWID_DEFINES=-DLIKWID_PERFMON
PWD=/home/hpc/iwia/iwia84/INSPECT-repo/stencils/3D_r2_point-symmetric_star_constant/BroadwellEP_E5-2697_CoD_20190424_025436
...
PBS_JOBCOOKIE=040614B3333490380058AFA05F447B26
...
LESS_TERMCAP_me=[0m
TMPDIR=/scratch/pbs.3117.catstor
