...
vmovupd xmm3, xmmword ptr [rdx+r14*8+0x10]
...
L2: P <= 32768/17
L3: P <= 3276800/17
L1: 88*N*P + 16*P*(N - 2) + 32*P <= 32768
L2: 88*N*P + 16*P*(N - 2) + 32*P <= 262144
L3: 88*N*P + 16*P*(N - 2) + 32*P <= 26214400
{%- endcapture -%}
{%- capture iaca -%}
...
|   1    |           |     | 1.0   1.0 |           |     |     | CP | vmovupd xmm10, xmmword ptr [rsi+r14*8+0x10]
