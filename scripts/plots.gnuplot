...
plot "< awk '(NR>2){print;}' results.csv" u 1:26 every 10:10 notitle w points ls 1, \
          "" u 1:26 notitle w lines ls 1, 1 / 0 title "L1 - L2 transfer" w linespoints ls 1, \
     "< awk '(NR>2){print;}' results.csv" u 1:30 every 10:10 notitle w points ls 2, \
          "" u 1:30 notitle w lines ls 2, 1 / 0 title "L2 - L3 transfer" w linespoints ls 2, \
     "< awk '(NR>2){print;}' results.csv" u 1:34 every 10:10 notitle w points ls 3, \
          "" u 1:34 notitle w lines ls 3, 1 / 0 title "L3 - Mem transfer" w linespoints ls 3
